        ...
        <Layout >
          <div className="w-full h-full flex flex-wrap">
            ...
            <div className="w-full h-full mt-11">
                  <div className='flex flex-wrap w-full h-full bg-light shadow-custom '>
                      {duplicatedData?.map((item, index) => (
                          <div key={index}  className='w-full h-full flex-grow-0 flex-shrink-0 lg:w-[20%] sm:max-w-[33.33%] max-w-[50%]  xl:max-w-[20%] md:max-w-[25%] py-[10px] px-[10px] relative '>
