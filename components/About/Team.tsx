...
const Team = ({teamMember}:Props) => {
  ...
  const duplicatedData = [...teamMember, ...teamMember, ...teamMember, ...teamMember, ...teamMember];
  return (
            ...
            <div className="flex flex-wrap w-full h-full items-center justify-between ">
              ...
              <div className="w-full h-full flex-grow-0 flex-shrink-0 lg:w-[33.333%]">
                <div className="flex items-end w-full justify-end">
                  <AnimatedButton className='bg-yellowColor' link='/team' text='view all' style='!mt-0 bg-redDark !rounded-[8px]'/>
                </div>
              </div>
            </div>
          </div>
