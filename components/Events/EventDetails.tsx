...
type Props = {
  singleEvent:EventsProps
}

const EventDetails = ({singleEvent}:Props) => {
    ...
    const dateData = new Date(singleEvent.timeStamp);

    const currentDate = new Date();

    const isEventEnded = currentDate > dateData;
    // Use a state variable to track the eventEnded state
    const [eventEnded, setEventEnded] = useState(isEventEnded);
    
    // Function to handle the countdown end
  ...
  return (
    <section className='block py-[120px] relative w-full h-full'>
        ...
        {/* <div className="flex w-full flex-col items-center">
          <p className="text-[30px] font-bold text-redDark text-center">The event has ended.</p>
          <div className="mt-4">
            <Link href="/events" className="text-white bg-yellowColor px-[30px] py-[10px]">View more events</Link>
          </div>
                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className="relative block -[20px]">
                                    <Image src={urlFor(singleEvent.image).url()} alt='main-image' width={800} height={800} className='w-full h-full md:h-[470px] object-cover rounded-tl-lg rounded-tr-lg'/>
                                    <div className="absolute left-[30px] bg-orangeDefault py-[6px] px-[25px] bottom-[30px] z-[2] -[15px]">
                                        <p className='text-[18px] text-white font-cav leading-[18px] font-[700]'>{singleEvent._createdAt}</p>
                                    </div>
                            </div>
                            <div className="p-[30px] w-full bg-white bg-shadow">
                            <PortableText value={singleEvent.body} components={RichTextComponent}/>
                            <div className="w-full block">
                              <ul className="flex flex-wrap items-center">
                                {singleEvent.tags.map((tag, index) => (
                                  <li className="p-1" key={index}>
                                    <Link href={""} className='bg-[#eaeaea] block text-primaryText px-[11px] py-[5px] font-medium text-[0.7rem]'>{tag.title}</Link>
                                  </li>
                                ))}
                              </ul>
                            </div>
                            <div className="flex flex-col flex-wrap mt-4">
                              ...
                              <div className="flex items-center w-full space-x-2">
                                ...
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="text-primaryDark bg-[#f7f7f7] relative gap-[10px] h-[40px] w-[40px]  items-center justify-center text-center text-[14px] rounded-full z-[1] hover:text-white group overflow-hidden transition-all duration-500 hidden"
                                >
                            ...
                            <div 
                              className='relative block  bg-white shadow-custom  p-[30px] rounded-[5px] w-full mt-11'>
                                <div className="text-[1.231rem] font-semibold mt-[-30px] mx-[-30px] mb-[30px] border-b border-b-[#eaeaea] px-[30px] py-[30px] pb-[25px] relative flex flex-wrap justify-between items-center">
                                  <span className='mr-[10px]'>Event Photos</span>
                                </div>
                                <div className='flex w-full h-full flex-wrap'>
                                  {singleEvent.eventPhotos.map((item, index) => (
                                    <div className="flex-grow-0 flex-shrink-0 lg:w-[33.33%] md:w-[50%] w-[50%] p-2" key={index}>
                                      <Link href={""} className='w-full h-full'>
                                        <Image src={urlFor(item.image).url()} alt='images-insta' width={300} height={300} className='w-full h-full md:h-[250px] lg:h-[250px] object-cover' />
                                      </Link>
                                    </div>
                                  ))}
                                </div>
                    ...
                    <div className="relative block space-y-[30px]">
                        ...
                        className='relative block  bg-white shadow-custom p-[30px] rounded-[5px] w-full '>
                          ...
                          <div className="">
                            <>
                              {eventEnded ? (
                                  <p className="text-start text-redDark uppercase">Event Ended</p>
                              ): (
                                <div className="mt-[-30px] mx-[-30px] py-[25px] text-center justify-center items-center px-[30px] bg-yellowColor">
                                  <Countdown onCountdownEnd={handleCountdownEnd}  targetDate={dateData}/>
                                </div>
                              )}
                            </>
                            <ul className="mt-5 w-full h-full">
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.startDate}</span>
                                  </div>
                                </li>
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.endDate}</span>
                                  </div>
                                </li>
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    {eventEnded ? (
                                      ...
                                      <span className="text-primaryText text-[0.9rem]">{singleEvent.status}</span>
                                    )}
                                  </div>
                                </li>
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.location}</span>
                                  </div>
                                </li>                                
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]"> {singleEvent.venue}</span>
                                  </div>
                                </li>                                
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.ticketCost}</span>
                                  </div>
                                </li>
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.organizer}</span>
                                  </div>
                                </li>
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.address}</span>
                                  </div>
                                </li>
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.phone}</span>
                                  </div>
                                </li>
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.email}</span>
                                  </div>
                                </li>
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">{singleEvent.remainingTickets}</span>
                                  </div>
                                </li>
                        ...
                        className='relative block  bg-white shadow-custom  p-[30px] rounded-[5px] w-full '>
                          <div className="text-[1.231rem] font-semibold mt-[-30px] mx-[-30px] mb-[30px] border-b border-b-[#eaeaea] px-[30px] py-[30px] pb-[25px] relative flex flex-wrap justify-between items-center">
                            ...
                            <ul className='m-0 pl-0 list-none'>
                                {singleEvent.categories.map((item, index) => (
                                <li key={index}>
                                    <Link href="#" 
                                    className={`group text-[#7b8381] text-[16px] relative transition-all duration-500 block bg-none py-[5px] px-[30px] rounded-[20px] font-[500] hover:bg-white hover:text-primaryDark mt-[10px] `}>
                                        {item.title}
