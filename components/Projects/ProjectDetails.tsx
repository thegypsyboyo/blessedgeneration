                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block">
                              <h2 className="text-[36px] font-[600] text-darkBlue mb-7">{singleproject.title}</h2>
                              <div className="relative block -[20px] lg:h-[500px]">
                                    <Image src={urlFor(singleproject.image).url()}alt='main-image' width={800} height={800} className='w-full h-full sm:max-h-[400px] lg:max-h-[500px] object-cover'/>
                                </div>
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <PortableText value={singleproject.body} components={RichTextComponent}/>
