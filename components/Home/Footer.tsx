...
const Footer = () => {
  return (
    <footer className='font-man relative block z-[1] w-full h-full bg-primaryDark overflow-hidden'>
            ...
            className="w-full  mb-[35px]  lg:max-[50%] md:max-w-[50%] xl:max-w-[33.333333%] flex-shrink-0">
              <div className="relative block mt-0 mr-[50px]">
                ...
                <div className="relative block">
                  ...
                  <AnimatedButton className='' link='/donate-now' text='donate now' style=''/>
                </div>
              </div>
            </motion.div>
      ...
      <motion.div className='bg-darkBlue overflow-hidden relative block'
       variants={footerVariants}
       initial = "hidden"
       whileInView="show"
      >
        <Layout className=''>
          <span className='flex flex-wrap ml-auto mr-auto py-[25px] text-center font-[400] text-white text-[15px]'>&copy;All Copyrights by <Link href={"https://www.instagram.com/myadventurers/"} target='_blank' rel='noreffere' className='hover:text-primaryBase transition-all duration-500 ml-1'> blessedgenerationkenya.com</Link></span>
        </Layout>
      </motion.div>
    </footer>
  )
