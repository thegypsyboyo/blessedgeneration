                ...
                <div className="flex flex-col justify-center items-center  w-full h-full">
                    <div className="flex-grow-0 flex-shrink-0 w-full mb-10">
                        <div className='relative z-[3] lg:max-w-540 m-auto w-full flex flex-col items-center justify-center text-center'>
                            ...
                            <h2 className="m-0 text-white text-[40px] leading-[48px] font-[600] capitalize -tracking-[0.04em] mt-[6px] font-man mx-auto lg:max-w-[500px] flex items-center justify-center text-center ">
