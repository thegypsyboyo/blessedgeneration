      ...
      <div className={`relative py-[150px] z-[1] h-[400px] px-0 overflow-hidden break-words bg-cover bg-center  ${className}`} >
          ...
          >
              <div className="relative flex flex-col h-[350px] items-center justify-center  text-center z-[15] w-full mt-[100%] ">
                  <h1 className="text-white font-[600] tracking-[-0.04em]  lg:text-[40px] lg:leading-[40px] text-[30px] leading-[30px] px-[30px] mb-[20px] inline-block font-man mt-[-10px] capitalize mx-auto w-[550px] pt-[100px]">{title}</h1>
      ...
      >
        ...
        >
            <div className="relative flex flex-col h-[350px] items-center justify-center  text-center z-[15] w-full pt-[100px]">
                <h1 className="text-white font-[600]  px-[30px] tracking-[-0.04em] mb-[20px] lg:text-[40px] lg:leading-[56px] text-[30px] leading-[45px]   inline-block font-man capitalize mx-auto w-[550px]  text-center ">{title}</h1>
                <ul className="relative z-1 space-x-4">
