...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ videoId, className, isOpen, onClose }) => {
  ...
  return (
      ...
      <div className="w-full h-full ">
        ...
        <div className={`fixed overflow-y-auto w-[500px] p-[20px] pt-[20px] h-full block text-white bg-white top-0 right-auto  shadow-md transition-all duration-500 z-[9999]`}>
