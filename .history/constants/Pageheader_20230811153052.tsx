...
const Pageheader = ({title, bgImage, className}:PropsHeader) => {
  return (
    <div className={`relative h-[350px] px-[15px] !py-[121px] z-[1] bg-primaryDark w-full flex items-center opacity-5 justify-center ${className}`}>
         <div 
       style={{backgroundImage: `url(${bgImage})`}}
       className='bg-cover h-full w-full absolute top-0 bottom-0 left-0 right-0 mix-blend-luminosity bg-no-repeat bg-primaryDark bg-center bg-no-repeat opacity-[0.7] -z-[1]' 
       />
