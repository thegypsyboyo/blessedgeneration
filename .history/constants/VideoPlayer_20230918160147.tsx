...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ videoId, className, isOpen, onClose }) => {
  ...
  return (
      ...
      <div className={`transform transition-all duration-1000 ${isOpen ? "fixed left-0 top-0 right-0 bottom-0 !bg-[#000] z-[9999] translate-x-[0px]" : "none transition-all duration-1000"}`}  />
