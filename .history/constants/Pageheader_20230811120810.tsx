...
const Pageheader = ({title, bgImage, className}:PropsHeader) => {
  return (
    <div className={`relative h-[300px] px-[15px] !py-[121px] z-[2] bg-white w-full flex items-center justify-center ${className}`}>
         <div 
       style={{backgroundImage: `url(${bgImage})`}}
       className='bg-cover h-full w-full absolute top-0 bottom-0 left-0 right-0' 
       />
       {/* <div className="bg-grad absolute opacity-[0.6] left-0 right-0 content-[] w-full h-full z-[1] "/> */}
