...
const Pageheader = ({title, bgImage, className}:PropsHeader) => {
  return (
    <>
    {!bgImage ? (
      <div className={`relative py-[150px] z-[1000] h-[350px] px-0 overflow-hidden break-words bg-cover bg-center bg-redLight z-[1] ${className}`} >
      ...
      <div className={`relative py-[150px] z-[1000]  h-[350px] px-0 overflow-hidden break-words bg-cover bg-center bg-redLight z-[2] ${className}`}
