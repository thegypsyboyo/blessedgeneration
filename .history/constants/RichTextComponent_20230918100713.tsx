...
import { faCheck, faQuoteRightAlt } from '@fortawesome/free-solid-svg-icons';
        ...
        bullet: ({children}: any) => (
            <ul className="relative block pl-0 list-none ">
                <li className="flex relative items-center">
                    <span className="h-[15px] w-[15px] bg-redLight text-[9px] rounded-[50%] text-white flex items-center justify-center">
                    <FontAwesomeIcon icon={faCheck} />
                    </span>
                    <span className="ml-[10px]">
                        <p className='text-[16px] text-primaryDark font-[700]'>{children}</p>
