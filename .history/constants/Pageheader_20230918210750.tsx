      ...
      >
        ...
        >
            <div className="relative flex flex-col h-[350px] items-center justify-center  text-center z-[15] w-full ">
                <h1 className="text-white font-[600]  px-[30px] tracking-[-0.04em] mb-[20px] lg:text-[40px] lg:leading-[40px] text-[30px] leading-[30px]   inline-block font-man mt-[100px] capitalize !max-w-[600px] text-center ">{title}</h1>
                <ul className="relative z-1 space-x-4">
