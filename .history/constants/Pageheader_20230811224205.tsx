...
const Pageheader = ({title, bgImage, className}:PropsHeader) => {
  return (
    ...
    <div className={`relative py-[150px]  h-[350px] px-0 overflow-hidden break-words bg-cover bg-center bg-[#ecf6fa] z-[1] ${className}`}  style={{backgroundImage: `url(${bgImage})`}}>
      <div className="absolute content-[] py-[150px] h-full left-0 opacity-[0.5] top-0 w-full -z-[1] bg-primaryDark bg-no-repeat bg-scroll bg-repeat bg-center"/>
         {/* <div 
