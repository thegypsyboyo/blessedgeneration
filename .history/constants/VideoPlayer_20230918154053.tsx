...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ videoId, className, isOpen, onClose }) => {
  ...
  return (
      ...
      <div className="w-full h-full ">
        ...
        <div className={`fixed w-[500px]  h-full text-white bg-white top-0 right-0 left-0 flex items-center justify-center  shadow-md transition-all duration-500 z-[9999]`}>
