...
const Pageheader = ({title, bgImage, className}:PropsHeader) => {
  return (
    ...
    <div className={`relative py-[150px]  h-[350px] px-0 overflow-hidden break-words bg-cover bg-center bg-primaryBase z-[1] ${className}`} >
      <div 
       style={{backgroundImage: `url(/images/slider/slide-1.jpg)`}}
       className='bg-cover h-full w-full absolute top-0 bottom-0 left-0 right-0 mix-blend-luminosity bg-no-repeat bg-center opacity-[0.06] -z-[1]' 
       />
         {/* <div 
