...
const PartnerWith:React.FC<PartnerProps> = ({className}) => {
        ...
        <Layout>
            <div className="flex flex-wrap w-full h-full">
                <div className="flex-grow-0 flex-shrink-0 lg:max-w-full w-full">
                    <div className={`bg-yellowColor shadow-custom -mt-[80px] mb-[-80px] p-[30px] rounded-xl ${className}`}>
                        <Swiper
                        autoplay={{
                            delay: 3000,
                        ...
                        className="w-full lg:max-w-[90%]  h-full flex items-center justify-center"
                        >
                                ...
                                <SwiperSlide className="w-full h-full" key={index}>
                                    <div className="w-full bg-white h-[100px]">
                                        <Link href="" className='w-full h-full '>
                                            <Image src={item.image} alt='' width={200} height={200} className='w-[300px] h-full object-fill opacity-[1] hover:opacity-[0.6]'/>
                                        </Link>
                                    </div>
                                </SwiperSlide>
                                ))}
