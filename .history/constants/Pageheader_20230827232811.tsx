...
const Pageheader = ({title, bgImage, className}:PropsHeader) => {
  return (
    <>
    {!bgImage ? (
      <div className={`relative py-[150px] z-[1] h-[400px] px-0 overflow-hidden break-words bg-cover bg-center bg-orangeDefault  ${className}`} >
          ...
          >
              <div className="relative flex flex-col h-[350px] items-center justify-center  text-center z-[15] w-full  ">
                  ...
                  <ul className="relative z-10 space-x-4">
                      ...
                      <li className="relative inline-block text-white text-[16px] font-[600] transition-all duration-500">
                        <span className="content-[] h-[2px] absolute top-1/2 left-[-10px] w-4 bg-white -mt-[1px]" /> 
                        {title}
                      </li>
                  </ul>
              </div>
      ...
      <div className={`relative py-[150px] z-[1]  h-[400px] px-0 overflow-hidden break-words bg-cover bg-center bg-dark  ${className}`}
