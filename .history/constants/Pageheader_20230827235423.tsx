              ...
              <div className="relative flex flex-col h-[350px] items-center justify-center  text-center z-[15] w-full  ">
                  ...
                  <ul className="relative z-1 space-x-4">
                      <li className="relative inline-block text-white font-man font-[600] py-0 px-[20px] z-[1] uppercase text-[14px]">
                        <Link href="/"  className="relative inline-block text-white text-[16px] text-center">
                        <FontAwesomeIcon icon={faHome} className="mr-2"/>
                        Home</Link></li>
                      {/* <li className="relative inline-block text-white text-[16px] font-[600] transition-all duration-500"><span>-</span></li> */}
                      <li className="relative inline-block text-white font-man font-[600] py-0 px-[20px] z-[1] uppercase text-[14px]">
                        {title}
                        <span className="content-[] h-[2px] absolute top-1/2 left-[-10px] w-4 bg-white text-white z-[2] -mt-[1px]" /> 
                      </li>
                  </ul>
              </div>
          </div>
