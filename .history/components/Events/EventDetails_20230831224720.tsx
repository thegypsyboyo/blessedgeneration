...
import { faArrowRight, faComment, faMagnifyingGlass, faQuoteRightAlt, faSearch, faTag, faUserCircle } from '@fortawesome/free-solid-svg-icons'
import { AnimatedText } from '@/constants/AnimatedText'
import {motion} from "framer-motion"
import { footerVariants } from '@/utils/motion'
import {BsArrowLeft, BsArrowRight, BsCalendar2, BsCheck2Circle, BsFacebook, BsHeart, BsInstagram, BsLinkedin, BsPinMap, BsTwitter, BsYoutube} from "react-icons/bs"
                        ...
                        className='relative block  bg-white shadow-custom p-[30px] rounded-[5px] w-full '>
                          ...
                          <div className="">
                            ...
                            <ul className="mt-5 w-full h-full">
                                ...
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
                                    <BiSolidLockAlt className="text-[#ffbb00]"/>
                                  </div>
                                  <div className="w-full">
                                ...
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">Malindi Children's Home</span>
                                  </div>
                                </li>                                
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  <div className="text-[1.943rem] leading-[1.93rem] pr-[25px] w-[60px]">
