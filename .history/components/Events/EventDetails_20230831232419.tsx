                            ...
                            <div 
                              className='relative block  bg-white shadow-custom  p-[30px] rounded-[5px] w-full mt-11'>
                                ...
                                <div className='flex w-full h-full flex-wrap'>
                                  <div className="flex-grow-0 flex-shrink-0 lg:max-w-[33.33%] md:max-w-[50%] ">
                                    <Link href={""} className='w-full h-full'>
                                      <Image src={"/images/test/gallery-1.jpg"} alt='images-insta' width={300} height={300} className='w-full h-full object-cover' />
                                    </Link>
                                  </div>
                                </div>
                              </div>
