    ...
    <section className='block py-[120px] relative w-full h-full'>
        ...
        <Layout>
            <div className="flex flex-wrap w-full">
                <div className="w-full lg:max-w-[58.333333%] mb-[30px] flex-shrink-0">
                              ...
                              className='relative block  bg-white shadow-custom  p-[30px] rounded-[5px] w-full mt-11'>
                                ...
                                <div className='flex w-full h-full flex-wrap'>
                                  {imageArray.map((item, index) => (
                                    <div className="flex-grow-0 flex-shrink-0 lg:w-[33.33%] md:w-[50%] w-[50%]" key={item.id*index}>
                                      <Link href={""} className='w-full h-full'>
                                        <Image src={item.image} alt='images-insta' width={300} height={300} className='w-full h-full md:h-[250px] lg:h-[250px] object-cover' />
                                      </Link>
                                    </div>
                                  ))}
                                </div>
                ...
                <div className="w-full lg:max-w-[41.666666%] mb-[30px] lg:pr-[15px] lg:pl-[35px] flex-shrink-0">
                        ...
                        className='relative block  bg-white shadow-custom p-[30px] rounded-[5px] w-full '>
                          ...
                          <div className="">
                            <div className="mt-[-30px] mx-[-30px] py-[25px] text-center justify-center items-center px-[30px] bg-yellowColor">
                              <Countdown onCountdownEnd={handleCountdownEnd}  targetDate={targetDate}/>
                            </div>
                            <ul className="mt-5 w-full h-full">
                                ...
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee] pb-[25px] '>
                                  ...
                                  <div className="w-full">
                                    ...
                                    <span className="text-primaryText text-[0.9rem]">455 tickets</span>
                                  </div>
                                </li>
