                            ...
                            <div className='single w-full h-full relative block group'>
                                <div className="relative block overflow-hidden !bg-white  z-[1] h-full ">
                                  <Link href={`/team/team-details`}>
                                  	<Image src={item.img} alt='image-data' width={400} height={400}  className='object-cover transform scale-110 group-hover:scale-125 transition-all duration-700 group-hover:rotate-12 h-full md:h-[300px] lg:h-[250px] w-full '/>
                                  </Link>
                                </div>
                                <div className="w-full bg-white  border border-[#eaeaea] py-[25px] px-[30px] flex flex-col items-center justify-center">
                                    ...
                                    <div className="mt-1 my-[-5px] mx-[-10px] w-full flex items-center flex-wrap">
                                        ...
                                        <div className="w-full mx-[20px] text-[0.9rem] ">Join us for an unforgettable trek through the stunning Village Mountain. Breathtaking views, fresh air, and a fun group await! Hosted by Eventchamp.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
