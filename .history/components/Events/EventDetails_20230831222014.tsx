...
import {BsArrowLeft, BsArrowRight, BsCalendar2, BsFacebook, BsHeart, BsInstagram, BsLinkedin, BsTwitter, BsYoutube} from "react-icons/bs"
                    ...
                    <div className="relative block space-y-[30px]">
                        ...
                        className='relative block  bg-white shadow-custom p-[30px] rounded-[5px] w-full '>
                          ...
                          <div className="">
                            ...
                            <ul className="">
                                <li className='flex flex-start mb-[25px] border-b border-b-[#eee]'>
