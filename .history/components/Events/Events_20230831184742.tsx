                                    ...
                                    <div className="mt-1 my-[-5px] mx-[-10px] w-full flex items-center flex-wrap">
                                        ...
                                        <div className="flex flex-wrap  w-full">
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-[14px] text-primaryText pl-2">Showing</span>
                                            </div>
                                            <div className="flex items-center pl-3">
                                                <MdLocationOn className="text-yellowColor"/>
                                                <span className="text-[14px] text-primaryText pl-2">Nairobi</span>
                                            </div>
                                            <div className="flex items-center pl-3">
                                                <BiMoney className="text-yellowColor"/>
                                                <span className="text-[14px] text-primaryText pl-2">$200</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
