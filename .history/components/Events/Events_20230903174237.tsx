  ...
  const sampleData:EventsProps[] = [
    {
      ...
      timeStamp: "2023-09-04T09:00:00", // Set the event's end time as a string
    },
    {
                            ...
                            <div className='single w-full h-full relative block group rounded-[15px]'>
                                <div className="w-full relative block overflow-hidden !bg-white  z-[1] h-full ">
                                  <Link href={`/team/team-details`} className="w-full h-full">
                                  	<Image src={item.img} alt='image-data' width={400} height={400}  className='object-cover transform scale-110 group-hover:scale-125 transition-all duration-700 group-hover:rotate-1 h-full md:h-[300px] rounded-t-[20px] lg:h-[300px] w-full '/>
                                  </Link>
                                </div>
                                <div className="w-full bg-white border border-[#eaeaea] py-[25px] px-[20px] flex flex-col items-center justify-center">
                                    <div className="w-full text-[18px] leading-[26px] font-[800] mb-4">
                                        <Link href={`/events/event-details/${item.slug}`} className='w-full h-full font-[800] font-nun text-[20px] transition-all duration-500 hover:text-yellowColor'>{item.title}</Link>
                                    </div>
                                    <div className="mt-1 my-[-5px] mx-[-10px] w-full flex items-center flex-wrap">
                                        <div className="py-[5px] px-[30px] bg-yellowColor mr-2 rounded-[30px]">
                                            <Link href={`/events/event-details/${item.slug}`} className='text-white font-semibold text-[14px]'>Funds raising</Link>
                                        </div>
                                        ...
                                        <div className="flex flex-wrap  w-full">
                                            <div className="flex items-center">
                                                ...
                                                <span className="font-bold text-[14px] text-primaryText pl-1 text-redDark">Event Ended</span>
                                                  ...
                                                  <>
                                                  <span className="text-[14px] text-primaryText pl-1">Upcoming Event</span>
                                                  {/* <Countdown
