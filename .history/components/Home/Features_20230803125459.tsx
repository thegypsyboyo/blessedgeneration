...
const Features:React.FC = () => {
  ...
  return (
    <section className='relative block pt-[270px] mt-[120px] pb-[90px] px-0 w-full'>
        <div className="absolute top-0 left-0 right-0 bottom-0 h-[645px] bg-primaryDark -z-[1] full">
            <div className='absolute top-0 bottom-0 right-0 left-0 bg-no-repeat bg-cover  bg-center mix-blend-luminosity opacity-[0.15]' style={{backgroundImage: `url(/images/blog/img-2.jpg)`}}/>
        </div>
                    ...
                    flex-grow-0 flex-shrink-0 group" key={index}>
                        <div className="relative block mb-[30px]">
                            <div className="relative block rounded-tl-[20px] rounded-tr-[20px] overflow-hidden z-[1]">
                                ...
                                <div className='absolute bottom-[30px] left-[30px] bg-yellowColor py-[6px] px-[25px] rounded-[15px] z-[2]'>
                                    <p className='text-[18px] text-primaryDark leading-[18px] font-cav font-[700]'>
                                       {item.category}
                                    </p>
                                </div>
                            </div>
