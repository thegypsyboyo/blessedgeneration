    ...
    <section className='relative block mt-[60px] bg-primaryBase pt-[120px] pb-[246px] px-0 z-[1]'>
        <div className="absolute top-0 bottom-0 right-0 left-0 bg-center bg-cover bg-no-repeat mix-blend-luminosity opacity-[0.1] -z-[1]">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-[100]">
                <div className='bg-center absolute bg-cover w-[1390px] h-[811.2px] overflow-hidden pointer-events-none ' style={{backgroundImage: `url(/images/blog/img-1.jpg)`}} />
            </div>
    ...
    <section className='relative block -mt-[155px] mb-[200px] z-[1] w-full h-full'>
        <Layout className='' >
            <div className="relative block bg-primaryDark pt-[100px] pb-[90px] px-[100px] w-full z-[1] rounded-[30px]">
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-no-repeat bg-cover bg-center rounded-[30px] opacity-10 -z-[1]" style={{backgroundImage: `url(/images/blog/img-4.jpg)`}} />
                <div className="relative block overflow-hidden mb-[37px]">
                    <div className="relative block float-left">
                        <div className="mb-0 relative block -mt-[4px]">
                            ...
                            <h2 className="m-0 text-white text-[50px] leading-[60px] font-[900] -tracking-[0.04] mt-[6px]">Support for eating funds <br/> for hungry people</h2>
                        </div>
                    </div>
                ...
                <div className="relative block w-full z-[1]">
                    <div className="relative w-full h-[20px] bg-primaryBase rounded-[10px] mb-[13px] ">
                        <div className="relative block h-[12px] rounded-[6px] bg-white top-[4px] left-[5px] transition-all duration-[1500ms]"  style={{width: "70%"}}>
                            <div className="absolute right-0 bottom-[25px] text-white leading-[18px] text-center font-[500] transition-all duration-500 ">70%</div>
                        </div>
                    </div>
                    <div className="flex justify-between items-center ">
                        <p className="text-yellowColor font-[500] m-0  space-x-4">
                            <span className="text-[20px] text-white font-[500] leading-[28px]">Ksh.28,000.00</span>
                            Donated 

                        </p>
                        <p className="text-yellowColor font-[500] m-0  space-x-4">
                            <span className="text-[20px] text-white font-[500] leading-[28px] mr-2">Ksh.80,000.00</span>
                            Goal
                        </p>
