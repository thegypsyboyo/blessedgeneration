            ...
            <div className="flex items-start flex-wrap w-full h-full justify-between">
                <div className="lg:max-w-[50%] flex-grow-0 flex-shrink-0 w-full mb-8 pr-[15px] h-full">
                    ...
                    <div className="w-full h-full">
                        ...
                        <h2 className="text-redDark lg:text-[40px] lg:leading-[55px]  xl:text-[48px] font-bold md:text-[30px] md:leading-[45px] text-[26px] leading-[40px] xl:leading-[60px] uppercase">Blessed Generation is an NGO Based in Kenya</h2>

                        <p className="mt-[25px] mb-[20px] text-primaryText text-[18px] font-normal leading-[28px] ">We collaborate with people, teams, and businesses to develop design systems, strategies, and processes to do a better creative work everyday.						
                        </p>
