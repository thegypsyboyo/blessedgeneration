                        ...
                        <p>
                            ...
                            <ul className='mt-[30px] overflow-hidden ml-0 list-none'>
                                <li className="w-full float-left py-0 px-[15px] relative z-[1] pl-[75px] text-darkBlue">
                                    <span className='absolute left-0 top-0  text-center rounded-[50%] font-bold h-[50px] w-[50px]  bg-redDark z-[2]'>
                                    </span>
                                    ...
                                    <p className='mt-5'>
                                        ...
                                        <FontAwesomeIcon icon={faCheck} className='absolute left-0 z-[1] '/>
                                </li>
                            </ul>
                    </div>
                </div>
