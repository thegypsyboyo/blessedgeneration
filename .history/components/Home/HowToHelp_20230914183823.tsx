                    ...
                    <div className='h-full md:w-[48%] w-full flex flex-shrink-0 flex-grow-0 md:mb-0 mb-3'>
                        <div className="w-full h-full relative mb-[30px] mr-[20px]">
                            ...
                            <div className="flex flex-wrap w-full h-full mt-6">
                                ...
                                <div className="w-[22%] h-[100px] mx-2 " key={index}>
                                    <div className="bg-yellowColor w-full h-[100px] p-1 mr-2 text-center">
                                        <Image src={item.image} alt={item.title} width={800} height={800} className='h-full object-cover w-fulls'/>
                                    </div>
                                    <div className="w-full mt-6 flex items-center justify-center">
                                    <span className="uppercase text-center text-light">{item.title}</span>
                                    </div>
                                </div>
                                ))}
                            </div>
