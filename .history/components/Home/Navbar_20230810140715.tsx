                ...
                <div className="main-menu__right-top flex items-center justify-between py-[18px] px-0">
                    ...
                    <div className="main-menu__right-top-right flex items-center">
                        ...
                        <div className="main-menu__right-top-social flex items-center ml-[50px] gap-[10px]">
                            <Link href="#" target='_blank' rel='noreferrer' className='text-primaryDark bg-borderColor relative gap-[10px] h-[40px] w-[40px] flex items-center justify-center text-center text-[14px] rounded-full z-[1] hover:text-white hover:bg-primaryBase hover:opacity-100 hover:transform hover:scale-y-100 '>
