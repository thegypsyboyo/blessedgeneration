    ...
    <section className="py-[120px] relative block bg-white z-[1] h-full">
        <Layout className="h-full">
            <div className="flex flex-wrap  w-full">
                <div className="flex-grow-0  flex-shrink-0 m-auto w-full lg:max-w-[33.333333%]">
                    <div className='relative z-[3] block w-full'>
                        <div className="relative mb-[28px] block -mt-[4px] w-full">
                        <span className="text-[24px] w-full text-orangeDefault font-[700] leading-[24px] mb-[10px] font-cav">Upcoming events</span>
                                    ...
                                    {data.map((item, index) => (
                                        <SwiperSlide key={index}  className='container h-full w-full relative'>
                                            <div className='single w-full h-full mr-[20px] relative block shadow-custom '>
                                                ...
                                                <Image src={item.img} alt='image-data' width={400} height={400}  className='object-cover   h-[450px] w-full rounded-sm'/>
