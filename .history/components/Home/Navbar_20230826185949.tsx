...
const Navbar:React.FC = () => {
  ...
  return (
    <>
    <header className={`relative w-full transition-all duration-1000 ease-in-out ${isSticky ? "fixed top-0 left-0 right-0 z-[99999] transition-all duration-1000 ease-in-out ": ""}`}>
