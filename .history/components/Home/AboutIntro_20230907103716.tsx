            ...
            <div className="flex items-start flex-wrap w-full h-full justify-between">
                ...
                <div className="w-full lg:max-w-[50%] flex-shrink-0 flex-grow-0">
                    <div className="lg:pl-[30px]">
                        <h2 className='font-[800] relative z-[1] mb-[25px] md:text-[30px] text-[25px] lg:leading-[40px] lg:text-[40px] text-redLight tracking-[0.1px]'>Blessed Generation is a loving charitable institution</h2>
                        <p>
