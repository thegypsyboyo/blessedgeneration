        ...
        <Layout className="h-full">
            <div className="flex items-start flex-wrap w-full h-full justify-between">
                ...
                <div className="w-full lg:max-w-[50%] flex-shrink-0 flex-grow-0">
                    ...
                    <div className="w-full h-full bg-redDark flex flex-row">
                        <div className="w-[41.667%] bg-yellowColor h-full flex flex-col items-end gap-[16px] p-0">
                            <div className="w-full h-f"></div>
                            <div className="max-w-full mb-0 h-full">
                                <Image src="/images/testing/gallery-1.jpg" alt='' width={800} height={800} className=''/>
                            </div>
                            <div className="max-w-full h-full">
                                <div className="bg-[#4f46e51a] rounded-[8px] h-full">content</div>
                            </div>
                        </div>
                        <div className="w-[58.333%] h-full bg-yellowColor">
                            <div className="w-full h-full">
                                <Image src="/images/testing/gallery-1.jpg" alt="" width={800} height={800}/>
                            </div>
                        </div>
                    </div>
                </div>
