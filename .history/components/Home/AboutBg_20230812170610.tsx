...
const AboutBg = () => {
  return (
    <section className='w-full min-h-full pb-[100px] pt-[150px]'>
        <div className="bg-no-repeat bg-cover bg-center pb-0  bg-lightBlue  h-screen w-full" style={{backgroundImage: `url(/images/test/bg.jpg)`}}>
