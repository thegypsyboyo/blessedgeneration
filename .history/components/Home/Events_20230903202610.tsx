...
const Events = () => {
  ...
  return (
    <section className="py-[120px] relative block bg-orangeDefault z-[1] h-full">
            ...
            <div className="flex flex-wrap  w-full">
                <div className="flex-grow-0  flex-shrink-0 m-auto w-full lg:max-w-[33.333333%] mb-8">
                    <div className='relative z-[3] block w-full'>
                        ...
                        <h2 className="m-0 text-white text-[50px] leading-[50px] font-[900] -tracking-[0.04em] mt-[6px]">
