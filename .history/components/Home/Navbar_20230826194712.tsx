...
const Navbar:React.FC = () => {
  ...
  return (
    ...
    <header className={`main-header relative w-full transition-all duration-1000 ease-in-out z-[99] ${isSticky ? "fixed top-0 left-0 right-0 z-[99999] transition-all duration-1000 ease-in-out ": ""}`}>
        ...
        <nav className={`main-menu__wrapper relative block pl-[60px] pr-[50px]`}>
            <div className="main-menu__wrapper-inner flex items-center justify-between">
            <div className="main-menu__left !bg-black h-full w-[9%] lg:ml-[160px] ml-[50px]">
                <div className="main-menu__logo max-w-full bg-black items-center justify-center !w-full">
