                ...
                <div className="lg:max-w-[50%] flex-grow-0 flex-shrink-0 w-full mb-8 pr-[15px] h-full">
                    ...
                    <div className="w-full h-full">
                        <div className='max-w-full'>
                            <Image src="/images/logo.jpg" alt="" width={800} height={800} className="w-[60px]"/>
                        </div>
                        <div className='mb-[20px]'>
                        <h6 className='mb-[16px] text-[#4f46e5] text-[18px] font-medium leading-[28px]'>
                            We are a very dedicated team
                        </h6>
                        <h2 className="text-[#161c2d] lg:text-[48px] font-bold leading-[60px]">We are a full-service digital agency</h2>

                        <p className="mt-[25px] text-[#94a3b8] text-[18px] font-normal leading-[28px] ">We collaborate with people, teams, and businesses to develop design systems, strategies, and processes to do a better creative work everyday.						
                        </p>
                        <div className="max-w-full">
                            <div className="inline-flex justify-center items-center bounded-full">
                                <div className="w-[36px] h-[36px] text-white bg-[#4f46e5] rounded-full text-[16px]">
                    ...
                    <div className="w-full h-full  flex flex-row items-center justify-center">
                        <div className=" w-[41.667%]  h-full flex flex-col items-end p-0 pr-[10px]">
                            <div className="max-w-full mb-[10px] h-full">
                                <Image src="/images/testing/gallery-1.jpg" alt='' width={800} height={800} className='object-cover rounded-[8px]'/>
                            </div>
                            <div className="max-w-full h-full">
                                <div className="bg-[#4f46e51a] rounded-[8px] w-[150px] h-[150px]"></div>
                            </div>
                        </div>
                        <div className="w-[58.333%] h-full  pl-[10px]">
                            <div className="w-full h-[400px]">
                                <Image src="/images/testing/gallery-1.jpg" alt="" width={800} height={800} className="w-full h-full object-cover rounded-[8px]"/>
                            </div>
                        </div>
                    </div>
                </div>
