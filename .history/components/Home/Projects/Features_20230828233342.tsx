...
const Project:React.FC<ProjectItemProps> = ({slug, title, image,lgColSpan, mdColSpan, width}) => {
  return (
      <article className='flex flex-col items-center justify-center'>
        {image ? (
          <div className="w-full h-full relative block group">
            ...
            <div className="flex items-center flex-col  justify-end absolute z-[3] top-0 left-0 w-full h-full p-[25px] text-left transition-all duration-700 overflow-hidden opacity-0 group-hover:visible group-hover:opacity-[1] ">
              <div className="mb-[11px] ">
                <Link href={""} className='text-white bg-yellowColor px-[15px] h-[24px] inline-block leading-[24px] text-[12px] font-semibold uppercase'>Child Care</Link>
              </div>
            ...
            <div className='absolute z-[1] top-0 left-0 w-full h-full transition-all duration-500 overlay opacity-0 hidden group-hover:opacity-[1] group-hover:block'/>
          </div>
        ): (
