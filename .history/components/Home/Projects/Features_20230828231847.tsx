      ...
      <article className='flex flex-col items-center justify-center'>
        {image ? (
          <div className="w-full h-full relative block">
            ...
            <div className="flex items-center flex-col  justify-center absolute z-[3] top-0 left-0 w-full h-full p-[25px] text-left transition-all duration-700 overflow-hidden bg-darkBlue">
            ...
            <div className="transition-all duration-700 mb-3 pt-2">
