      ...
      <article className='flex flex-col items-center justify-center'>
        {image ? (
          <div className="w-full h-full relative overflow-hidden block group">
            ...
            <div className="flex items-center flex-col  justify-end absolute z-[3] top-0 left-0 w-full h-full p-[25px] text-left transition-all duration-700 overflow-hidden opacity-0 transform translate-y-[120px] group-hover:visible group-hover:opacity-[1] ">
