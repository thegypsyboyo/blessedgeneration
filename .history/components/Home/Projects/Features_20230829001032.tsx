...
const Project:React.FC<ProjectItemProps> = ({slug, title, image,lgColSpan, mdColSpan, width}) => {
  return (
      <article className='flex flex-col items-center justify-center'>
        {image ? (
          <Link href={slug} className="w-full h-full relative overflow-hidden block group">
          ...
          <div className='relative w-full h-[300px] bg-redDark z-[1]'>
            <div className="bg-center bg-cover pt-[1%] pb-[3%] pr-[5%] pl-[5%]  bg-no-repeat w-full h-full z-[2] absolute left-0 right-0 bottom-0 flex justify-start items-center content-[]">
              <div className="z-[2]">
                ...
                <AnimatedButton className='bg-[#0B3D19]' link='' text='Explore more' style='!mt-[20px] rounded-none bg-yellowColor'/>
              </div>
            </div>
          </div>
        )}
