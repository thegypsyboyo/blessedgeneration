  ...
  return (
      <article className='flex flex-col items-center justify-center'>
        {image ? (
          <div className="w-full h-full relative overflow-hidden block group">
            ...
            <div className="flex items-center flex-col  justify-end absolute z-[3] top-0 left-0 w-full h-full p-[25px] text-left transition-all duration-1000 overflow-hidden opacity-0 transform translate-y-[150px] group-hover:visible group-hover:translate-y-[0px]  group-hover:opacity-[1] ">
              <div className="mb-[11px] transition-all duration-[900]">
                <Link href={slug} className='text-white bg-yellowColor px-[15px] h-[24px] inline-block leading-[24px] text-[12px] font-semibold uppercase transition-all duration-700 hover:bg-redDark'>Child Care</Link>
              </div>
              <div className="text-center transition-all duration-700 mb-3 pt-2">
                <h4 className='text-white font-semibold font-nun text-[24px] leading-[33px] hover:text-yellowColor transition-all duration-700'>
                  <Link href={slug}>How can supporting benefit a child.</Link>
                </h4>
              </div>
            </div>
          ...
          <div className='relative w-full h-[300px] bg-redDark z-[1]'>
            <div className="bg-center bg-cover pt-[1%] pb-[3%] pr-[5%] pl-[5%]  bg-no-repeat w-full h-full z-[2] absolute left-0 right-0 bottom-0 flex justify-start items-center content-[]">
              <div className="z-[2]">
                <span className="text-white font-nun text-[18px] capitalize mb-3 font-[400] ">Our Projects thus far</span>
                ...
                <AnimatedButton className='bg-[#0B3D19]' link='/projects' text='Explore more' style='!mt-[20px] rounded-none bg-yellowColor'/>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-12 gap-4 w-full h-full bg-transparent">
          {/* {projects.map((project, index) => (
            ...
            {/* {projects.map((item, index) => (
                ...
                <div className='md:col-span-6 lg:col-span-6 col-span-12'>
                  <Project 
                    image='/images/testing/gallery-9.jpg'
                    title={" Crypto Screener Application"} 
                    slug=''
