      ...
      <article className='flex flex-col items-center justify-center'>
        {image ? (
          ...
          <div className='relative w-full h-[300px] bg-yellowColor z-[1]'>
            <div className="bg-[#0B3D19] bg-center bg-cover pt-[1%] pb-[12%] pr-[5%] pl-[5%]  bg-no-repeat w-full h-full z-[2] absolute left-0 right-0 bottom-0 flex justify-start items-center content-[]">
              <div className="z-[2]">
                <span className="text-yellowColor font-cav text-[26px] font-[400] ">Our awesome portfolio</span>
                <h4 className="font-man font-semibold text-[42px] leading-[48px] tracking-tighter text-white">You Can Explore<br/>Our Incredible Projects</h4>
                <AnimatedButton className='' link='' text='Explore more' style='mt-0 rounded-none'/>
              </div>
            </div>
          </div>
        )}
