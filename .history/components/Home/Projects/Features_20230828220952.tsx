  ...
  return (
      <article className='flex flex-col items-center justify-center'>
        {image ? (
          ...
          <div className='w-full h-[300px] bg-yellowColor z-[1]'>
            <div className="bg-darkBlue bg-center bg-cover pt-[1%] pb-[12%] pr-[5%] pl-[5%] bg-no-repeat w-full h-full z-[-1]" style={{backgroundImage: `url(/images/test/gallery-1.jpg)`}}></div>
          </div>
        )}
      </article>
  )
