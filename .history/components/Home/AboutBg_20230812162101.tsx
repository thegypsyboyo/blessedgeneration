  ...
  return (
    <section className='mb-0 w-full h-screen pt-[150px] !m-auto'>
        <div className="bg-no-repeat bg-cover bg-center pb-0 h-full w-full" style={{backgroundImage: `url(/images/test/bg.jpg)`}}>
            ...
            <Layout className="w-full h-auto flex !items-center !justify-center ">
                <div className="flex items-center flex-wrap w-full h-full bg-yellowColor justify-between mp-11">
                    <div></div>
