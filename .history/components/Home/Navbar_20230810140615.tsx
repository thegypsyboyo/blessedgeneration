            ...
            <div className="main-menu__right block w-[91%]">
                <div className="main-menu__right-top flex items-center justify-between py-[18px] px-0">
                    ...
                    <div className="main-menu__right-top-right flex items-center">
                        ...
                        <div className="main-menu__right-top-social flex items-center ml-[50px] gap-[10px]">
                            <Link href="#" target='_blank' rel='noreferrer' className='text-primaryDark bg-borderColor relative gap-[10px] h-[40px] w-[40px] flex items-center justify-center text-center text-[14px] rounded-full z-[1] hover:text-white hover:bg-primaryBase hover:after:opacity-100 hover:after:transform hover:after:scale-y-100 '>
                                <span className='absolute content-[] top-0 left-0 right-0 h-full bg-primaryBase delay-[0.1s] ease-in-out transition-all duration-500 opacity-100  transform origin-top scale-y-0 -z-[1] '/>
                                <BsInstagram/>
                            </Link>
