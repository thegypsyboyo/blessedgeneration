                        ...
                        <div className="w-full h-full">
                            <form action="" className='relative mb-0'>
                                ...
                                <ul className="flex w-full h-full flex-wrap ">
                                    ...
                                    <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                        <button className="outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]">$40</button>
                                    </li>
                                </ul>
                            </form>
                        </div>
