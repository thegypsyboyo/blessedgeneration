...
const Child = () => {
  ...
  return (
    <section className="relative block pt-[120px] pb-[90px] bg-white">
        <div className="w-full h-full block">
            {/* <div className='relative -mt-[40px] mb-[46px] flex flex-col items-center justify-center w-full'>
                <span className="text-2xl text-orangeDefault font-normal leading-[24px] mb-[10px] font-man uppercase text-center">how you can help</span>
            ...
            <div className="flex items-start flex-wrap w-full h-full justify-between">
                ...
                <div className="w-full lg:max-w-[50%] flex-shrink-0 flex-grow-0">
                    <div className="lg:pl-[30px]">
                        <span className="">How you can help</span>
                        ...
                        <p>
                            ...
                            <AnimatedButton className='' text='sponsor a child' style='' link='/sponsorship'/>
                    </div>
                </div>
            </div>
            </Layout>
