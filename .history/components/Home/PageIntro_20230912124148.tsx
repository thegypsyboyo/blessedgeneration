            ...
            <SwiperSlide className="swiper" key={index}>
              <div className="page-intro__slide relative">
                <div className="single-banner" >
                  <div className="w-screen h-screen absolute top-0 bottom-0 right-0 left-0 scale-1 bg-no-repeat bg-cover mix-blend-luminosity bg-left" style={{backgroundImage: `url(${urlFor(item.image).url()})`}} />
