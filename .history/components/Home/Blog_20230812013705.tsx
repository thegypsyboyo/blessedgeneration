    ...
    <section className="relative block pt-[120px] pb-[90px] bg-[#ecf6fa]">
        <Layout className="flex flex-col">
            <div className='relative -mt-[40px] mb-[46px] flex flex-col items-center justify-center w-full'>
                ...
                <h2 className="m-0 text-[#0e2258] text-2xl leading-7 font-bold -tracking-[0.04em] mt-[6px] text-center lg:text-3xl lg:leading-9 xl:text-[50px] lg:max-w-[650px] xl:leading-[60px] relative">Most popular breaking news & top stories
                <span className="absolute content-[] bg-orangeDefault left-1/2 bottom-0 h-0.5 w-16 "/>
                </h2>
            </div>
