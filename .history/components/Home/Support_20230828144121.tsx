  ...
  return (
    <section className="relative block mt-0 pt-[0] pb-[90px] bg-white">
        <div className="w-full h-full block">
            ...
            <div className="w-full h-full md:max-w-[50%] flex-shrink-0 flex-grow-0 bg-yellowColor lg:h-[600px] h-[500px]">
                    <div className="md:p-[50px] p-[30px] lg:p-[90px] flex flex-col items-center justify-center w-full h-full">
                ...
                <div className="md:max-w-[50%] flex-grow-0 flex-shrink-0 w-full h-[500px] lg:h-[600px]">
                                ...
                                <div className='w-full h-full'>
                                    {duplicatedData.map((item, index) => (
                                        <SwiperSlide key={index}  className='container h-full w-full relative'>
                                              <Image src={item.img} alt='main-image' width={200} height={200} priority className='w-full h-[500px] lg:h-[600px] object-cover'/>
                                        </SwiperSlide>
                                    ))}
                                </div>
                        </Swiper>
