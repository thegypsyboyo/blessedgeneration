                ...
                <div className="flex shadow-main bg-white flex flex-wrap w-full">
                    ...
                    <div className="md:w-[62%] text-left bg-white py-[60px] px-[50px]">
                        <div className="pr-[180px]">
                            <h3 className="text-[6px] leading-[28px] font-[500] text-[#002866]  mb-[4px] ">Please select </h3>
                            <h2 className="text-[30px] leading-[45px] text-[#002866] mb-[8px]">All donations are tax deductable</h2>
                        </div>
                    </div>
                </div>
