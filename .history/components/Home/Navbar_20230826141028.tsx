...
const Navbar:React.FC = () => {
  ...
  return (
    <>
    <header className='main-header relative w-full shadow-custo'>
                ...
                <div className="main-menu__right-bottom bg-yellowColor w-full text-darkBlue">
                    <div className="main-menu__main-menu-box">
                        ...
                        <ul className='main-menu main-menu__list m-0 p-0 list-none items-center hidden xl:flex'>
                            ...
                            <Link href="" className={` relative group text-redLight text-[16px] flex transition-all duration-500 font-[600]`}>
                                name
                                <span className={`h-[1px] bg-yellowColor inline-block absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 ${currentPath === "name" ? 'w-full': 'w-0'}`}>&nbsp;</span>
