            ...
            <div className="flex w-full h-full  relative mx-auto flex-wrap">
                <div className="flex-grow-0 flex-shrink-0 md:w-[61.917%] w-full">
                    <div className="w-full p-4 items-start  flex flex-col relative">
                        ...
                        <h2 className="!ml-0 lg:w-[525px] flex items-start justify-start text-white text-[40px] font-bold leading-[55px] mb-[20px] text-[18px] font-normal leading-[33px] text-white ">Some People Need Help And We Give It! </h2>
                        <p className='max-w-[525px] '>Alienum phaedrum torquatos nec eu, vis detrax culis ex, nihis in mei. Mei an periculaeuripidis.</p>
                    </div>
                </div>
                <div className="flex-grow-0 flex-shrink-0 md:w-[38.083%] w-full"></div>
            </div>
        </Layout>
    </section>
  )
