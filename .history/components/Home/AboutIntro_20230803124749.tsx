                    ...
                    <div className="relative block mr-[40px] w-full h-full">
                        <div className="relative block h-full w-full">
                            <div className="1 relative block h-full w-full">
                                <Image src="/images/events/image-2.jpg" alt='main-image' width={400} height={400} className='object-cover rounded-full h-full w-full'/>
                            </div>
                            
                            <div className="absolute -bottom-[75px] -right-[95px]">
                                <Image src="/images/blog/img-2.jpg" alt='main-image' width={200} height={200} className='w-full h-full object-cover rounded-full'/>
                            </div>
