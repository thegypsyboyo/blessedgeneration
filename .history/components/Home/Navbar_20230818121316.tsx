    ...
    <header className='main-header'>
        <nav className="main-menu__wrapper">
            ...
            <div className="main-menu__right block w-[91%]">
                ...
                <div className="main-menu__right-bottom bg-white shadow-custom w-full text-darkBlue">
                    <div className="main-menu__main-menu-box">
                        ...
                        <ul className='main-menu main-menu__list m-0 p-0 list-none items-center hidden xl:flex'>
                            <li className='dropdown '>
                                ...
                                {/* <Link href=""className={` relative group text-orangeDefault text-[16px] flex transition-all duration-500 font-[600]`}>
                                    Home
                                    <span className={`h-[1px] bg-orangeDefault inline-block absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 ${currentPath === "Home" ? 'w-full': 'w-0'}`}>&nbsp;</span>
                                </Link> */}
                            </li>
                            <li className='dropdown'>
                            <CustomLink className='' href='/blessed-generation-kenya' title='About us'  />
                                <ul>
                                    <li className=''>
                            ...
                            <li className='dropdown'>
                                <CustomLink className='' href='#' title='Safaris'  />
                                <ul>
                                    <li className=''>
                    ...
                    <div className="main-menu__main-menu-content-box">
                        <div className="main-menu__search-cat-btn-box">
                            ...
                            <div className="relative flex items-center z-100 ml-[10px] bg-redDark">
                                <Link href="/donate-now" className='main-menu__btn text-[14px] font-[700] text-white bg-orangeDefault z-[2] pl-[50px] pt-[19px] pb-[19px] relative flex items-center uppercase transition-all duration-500 hover:text-white hover:bg-darkBlue group  '>
                                    <span className='content-[] absolute top-0 bottom-0 left-0 right-0 w-[calc(100%+50px)] bg-orangeDefault -z-[1] group-hover:bg-darkBlue transition-all duration-500' />
