      ...
      <div className='relative w-full h-full flex box-content transition-transform'>
        {sliderData?.map((item, index) =>(
          <div className="w-full h-full" key={index}>
            ...
            <SwiperSlide 
              className='relative w-full z-[5] flex items-center min-h-[850px]'
              key={index}
            >
                ...
                <div className="flex w-full h-full flex-wrap items-center mt-[120px]">
                  <div className="lg:w-[66.6667%] flex-grow-0 flex-shrink-0 h-full w-full">
                    <div className="w-full h-full pt-[80px] ">
                      ...
                      <h1 className="font-man text-fade mb-[30px] font-extrabold uppercase text-[#0b3d2c] lg:text-[90px] lg:leading-[90px] xl:leading-[100px] xl:text-[100px] md:leading-[80px] leading-[50px] md:text-[80px] text-[48px]">make dream gardening</h1>
                      <div className="max-w-[570px] py-[19px] px-[28px] bg-white rounded-tl-0 rounded-tr-[10px] rounded-br-[10px] border-l border-l-[2px] border-l-redDark">
                        <p className='text-[18px] font-[500] text-dark leading-[28px] mb-0'>The laying out and care of a plot of ground devoted partially or wholly to the growing of plants such as flowers.</p>
                      </div>
                      <div className="flex w-full h-full items-center mt-[20px]">
                        <div className="bg-redLight text-white flex font-bold h-[60px] leading-[58px] rounded-[10px] py-0 px-[34px] relative items-center justify-center uppercase">
                          get in touch
                        </div>
                      </div>
                    </div>
