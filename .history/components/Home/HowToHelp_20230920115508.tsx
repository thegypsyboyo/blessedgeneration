                ...
                <div className="flex shadow-main bg-white flex flex-wrap w-full">
                    <div className="md:w-[38%] bg-[#002866] py-[60px] px-[55px]">
                        ...
                        <div className="text-[16px] leading-[28px] text-white mb-0 w-full h-full ">
                            ...
                            <div className="relative block w-full bg-borderColor rounded-[20px] border-solid border-borderColor z-[1]">
                            ...
                            <form action="" className='relative mb-0'>
                                ...
                                <ul className="flex w-full h-full flex-wrap mb-[20px]">
                                    <li className="flex-shrink-0  flex-grow-0 ">
                                        <button className="outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]">$10</button>
                                    </li>
                                    <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                        <button className="outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]">$10</button>
                                    </li>
                                    <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                        <button className="outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]">$50</button>
                                    </li>
                                    <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                        <button className="outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]">$100</button>
                                    </li>
                                    <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                        <button className="outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] h-[50px] w-[100px]">Custom Amount</button>
                                    </li>
                                </ul>
                                <div className="w-full ">
                                    <button className="bg-[#002866]  text-[16px] font-bold uppercase text-white transition-all duration-500 mb-[150x] rounded-[4px] items-center px-[30px] outline-none border-none flex  justify-start h-[50px]">donate now </button>
                                </div>
                            </form>
                        </div>
                    </div>
