...
const Projects = () => {
  ...
  return (
    <>
    <Partner className='mt-[200px] shadow-none bg-white'/>
        <section className='overflow-hidden mt-[-100px] pt-[270px] pb-[200px] w-full h-full bg-no-repeat bg-cover bg-center relative z-[1]' style={{backgroundImage: `url(/images/test/gallery-1.jpg)`}}>
