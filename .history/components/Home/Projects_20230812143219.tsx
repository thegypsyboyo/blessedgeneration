    ...
    <section className="py-[120px] relative block bg-lightBlue z-[1] h-full">
        <Layout className="">
            <div className="flex flex-col justify-center items-center  w-full h-full">
                <div className="flex-grow-0 flex-shrink-0 w-full m-auto mb-[30px]">
                    <div className='relative z-[3] lg:max-w-540  w-full flex flex-col items-center justify-center text-center'>
