...
const Projects = () => {
  ...
  return (
    <section className='mt-[90px] py-[120px] mt-[90px]  w-full h-full bg-no-repeat bg-cover bg-center relative z-[5] ' style={{backgroundImage: `url(/images/test/gallery-1.jpg)`}}>
