  ...
  return (
    <section className="relative block mt-0 pt-[0] pb-[0] bg-white w-full h-full ">
        <div className="w-full h-full block">
            ...
            <div className="w-full md:max-w-[50%] flex-shrink-0 flex-grow-0 bg-redDark lg:h-[600px] h-[500px]">
                    <div className="md:p-[50px] p-[30px] lg:p-[90px] flex flex-col items-center justify-center w-full h-full text-center">
                        ...
                        <AnimatedButton className='' link='/become-volunteer' text='volunteer' style='!bg-yellowColor !rounded-[10px]'/>
                    </div>
                </div>
