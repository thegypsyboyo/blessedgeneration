    ...
    <section className='py-[120px] w-full h-full'>
        <Layout className="h-full">
            <div className="flex items-center flex-wrap w-full h-full justify-between">
                ...
                <div className="w-full lg-max-w-1/2 flex-shrink-0 flex-grow-0">
                    <div className="pl-[30px]">
                        <h2 className='font-bold relative z-[1] mb-[25px]  text-[36px]'>Developing powerful brands &amp; business identities</h2>
                    </div>
                </div>
            </div>
        </Layout>
