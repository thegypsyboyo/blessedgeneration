    ...
    <header className='main-header'>
        <nav className="main-menu__wrapper">
            ...
            <div className="main-menu__right block w-[91%]">
                ...
                <div className="main-menu__right-bottom bg-white shadow-custom w-full text-white">
                    <div className="main-menu__main-menu-box">
                        ...
                        <ul className='main-menu main-menu__list m-0 p-0 list-none items-center text-white hidden xl:flex'>
                    ...
                    <div className="main-menu__main-menu-content-box">
                        <div className="main-menu__search-cat-btn-box">
                            ...
                            <div className="relative flex items-center z-100 ml-[10px] bg-redDark">
                                <Link href="/donate" className='main-menu__btn text-[14px] font-[700] text-primaryDark bg-yellowColor pl-[50px] pt-[19px] pb-[19px] relative flex items-center uppercase transition-all duration-500 hover:text-white hover:bg-orangeDefault group  '>
