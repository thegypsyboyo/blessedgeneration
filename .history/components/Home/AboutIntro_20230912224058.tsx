    ...
    <section className='pt-[120px] w-full h-full'>
        <Layout className="h-full">
            <div className="flex items-start flex-wrap w-full h-full justify-between">
                ...
                <div className="w-full my-[100px] mr-[-80px] ml-[70px] flex relative">
                    <div className="bg-[#6a161600] w-full h-full" style={{backgroundImage:`url(${"/images/testing/gallery-1.jpg"})`}}></div>
