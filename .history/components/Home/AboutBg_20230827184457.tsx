            ...
            <Layout className="h-full flex !items-center !justify-center !overflow-visible ">
                <div className="flex items-center flex-wrap w-full h-full justify-between mp-11 ">
                    ...
                    <div className=" lg:max-w-[56.666667%] w-full  flex flex-shrink-0 flex-grow-0">
                        <div className="p-14 relative z-[2] bg-yellowColor w-full mt-[180px] mb-[-80px] min-h-[500px]">
                        <h2 className="font-bold -mt-1 mb-6 text-redDark text-4xl font-man">We Create digital products That Make people’s Lives More Easier.</h2>
                        <p className='text-darkBlue font-normal text-base'>
