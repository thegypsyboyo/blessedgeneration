                    ...
                    <div className='w-full h-full flex flex-wrap items-center justify-center'>
                        <div className="md:w-[50%] w-full h-full md:pr-[10px]">
                            <div className="w-full h-full">
                                <h5 className="mb-3 text-light  text-[18px] font-bold leading-[28px]"><span>My Story</span></h5>
                                <h2 className="text-white text-[30px] font-semibold leading-[45px]">Today on my Story we present Jane Doe </h2>
                            </div>
                        </div>
