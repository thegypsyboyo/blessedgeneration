    ...
    <section className="relative block pt-[120px] pb-[90px] bg-[#ecf6fa]">
        <Layout className="flex flex-col">
            <div className='relative -mt-[40px] mb-[46px] flex flex-col items-center justify-center w-full'>
                ...
                <h2 className="m-0 text-primaryDark text-[40px] leading-[45px] font-[800] -tracking-[0.04em] mt-[6px] text-center lg:text-[45px] lg:leading-[50px] xl:text-[50px] xl:leading-[60px]">Most popular breaking news & top stories</h2>
            </div>
