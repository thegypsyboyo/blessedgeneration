  ...
  return (
    <>
        <section className='overflow-hidden mt-0 pt-[120px] pb-[110px] w-full h-full bg-no-repeat bg-cover bg-center relative z-[2]'>
            <div className='absolute content-[] w-full h-full bg-redLight flex items-center justify-center z-[-1] left-0 top-0 overflow-hidden'>
                ...
                <div className="flex flex-col justify-center items-center  w-full h-full">
                    <div className="flex-grow-0 flex-shrink-0 w-full mb-10">
                        <div className='relative z-[3] lg:max-w-540 m-auto w-full flex flex-col items-center justify-center text-center'>
                            ...
                            <span className="text-[24px] w-full text-white font-normal  leading-[24px] mb-[10px] font-man uppercase">[ Testimonials ]</span>
                            <h2 className="m-0 text-primaryDark text-[50px] leading-[50px] font-[900] -tracking-[0.04em] mt-[6px]">
                                <AnimatedText text={"what people say about us"} className={"text-white !uppercase font-[800] font-man"} />
                            </h2>
                            </div>
                        </div>
                    </div>
                            ...
                            {duplicatedData.map((item, index) => (
                                <SwiperSlide key={index}  className='container h-full w-full relative z-[10] bg-transparent'>
                                    <div className='single w-full h-full relative block group '>
                                        <div className="bg-white shadow-custom px-[20px] py-[48px] xl:py-[50px] xl:px-[32px] text-center mb-[45px] relative z-[2] transition-all duration-500 rounded-xl">
                                            ...
                                            <p className="text-[20px] font-[400] uppercase mb-[30px] transition-all duration-500 text-black" >“ When starting a garden, one of the top pieces of advice is o invest in soil that is nutrient rich &amp; well drained. ”</p>
