                ...
                <div className="flex-shrink-0 flex-grow-0 md:max-w-[50%] lg:max-w-[33.333333%] xl:max-w-[33.333333%] w-full pl-[15px] pr-[15px] mt-0 group " key={index}>
                    ...
                    <div className="relative block mb-[30px] border-solid border-2 border-[#dcdfe9]">
                        <div className="relative block z-[1] overflow-hidden">
                            ...
                            <Image src={item.image} width={400} height={400} alt="main-image" className="w-full h-[350px] object-cover align-middle transform scale-[1] transition duration-500 ease group-hover:scale-[1.05]"/>
                            ...
                            <div className="">
                             ...
                             <div className="mt-7">
                                    <ul className="-mb-2 text-white list-none pl-0">
                        ...
                        <div className="relative block mb-[30px] border-solid border-2 border-[#dcdfe9] p-8 w-full h-[350px]">
                                ...
                                <h4 className="text-2xl font-semibold transition-all duration-500 text-[#0e2258] font-man hover:text-orangeDefault">
                                    <Link href="" className="" >{item.title}</Link>
                                </h4>
                                <p className="mb-4 text-primaryText text-sm">
