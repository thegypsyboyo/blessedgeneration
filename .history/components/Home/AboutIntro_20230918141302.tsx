                ...
                <div className="lg:max-w-[50%] flex-grow-0 flex-shrink-0 w-full mb-8 pr-[15px] h-full">
                    ...
                    <div className="w-full h-full">
                        <div className='max-w-full'>
                            <Image src="/images/logo.jpg" alt="logo" width={800} height={800} className="w-[60px]"/>
                        </div>
                        ...
                        <div className="max-w-full mt-[25px]">
                            <div className="inline-flex justify-center items-center bounded-full">
                                <div className="w-[36px] h-[36px] text-white bg-redDark rounded-full text-[16px] flex items-center justify-center" onClick={openModal}>
                    ...
                    <div className="w-full h-full  flex flex-row items-center justify-center">
                        <div className=" w-[41.667%]  h-full flex flex-col items-end p-0 pr-[10px]">
                            <div className="max-w-full mb-[10px] h-full">
                                <Image src="/images/testing/gallery-1.jpg" alt='gallery-1' width={800} height={800} className='object-cover rounded-[8px]'/>
                            </div>
