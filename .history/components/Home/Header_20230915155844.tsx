                ...
                <div className="flex w-full h-full flex-wrap items-center mt-[120px]">
                  <div className="lg:w-[66.6667%] flex-grow-0 flex-shrink-0 h-full w-full">
                    <div className="w-full h-full pt-[80px] ">
                      ...
                      <h1 className="font-man text-fade mb-[30px] font-extrabold uppercase text-[#0b3d2c] lg:text-[90px] lg:leading-[90px] xl:leading-[100px] xl:text-[100px] md:leading-[80px] leading-[50px] md:text-[80px] text-[48px]">{slider.title}</h1>
