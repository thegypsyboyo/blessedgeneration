...
const Projects = () => {
  ...
  return (
    <section className="py-[120px] relative block bg-lightBlue z-[1] h-full">
        <Layout className="">
                                ...
                                <div className='h-full w-full'>
                                    {duplicatedData.map((item, index) => (
                                        <SwiperSlide key={index}  className='container h-full w-full relative'>
                                            <div className='single w-full h-full mr-[20px] relative block shadow-custom group transition-all duration-500 ease-in-out '>
                                                <div className="relative block overflow-hidden  z-[1] h-full">
                                                <Image src={item.img} alt='image-data' width={400} height={400}  className='object-cover h-full w-full transform  translate-x-[-50px] scale-125 group-hover:translate-x-0'/>
                                                <div className='absolute top-0 bottom-0 left-0 right-0 content-[] bg-primaryDark bg-custom-gradient z-[1] group-hover:translate-x-0'/>
