...
const Header = ({sliderData, navquery}:Props) => {
  console.log("SLider Contents: ", sliderData)
  console.log("Nav Query: ", navquery)
  
  return (
   
    <Swiper
    className='flex items-start relative z-[1] bg-white w-full h-full '
    effect={'fade'}
    autoplay={{
      delay: 5000,
          ...
          <div className="" key={index}>
            ...
            >
              ...
              <div className="" >
                ...
                <div className="w-full h-[140vh] text-center bg-cover bg-center relative" style={{backgroundImage: `url(${urlFor(slider.image).url()})`}}>
