...
const Navbar:React.FC = () => {
  ...
  // function for dynamic rendering of the menu items
    ...
    useEffect(() => {
        function handleScroll() {
          const navigationMenu = document.querySelector(".main-menu__wrapper") as HTMLElement;
  ...
  return (
    ...
    <header className='main-header relative w-full shadow-custo'>
        <nav className={`main-menu__wrapper ${isSticky ? "fixed top-0 left-0 right-0 z-[99999]": ""}`}>
