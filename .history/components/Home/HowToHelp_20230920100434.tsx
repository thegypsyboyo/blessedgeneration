                        ...
                        <div className="text-[16px] leading-[28px] text-white mb-0 w-full h-full ">
                            <div className="flex justify-between mb-[16px] w-full ">
                                <div className="flex text-left items-center">
                                    Raised so far
                                    <span className="text-[26px] font-bold leading-[45px] text-[#fe0] mt-1 pl-1">$1,200</span>
                                </div>
                                <div className="flex text-right items-center">
                                    Our goal 
                                    <span className="text-[26px] font-bold leading-[45px] text-[#fe0] mt-1 pl-1">$5,200</span>
                                </div>
                            </div>
                        </div>
                    </div>
