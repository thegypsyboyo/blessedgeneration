        ...
        <Layout className="">
            <div className="flex w-full h-full  relative mx-auto flex-wrap">
                <div className="flex-grow-0 flex-shrink-0 md:w-[61.917%] w-full">
                    <div className="w-full p-4 items-center flex flex-col relative">
                        <h3 className="w-full text-[#fe0] text-[16px] font-medium  uppercase leading-[28px] mb-[20px]">Mission is Give for People</h3>
                        <h2 className="ml-0 lg:max-w-[525px] flex items-start justify-start  text-white text-[40px] font-bold leading-[55px]">Some People Need Help And We Give It!</h2>
                    </div>
                </div>
