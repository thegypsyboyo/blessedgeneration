  ...
  return (
    <>
        <section className="flex flex-col w-full items-center justify-center h-full mt-0 mr-0 mb-[-230px]">
                ...
                <div className="mx-auto w-full md:w-[83.333%] flex items-center justify-center p-0 flex-col h-[500px] relative">
                    <Image src={"/images/testing/gallery-3.jpg"} alt='gallery-3' width={800} height={800} className="w-full h-full object-cover rounded-lg"/>
                    <div className="max-w-full mt-[25px]">
                    <span className="w-[120px] h-[120px] leading-[120px] bg-white inline-block rounded-full text-darkBlue cursor-pointer text-center absolute top-[40%] left-[50%]">
