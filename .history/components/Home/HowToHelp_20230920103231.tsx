                    ...
                    <div className="md:w-[62%] text-left bg-white py-[60px] px-[50px]">
                        ...
                        <div className="w-full h-full">
                            <form action="" className='relative mb-0'>
                                <div className="absolute top-[-120px] right-0 w-[162px] ">
                                    <div className="flex mb-[30px] relative">
                                        <div className='content-[] table '/>
                                        <span className="bg-[#002866] text-white">$</span>
                                        <input type='text' className="text-[#002866] text-[24px] font-[600] px-[20px]"/>
                                    </div>
                                </div>
                            </form>
                        </div>
