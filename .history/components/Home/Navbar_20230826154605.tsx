...
const Navbar:React.FC = () => {
  ...
  // function for dynamic rendering of the menu items
    ...
    useEffect(() => {
        function handleScroll() {
          ...
          const scrollThreshold = 400; // Adjust this threshold as needed
  ...
  return (
    <>
    <header className={`main-header relative w-full transition-all duration-1000 ease-in-out ${isSticky ? "fixed top-0 left-0 right-0 z-[99999]": ""}`}>
