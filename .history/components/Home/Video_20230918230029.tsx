            ...
            <Layout>
                <div className="w-full h-full mx-auto md:w-[83.333%] pt-[290px]">
                    <div className='w-full h-full flex flex-wrap'>
                        <div className="md:w-[50%] w-full h-full pr-[10px]">
                        ...
                        <div className="w-[50%] h-full pl-[10px]">
                            <div className="w-full h-full text-[#FFFFFF80] text-[16px] font-normal leadin-[26px] ">                                
