...
const Features:React.FC<SingleImageGalleryProps>= ({images}) => {
  return (
    <section className='relative block pt-[120px] mt-[0] pb-[90px] px-0 w-full h-full' >
        <Layout>
            <div className="grid grid-cols-32 gap-4 w-full">
                {images.map((imageInfo, index) => (
                <div key={index} className={`w-full h-full bg-yellowColor sm:col-span-${imageInfo.colSpan} md:col-span-${imageInfo.colSpanMd} lg:col-span-${imageInfo.colSpanLg}`}>
