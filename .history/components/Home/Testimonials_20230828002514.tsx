...
const  Testimonials = () => {
  ...
  return (
    ...
    <Partner className='mt-[200px] !bg-light'/>
        <section className='overflow-hidden mt-[-100px] pt-[200px] pb-[200px] w-full h-full bg-no-repeat bg-cover bg-center relative z-[1]' style={{backgroundImage: `url(/images/test/gallery-1.jpg)`}}>
