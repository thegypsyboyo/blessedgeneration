...
const  Testimonials = () => {
  ...
  return (
    <>
        <section className='overflow-hidden mt-0 pt-[120px] pb-[90px] w-full h-full bg-no-repeat bg-cover bg-center relative z-[1]' style={{backgroundImage: `url(/images/test/gallery-1.jpg)`}}>
