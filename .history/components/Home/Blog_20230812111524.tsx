                            ...
                            <div className="">
                             ...
                             <div className="mt-7">
                                    <ul className="-mb-2 text-white list-none pl-0">
                                        <li className="relative z-[1] text-xs uppercase pr-16 float-left flex">
                                            <Image src="/images/events/image-1.jpg" alt="profile " width={50} height={50} className="w-9 h-9 mr-3 rounded-full"/>
