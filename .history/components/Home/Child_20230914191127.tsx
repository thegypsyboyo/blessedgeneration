                                ...
                                <div className=''>
                                    {duplicatedData.map((item, index) => (
                                        <SwiperSlide key={index}  className='h-full w-full relative'>
                                              <Image src={item.img} alt='main-image' width={800} height={800} priority className='w-full lg:h-[600px] h-[500px] object-cover'/>
                                        </SwiperSlide>
                                    ))}
                                </div>
                        </Swiper> */}
                        <Image src={"/images/testing/gallery-6.jpg"} alt='' width={800} height={800} className='w-full h-full object-cover'/>
                    </div>
                </div>
                <div className="w-full lg:max-w-[50%] flex-shrink-0 flex-grow-0 lg:h-[600px] h-[500px] bg-redDark">
                    <div className="w-full h-full flex flex-col items-center justify-center md:p-[50px] p-[30px] lg:p-[90px] text-center">
                        <h2 className='font-bold relative z-[1] mb-[25px]  text-[36px] text-white '>Become a child sponsor</h2>
                        ...
                        <AnimatedButton className='' link='/sponsor-a-child' text='sponsor a child' style='!bg-yellowColor !rounded-[10px]'/>
                    </div>
                </div>
            </div>
            </Layout>
