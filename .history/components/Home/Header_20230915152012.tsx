      ...
      <div className='relative w-full h-full flex box-content transition-transform'>
        {sliderData?.map((item, index) =>(
          <div className="w-full h-full" key={index}>
            ...
            <SwiperSlide 
              className='relative w-full z-[5]  h-full lg:min-h-[850px]'
              key={index}
            >
              ...
              <Layout className="bg-redDark mih-h-[850px] flex items-center justify-center">
                <div className="flex w-full h-full bg-yellowColor flex-wrap items-center justify-center">
