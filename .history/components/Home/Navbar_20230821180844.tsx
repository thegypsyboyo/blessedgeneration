...
const Navbar:React.FC = () => {
  ...
  return (
    <>
    <header className='main-header relative w-full shadow-custom'>
        <nav className="main-menu__wrapper">
            ...
            <div className="main-menu__right block w-[91%]">
                ...
                <div className="main-menu__right-bottom bg-redLight w-full text-darkBlue">
                    ...
                    <div className="main-menu__main-menu-content-box">
                        <div className="main-menu__search-cat-btn-box">
                            ...
                            <div className="relative flex items-center z-100 ml-[10px] bg-redLight">
                                <Link href="/donate-now" className='main-menu__btn text-[14px] font-[700] text-white bg-redLight z-[2] pl-[50px] pt-[19px] pb-[19px] relative flex items-center uppercase transition-all duration-500 hover:text-white hover:bg-darkBlue group  '>
