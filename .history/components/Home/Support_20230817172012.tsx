...
const Volunteer = () => {
  ...
  return (
    <section className="relative block pt-[20px] pb-[300px] bg-lightBlue w-full overflow-hidden">
        <div className="w-full h-full block">
            ...
            <div className="w-full lg:max-w-[50%] flex-shrink-0 flex-grow-0">
                ...
                <div className="lg:max-w-[50%] flex-grow-0 flex-shrink-0 w-full mb-8 h-[300px] ">
                    <div className="lg:pl-[30px] relative z-[1] lg:w-[calc(100%+50px)] lg:!h-[200px] ">
                        <Swiper
                            className=''
                            autoplay={{
                            delay: 5000,
