...
const Footer = () => {
  return (
    <footer className='font-man relative block z-[1] w-full h-full bg-[#121219] overflow-hidden'>
      ...
      >
        <Layout className=''>
          <span className='flex flex-wrap ml-auto mr-auto py-[25px] text-center font-[400] text-white text-[15px]'>Copyright &copy; 2023 BlessedGeneration -All rights reserved <Link href={"https://www.instagram.com/myadventurers/"} target='_blank' rel='noreffere' className='hover:text-primaryBase transition-all duration-500 ml-1'> blessedgenerationkenya.com</Link></span>
        </Layout>
      </motion.div>
    </footer>
  )
