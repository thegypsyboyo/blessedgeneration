...
const Navbar:React.FC = () => {
    ...
    useEffect(() => {
        function handleScroll() {
          ...
          if (window.scrollY > scrollThreshold) {
            ...
            elementToHide.classList.add('sticky');
            mainHeader.style.display = "none";
          } else {
            setIsSticky(false);
            navigationMenu.classList.remove('sticky'); 
            elementToHide.classList.remove('sticky');
  ...
  return (
    <>
    <header className={`main-header relative w-full transition-all duration-700 ease-in-out ${isSticky ? "fixed top-0 left-0 right-0 z-[1] transition-all duration-700 ease-in-out ": ""}`}>
        <nav className={`main-menu__wrapper`}>
            ...
            <div className="relative md:hidden md:h-auto h-[80px] flex items-center">
            ...
            <div className={` main-menu__right block w-[91%] ${isSticky ? "pt-0 ": ""}`}>
    ...
    <div className={`transition-all duration-500 mobile-nav__wrapper fixed top-0 left-0 w-full h-full z-[999999] ${isOpen ? "block transition-all duration-500" : "hidden"}`}>
      <motion.div
        className="transition-all duration-500 absolute top-0 left-0 right-0 bottom-0 !bg-black"
      ...
      />
      <motion.div
        className="mobile-nav__content bg-black w-[300px] z-10 h-full pt-[30px] pb-[30px] pl-[15px] pr-[15px] absolute top-0 left-0 "
