    ...
    <header className='main-header'>
        <nav className="main-menu__wrapper">
            ...
            <div className="main-menu__right block w-[91%]">
                ...
                <div className="main-menu__right-bottom bg-orangeDefault w-full">
           ...
           Home
            <span className={`h-[1px] bg-white inline-block absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease duration-300 ${currentPath === "Home" ? 'w-full': 'w-0'}`}>&nbsp;</span>
                    ...
                    <div className="main-menu__main-menu-content-box">
                        <div className="main-menu__search-cat-btn-box">
                            ...
                            <div className="relative flex items-center z-100 ml-[10px] bg-redDark">
                                <Link href="/dontate" className='main-menu__btn text-[14px] font-[700] text-primaryDark bg-yellowColor pl-[50px] pt-[19px] pb-[19px] relative flex items-center uppercase transition-all duration-500 hover:text-white hover:bg-orangeDefault group  '>
                                    <span className='content-[] absolute top-0 bottom-0 left-0 right-0 w-[calc(100%+50px)] bg-yellowColor -z-[1] group-hover:bg-orangeDefault transition-all duration-500' />
