              ...
              <div className="row flex flex-wrap mx-auto my-auto  justify-center w-full">
                ...
                <div className="w-full flex-shrink-0 flex-grow-0 flex-auto lg:w-[66.66666%] xl:w-3/4 ">
                  ...
                  >
                    ...
                    ><span className="text-orangeDefault bg-yellowColor px-[20px] text-[30px] md:text-[35px] lg:text-[40px]">{item.title}</span></p>
                  ...
                  >   <span className="text-orangeDefault bg-white px-[100px]">{item.description}</span></h2>
                  <div
              className={`bt ${
