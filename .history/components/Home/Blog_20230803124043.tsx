...
const Blog:React.FC = () => {
  ...
  return (
    <section className="relative block pt-[120px] pb-[90px]">
        <Layout className="flex flex-col">
            <div className='relative -mt-[40px] mb-[46px] flex flex-col items-center justify-center w-full'>
                <span className="text-[24px] text-primaryBase font-[700] leading-[24px] mb-[10px] font-cav text-center">New & articles</span>
                <h2 className="m-0 text-primaryDark text-[40px] leading-[45px] font-[800] -tracking-[0.04em] mt-[6px] text-center lg:text-[45px] lg:leading-[50px] xl:text-[50px] xl:leading-[60px]">Directly from the latest <br/> news and articles</h2>
            </div>
            <div className="flex flex-wrap mx-auto my-auto w-full">
                ...
                <div className="flex-shrink-0 flex-grow-0 md:max-w-[50%] lg:max-w-[33.333333%] xl:max-w-[33.333333%] w-full pl-[15px] pr-[15px] mt-0 group " key={index}>
                    <div className="relative block mb-[30px]">
                        <div className="relative block rounded-tl-[20px] rounded-tr-[20px] z-[1] overflow-hidden">
                            ...
                            <Image src={item.image} width={400} height={400} alt="main-image" className="w-full h-[250px] object-cover align-middle rounded-tl-[20px] rounded-tr-[20px] transform scale-[1] transition duration-500 ease group-hover:scale-[1.05]"/>
                        </div>
