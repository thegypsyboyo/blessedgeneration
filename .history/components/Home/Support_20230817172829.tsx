        ...
        <div className="w-full h-full block">
            ...
            <div className="w-full lg:max-w-[50%] flex-shrink-0 flex-grow-0">
                ...
                <div className="lg:max-w-[50%] flex-grow-0 flex-shrink-0 w-full mb-8">
                    <div className="lg:pl-[30px] mr-[100px] relative z-[1] w-[calc(100%+100px)] ">
                        <Swiper
                            className=''
                            autoplay={{
                            delay: 5000,
                                ...
                                <div className=''>
                                    {duplicatedData.map((item, index) => (
                                        <SwiperSlide key={index}  className='container h-full w-full relative'>
                                              <Image src={item.img} alt='main-image' width={200} height={200} priority className='w-full h-[400px] object-cover'/>
                                        </SwiperSlide>
                                    ))}
                                </div>
                        </Swiper>
