  ...
  // function for dynamic rendering of the menu items
    ...
    useEffect(() => {
        function handleScroll() {
          ...
          const elementToHide = document.querySelector(".main-menu__right-top") as HTMLElement; // Adjust the selector
    ...
    <header className={`main-header relative w-full transition-all duration-1000 ease-in-out ${isSticky ? "fixed top-0 left-0 right-0 z-[99999] transition-all duration-1000 ease-in-out ": ""}`}>
        <nav className={`main-menu__wrapper`}>
            ...
            <div className="main-menu__right block w-[91%]">
                <div className={`main-menu__right-top flex items-center justify-between py-[18px] px-0 ${isSticky ? 'hide-on-sticky none opacity-0' : ''}`}>
                ...
                <div className="main-menu__right-bottom bg-yellowColor w-full text-darkBlue">
                    ...
                    <div className="main-menu__main-menu-content-box">
                        <div className="main-menu__search-cat-btn-box">
                            ...
                            <div className="relative flex items-center z-100 ml-[10px] bg-yellowColor">
                                <Link href="/donate-now" className='main-menu__btn text-[14px] font-[700] text-white bg-yellowColor z-[2] pl-[50px] pt-[19px] pb-[19px] relative flex items-center uppercase transition-all duration-500 hover:text-white  group  '>
