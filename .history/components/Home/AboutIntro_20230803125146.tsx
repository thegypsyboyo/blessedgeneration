                    ...
                    <div className="relative block mr-[40px] w-full h-full">
                        <div className="relative block h-full w-full">
                            ...
                            <div className="absolute -bottom-[75px] -right-[95px]">
                                <Image src="/images/events/image-1.jpg" alt='main-image' width={200} height={200} className='w-full h-full object-cover rounded-full'/>
                            </div>
                            <div className='absolute -bottom-[118px] left-[92px] h-[205px] w-[290px] z-[1]'>
                                ...
                                <div className="absolute top-[43px] left-[47px]">
                                    ...
                                    <p className="text-[20px] text-white font-[700] leading-[25px]">We’ve helped many disabled children</p>
                                </div>
                            </div>
