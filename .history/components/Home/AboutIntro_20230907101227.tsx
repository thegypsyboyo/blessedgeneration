        ...
        <Layout className="h-full">
            <div className="flex items-start flex-wrap w-full h-full justify-between">
                <div className="lg:max-w-[50%] flex-grow-0 flex-shrink-0 w-full mb-8">
                    <div className="mr-[100px] relative z-[1] md:h-[600px] lg:h-[800px] mb-5">
                        <Swiper
                            className=''
                            autoplay={{
                            delay: 5000,
                                ...
                                <div className='w-full h-full'>
                                    {duplicatedData.map((item, index) => (
                                        <SwiperSlide key={index}  className='h-full w-full relative'>
                                              <Image src={item.img} alt='main-image' width={800} height={800} priority className='w-full  md:h-[600px] lg:h-[800px]  object-cover'/>
                                        </SwiperSlide>
                                    ))}
                                </div>
                        </Swiper>
