...
const Footer = () => {
  return (
    <footer className='font-man relative block z-[1] w-full h-full bg-[#121219] overflow-hidden'>
      ...
      <Layout className='text-white flex flex-col'>
        <div className='relative block pt-[100px] px-0 pb-[98px]'>
          <div className="flex flex-wrap">
            ...
            initial = "hidden"
            animate="show"
            className="w-full  mb-[35px]  lg:max-[50%] sm:max-w-[100%] md:max-w-[50%] xl:max-w-[33.333333%] flex-shrink-0">
              <div className="relative block mt-0 mr-[50px]">
                ...
                <div className="relative block">
                  <AnimatedButton className='' link='/donate-now' text='donate now' style='!mt-0 !rounded-[5px]'/>
                </div>
              </div>
            </motion.div>
            ...
            initial = "hidden"
            whileInView="show"
            className='w-full mb-[35px] xl:max-w-[16.66666%] sm:max-w-[50%] lg:max-w-[50%] md:max-w-[50%] flex-shrink-0'>
              <div className="relative block">
            ...
            initial = "hidden"
            whileInView="show" 
            className='w-full xl:max-w-[33.33333%] lg:max-w-[50%] sm:max-w-[50%] md:max-w-[50%]'>
      ...
      >
        <Layout className=''>
          <span className='flex flex-wrap ml-auto mr-auto py-[25px] text-center font-[400] text-white text-[15px]'>Copyright &copy; 2023 
          <Link href={"https://www.instagram.com/myadventurers/"} target='_blank' rel='noreffere' className='hover:text-primaryBase transition-all duration-500 mx-1'>
            BlessedGenerationKenya 
          </Link> 
