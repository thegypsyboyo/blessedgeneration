...
const ProjectsData = () => {
  ...
  return (
    <section className='h-full w-full mt-[-100px]  bg-transparent'>
    <Layout>
        <Swiper
            ...
            {duplicatedData.map((item, index) => (
                <SwiperSlide key={index}  className='container h-full w-full relative z-[1000]'>
                    <div className='single w-full h-full relative block shadow-custom group '>
