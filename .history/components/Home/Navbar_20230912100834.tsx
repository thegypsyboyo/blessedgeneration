...
const Navbar:React.FC = () => {
  ...
  return (
    <>
    <header className={`main-header relative w-full transition-all duration-700 ease-in-out ${isSticky ? "fixed top-0 bg-white shadow-custom left-0 right-0 z-[1] transition-all duration-700 ease-in-out ": ""}`}>
