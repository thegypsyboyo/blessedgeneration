...
const Navbar:React.FC = () => {
  ...
  return (
    <>
    <header className={`main-header relative w-full transition-all duration-1000 ease-in-out z-[99] ${isSticky ? "fixed top-0 left-0 right-0 z-[99999] transition-all duration-1000 ease-in-out ": ""}`}>
        <nav className={`main-menu__wrapper relative block pl-[60px] pr-[50px] overflow-hidden`}>
            <div className="main-menu__wrapper-inner flex justify-between items-center">
            <div className="main-menu__left !bg-black h-full w-[9%] flex items-center relative ">
                <div className="main-menu__logo max-w-full items-center justify-center !w-full">
                    <Link href={"/"} className='w-full h-full bg-yellowColor'>
                        <Image src={"/images/logo.png"} alt='logo' width={120} height={120} className='w-full h-full object-contain'/>
                    </Link>
                </div>
            ...
            <div className="main-menu__right ml-[50px] lg:ml-[160px] block w-[91%]">
                ...
                <div className={`main-menu__right-bottom bg-yellowColor w-full text-darkBlue ${isSticky ? "h-[70px]": ""}`}>
                    <div className="main-menu__main-menu-box">
                        ...
                        <ul className='main-menu main-menu__list m-0 p-0 list-none items-center hidden xl:flex'>
                            ...
                            <li className='dropdown'>
                            <CustomLink className='' href='/our-work' title='Projects'  />
                                <ul>
                                    <li className=''>
                                        <Link href="/become-volunteer" className="relative group">
                                        Nyamira | Child care
                    ...
                    <div className="main-menu__main-menu-content-box">
                        <div className="main-menu__search-cat-btn-box">
                            ...
                            <div className={`relative flex items-center z-100 ml-[10px] bg-yellowColor `}>
                                <Link href="/donate-now" className={`main-menu__btn text-[14px] font-[700] text-white bg-yellowColor z-[2] pl-[50px] pt-[19px] pb-[19px] relative flex items-center uppercase transition-all duration-500 hover:text-white  group  ${isSticky ? "h-[70px]": ""} `}>
