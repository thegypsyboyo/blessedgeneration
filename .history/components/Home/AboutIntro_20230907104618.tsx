                ...
                <div className="lg:max-w-[50%] flex-grow-0 flex-shrink-0 w-full mb-8">
                    <div className="mr-[100px] relative z-[1] h-[500px] md:h-[600px] lg:h-[600px] mb-5">
                        ...
                        <div className="absolute right-[-100px] top-[50%]  bg-[#f9f9f9] shadow-custom rounded-[30px] p-[50px] z-[2]">
                            <span className="md:w-[40px] lg:w-[60px] md:h-[40px] w-[35px] h-[35px] lg:h-[60px] bg-redLight inline-block rounded-full text-darkBlue cursor-pointer text-center relative">
