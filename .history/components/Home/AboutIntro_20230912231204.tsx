    ...
    <section className='pt-[120px] w-full h-full'>
        <Layout className="h-full">
            <div className="flex items-start flex-wrap w-full h-full justify-between">
                <div className="lg:max-w-[43.357%] flex-grow-0 flex-shrink-0 w-full mb-8">
                    {/* <div className="mr-[100px] relative z-[1] h-[500px] md:h-[600px] lg:h-[600px] mb-5">
                        <Swiper
                            className=''
                            autoplay={{
                            delay: 5000,
                                ...
                                <div className='w-full h-full'>
                                    {duplicatedData.map((item, index) => (
                                        <SwiperSlide key={index}  className='h-full w-full relative'>
                                              <Image src={item.img} alt='main-image' width={800} height={800} priority className='w-full  md:h-[600px] h-[500px]  lg:h-[600px]  object-cover'/>
                                        </SwiperSlide>
                                    ))}
                                </div>
                        </Swiper>
                        <div className='absolute right-[-30px] bottom-[-30px] h-full w-full z-[-1] bg-[#f9f9f9] content-[]'/>
                        <div className="absolute right-[-100px] top-[50%]  bg-[#f9f9f9] shadow-custom rounded-[30px] lg:p-[50px] md:p-[40px] p-[35px] z-[2]">
                            <span className="md:w-[40px] lg:w-[60px] md:h-[40px] md:leading-[40px] leading-[35px] w-[35px] h-[35px] lg:h-[60px] lg:leading-[60px] bg-redLight inline-block rounded-full text-darkBlue cursor-pointer text-center relative">
                ...
                <div className="w-full my-[100px] mr-[-80px] ml-[70px] flex relative h-full">
                    <div className="bg-[#6a161600] w-full h-full">
                        <Image src="/images/testing/gallery-1.jpg" width={800} height={800} alt="aboutus-image" className=""/>
                        <div className="mb-[20px]">
                            <div className="text-dark text-[12px] uppercase tracking-[2px] leading-[20px]  w-full relative">
                                <div className="mt-0 mr-0 mb-0 ml-[-62px]">Since</div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="w-full lg:max-w-[56.6433%] flex-shrink-0 flex-grow-0 bg-white shadow-custom">
                    <div className="lg:pt-[5%] pr-[13.5%] pb-[5%] pl-[23%]">
                        <h2 className='font-[800] relative z-[1] mb-[25px] md:leading-[35px] md:text-[30px] leading-[25px] text-[25px] lg:leading-[40px] lg:text-[40px] text-redLight tracking-[0.1px]'>Blessed Generation is a loving charitable institution</h2>
                        <p>
