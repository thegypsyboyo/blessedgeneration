                    ...
                    <div className="md:w-[62%] text-left bg-white py-[60px] px-[50px]">
                        ...
                        <div className="w-full h-full">
                            <form action="" className='relative mb-0'>
                                ...
                                <ul className="">
                                    <li className="">
                                        <button className="outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600] inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] max-w-[60px]">$10</button>
                                    </li>
                                </ul>
                            </form>
                        </div>
