                ...
                <div className="flex items-center flex-wrap w-full h-full justify-between">
                    <div className='h-full md:w-[48%] w-full flex flex-shrink-0 flex-grow-0 md:mb-0 mb-3'>
                        <div className="w-full h-full relative mb-[30px] mr-[20px]">
                            ...
                            <p className="text-yellowColor font-normal ">Fourth Estate members are Invisible Children’s most faithful supporters. By giving what they can each month they advance all aspects of our mission to end the atrocities of Joseph Kony and his rebel army.</p>
                        </div>
                    </div>
