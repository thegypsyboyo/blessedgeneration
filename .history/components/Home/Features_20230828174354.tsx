...
interface ImageInfo {
    ...
    title: string,
    slug: string,
    colSpan?: string | number; // Add colSpan property
    colSpanMd?: string | number; // Add colSpan property
    colSpanLg?: string | number; // Add colSpan property
}
    ...
    <section className='relative block pt-[120px] mt-[0] pb-[90px] px-0 w-full h-full' >
        <Layout>
            <div className="grid grid-cols-12 gap-4 w-full">
                ...
                <div key={index} className={`col-span-${imageInfo.colSpan} md:col-span-${imageInfo.colSpanMd} lg:col-span-${imageInfo.colSpanLg} w-full h-full bg-yellowColor`}>
