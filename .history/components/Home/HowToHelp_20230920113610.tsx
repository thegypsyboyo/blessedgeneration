                    ...
                    <div className="md:w-[62%] text-left bg-white py-[60px] px-[50px]">
                        ...
                        <div className="w-full h-full">
                            <form action="" className='relative mb-0'>
                                ...
                                <ul className="flex w-full h-full flex-wrap ">
                                ...
                                <div className="bg-[#002866] text-[16px] font-bold uppercase text-white transition-all duration-500 mb-[150x] rounded-lg px-[30px] outline-none border-none">Donate now </div>
                            </form>
                        </div>
                    </div>
                </div>
