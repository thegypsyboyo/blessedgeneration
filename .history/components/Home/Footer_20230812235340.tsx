...
const Footer = () => {
  return (
    <footer className='font-man relative block z-[1] w-full h-full bg-primaryDark overflow-hidden'>
      ...
      >
        <Layout className=''>
          <span className='flex flex-wrap ml-auto mr-auto py-[25px] text-center font-[400] text-[#98a8a5] text-[15px]'>&copy;All Copyrights by <Link href={"https://www.instagram.com/myadventurers/"} target='_blank' rel='noreffere' className='hover:text-primaryBase transition-all duration-500 ml-1'> blessedgenerationkenya.com</Link></span>
        </Layout>
      </motion.div>
    </footer>
  )
