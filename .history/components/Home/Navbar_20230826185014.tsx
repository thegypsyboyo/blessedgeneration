    ...
    <header className={`main-header relative w-full transition-all duration-1000 ease-in-out ${isSticky ? "fixed top-0 left-0 right-0 z-[99999] transition-all duration-1000 ease-in-out ": ""}`}>
        <nav className={`main-menu__wrapper`}>
            ...
            <div className="main-menu__left !bg-darkBlue h-full max-w-[9%]">
                <div className="main-menu__logo max-w-full h-[90px] bg-black items-center justify-center">
                    <Link href={"/"} className='w-full h-full bg-yellowColor'>
                        <Image src={"/images/logo.png"} alt='logo' width={120} height={120} className='w-full h-full'/>
                    </Link>
                </div>
