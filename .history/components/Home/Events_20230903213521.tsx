...
const Events = () => {
  ...
  return (
    <section className="py-[120px] relative block bg-redDark z-[1] h-full w-full">
            ...
            <div className="flex flex-wrap items-center justify-center w-full h-full">
                <div className="flex-grow-0 flex-shrink-0 w-full lg:max-w-[33.333333%] mb-8 h-full">
                    <div className='relative z-[3] block w-full h-full'>
                        ...
                        <p className="text-[16px] mr-[33px] text-light ">There are many variations of passages of lorem ipsum available but the majority have suffered</p>
                        <AnimatedButton style='!bg-yellowColor !mt-4' text="discover more" link="/events" className="" />
                    </div>
                </div>
                                    ...
                                    { duplicatedData.map((item, index) => (
                                        <SwiperSlide key={index}  className='h-full w-full relative'>
                                            <div className='single w-full h-full relative block'>
                                                ...
                                                <div className="absolute top-[20px] right-[20px] bg-orangeDefault px-[25px] py-[6px] z-[2]">
                                                    <p className="text-[18px] leading-[18px] text-[700] font-cav text-white">23 May, 2022</p>
                                                </div>
                                                <div className="absolute bottom-[44px] left-[30px] z-[2]">
                                                    ...
                                                    <h3 className="text-[24px] font-bold -tracking-[0.04em] leading-[28px] w-full pr-4">
                                                        <Link href={`/event/event-details/${item.slug }`} className='text-white transition-all duration-700 hover:text-orangeDefault' >{item.title}</Link>
                                                    </h3>
                                                </div>
                                                </div>
                                            </div>
