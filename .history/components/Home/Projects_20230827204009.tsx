...
const Projects = () => {
  ...
  return (
    <>
        <section className='overflow-hidden mt-[200px] py-[120px] pb-[200px] w-full h-full bg-no-repeat bg-cover bg-center relative z-[1]' style={{backgroundImage: `url(/images/test/gallery-1.jpg)`}}>
