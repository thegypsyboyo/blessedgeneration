                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                              <h3 className='text-[42px] leading-[50px] font-[800] capitalize text-yellowColor break-words block -tracking-[0.04] font-man mb-[20px]'>the story of blessed generation kenya.</h3>
                              ...
                              {/* <div className="relative block -[20px] lg:h-[350px]">
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <ImageSlider images={imageUrls} breakpoints={{ 1200: {slidesPerView: 2}, 760:{slidesPerView: 1}}}/>
                                </div>
