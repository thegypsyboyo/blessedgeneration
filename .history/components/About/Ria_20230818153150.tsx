                            ...
                            className="relative block" key={index}>
                              <div className="relative block -[20px] lg:h-[350px]">
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='lg:max-w-[60%] mt-5 text-[22px] leading-[22px] font-[800] uppercase text-darkBlue break-words block -tracking-[0.04] font-nun mb-[10px]'>Interview with Ria for EO Vision &apos;It could be your neighbour &apos; </h3>
                                    <motion.p 
                                    variants={footerVariants}
                                    initial = "hidden"
                                    animate="show"
