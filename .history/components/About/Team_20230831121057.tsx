                            ...
                            <div className='single w-full h-full relative block group'>
                                <div className="relative block overflow-hidden !bg-white  z-[1] h-full ">
                                  <Link href={`/team/team-details/${item.slug}`}>
                                  	<Image src={item.image} alt='image-data' width={400} height={400}  className='object-cover transform scale-100 group-hover:scale-125 transition-all duration-300 group-hover:rotate-12 h-[400px] w-full '/>
                                  </Link>
                                ...
                                <div className="w-full bg-lightBlue py-[22px] px-[15px] pb-0 flex flex-col items-center justify-center">
