                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                              <div className="relative block -[20px] lg:h-[500px]">
                                    <Image src={urlFor(item.mainImage).url()} alt='main-image' width={400} height={400} className='w-full h-full sm:max-h-[300px] lg:max-h-[300px] object-cover rounded-tl-[10px] rounded-tr-[10px] '/>
                                </div>
