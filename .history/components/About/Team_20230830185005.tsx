                                ...
                                <div className="absolute flex flex-col top-0 left-0 transition-all duration-500 pointer-events-none">
                                  ...
                                  <ul className="max-w-[40px] flex-col h-full bg-yellowColor flex justify-center">
                                      ...
                                      <li key={index} className="bg-[#489f10] w-[40px] h-[40px] flex ">
                                        <Link href={social.url} rel="noreferrer noopener" target="_blank" className={`${social.platform === 'facebook' ? "hover:bg-blue-700" : ""} bg-[#489f10] text-white z-[4] w-full h-full flex items-center justify-center`}>
