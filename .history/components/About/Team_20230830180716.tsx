                        ...
                        <SwiperSlide key={index}  className='h-full w-full relative !bg-white'>
                            <div className='single w-full h-full relative block shadow-custom '>
                                ...
                                <div className="absolute flex flex-col top-0 left-0 transition-all duration-500 pointer-events-none">
                                  ...
                                  <ul className="w-full h-full bg-yellowColor flex flex-col gap-3 justify-center">
                                      {item.socials?.map((social, index) => (       
                                      <li key={index} className="!bg-[#489f10] w-full h-full">
                                        <Link href={social.url} rel="noreferrer noopener" target="_blank" className="!bg-[#489f10] w-[40px] h-[40px] text-center text-[20px] text-white ">
                                          <span className="bg-[#489f10] w-[40px] h-[40px] text-center text-[20px] text-white ">
