                    ...
                    {duplicatedData?.map((item, index) => (
                        <SwiperSlide key={index}  className='h-full w-full relative !bg-white'>
                            <div className='single w-full h-full relative block group'>
                                ...
                                <div className="w-full bg-white shadow-custom pt-[22px] px-[15px] pb-0">
                                  <p className="text-darkBlue font-bold  text-[20px] leading-[25px] pb-[10px]">{item.name}</p>
                                  <Link href={`/team/team-details/${item.slug}`}  className=" text-[20px] text-[#8ec135] font-bold font-nan pb-[22px]">{item.name}</Link>
                                </div>
                            </div>
                        </SwiperSlide>
                    ))}
