                    ...
                    {duplicatedData?.map((item, index) => (
                        <SwiperSlide key={index}  className='container h-full w-full relative !bg-white'>
                            <div className='single w-full h-full relative block group'>
                                ...
                                <Image src={item.image} alt='image-data' width={400} height={400}  className='object-cover   h-[250px] w-full '/>
                                  <div className="absolute flex flex-col top-0 left-0 transition-all duration-500  ">
                                    ...
                                    <ul className="max-w-[40px] flex-col transition-all duration-500 h-full transform translate-y-[-140px] flex justify-center group-hover:translate-y-[0px]">
                                ...
                                <div className="w-full h-[150px] bg-yellowColor p-4">
                                  <p className="text-redDark font-bold font-cav">{item.position}</p>
                                </div>
                            </div>
                        </SwiperSlide>
                    ))}
