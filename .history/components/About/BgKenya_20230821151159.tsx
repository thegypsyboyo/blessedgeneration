                            ...
                            className="relative block" key={index}>
                              ...
                              <ul className='relative flex items-center mb-[20px] '>
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='lg:max-w-[80%] mt-[30px] text-[18px] lg:text-[35px] leading-[50px] font-[700] capitalize  text-yellowColor break-words block -tracking-[0.04] font-nun mb-[10px]'>What Does Blessed Generation really offers the children ?</h3>
                                    <ul className="relative block pl-1 list-none mb-[30px]">
                                        <li className='flex relative '>
                                            <div className="h-[15px] w-[15px] bg-primaryBase text-[9px] rounded-full text-white flex items-center justify-center">
                                                <FontAwesomeIcon icon={faCheck} />
                                            </div>
                                            <p className='ml-4 text-[16px] text-primaryDark font-[400]'>Education (from kindergarten to university) to more than 800 children, partly through our own primary and secondary schools</p>
                                        </li>
                                        <li className='flex relative '>
                                            <div className="h-[15px] w-[15px] bg-primaryBase text-[9px] rounded-full text-white flex items-center justify-center">
                                                <FontAwesomeIcon icon={faCheck} />
                                            </div>
                                            <p className='ml-4 text-[16px] text-primaryDark font-[400]'>Financing of textbooks and uniforms</p>
                                        </li>
