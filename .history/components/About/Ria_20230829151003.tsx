                    ...
                    <aside className="relative block">
                        ...
                        <div className="w-full h-full pt-[35px] relative z-[1] overflow-hidden group">
                            ...
                            <div className="pt-[13px]">
                                {tags.map((item, index) => (
                                    <Link href={""}  key={item.id * (index)} className='inline-block mr-2 mb-3 px-4 py-2 bg-yellowColor text-sm font-semibold lowercase transition-all duration-500 text-white'>
                                    {item.title}
                                    </Link>
                                ))}
                            </div>
