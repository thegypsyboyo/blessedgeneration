                            ...
                            <div className='single w-full h-full relative block group'>
                                <div className="relative block overflow-hidden !bg-white  z-[1] h-full ">
                                  <Link href={`/team/team-details/${item.slug}`}>
                                  	<Image src={item.image} alt='image-data' width={400} height={400}  className='object-cover transform scale-100 group-hover:scale-125 transition-all duration-300 h-[400px] w-full '/>
                                  </Link>
