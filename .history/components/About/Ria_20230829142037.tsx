                                ...
                                <div className="w-[33%] text-center">
                                    <div className="relative z-[1] m-1">
                                        <Link href={""} className='w-full h-full block'>
                                            <Image src={"/images/test/gallery-1.jpg"} alt='thumb-1' width={150} height={150} className='max-w-full h-auto object-cover'/>
                                        </Link>
                                    </div>
                                </div>
                                <div className="w-[33%] text-center">
                            ...
                            className="relative block" key={index}>
                              <div className="relative block -[20px] lg:h-[500px]">
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='lg:max-w-full mt-5 text-[22px] leading-[30px] font-[800] capitalize text-yellowColor break-words block -tracking-[0.04] font-nun mb-[10px]'>Interview with Ria for EO Vision &apos;It could be your neighbour &apos; </h3>
                                    <motion.p 
                                    variants={footerVariants}
                                    initial = "hidden"
                                    animate="show"
