        ...
        <Layout>
            <div className="flex flex-wrap-reverse flex-row-reverse  w-full justify-between">
                <div className="relative w-full xl:max-w-[33.333%] lg:max-w-[33.333%] mb-[30px] lg:pl-[25px] flex-shrink-0">
                          ...
                          <div>
                            <div className="mt-0 mx-[-15px] mb-[-30px] flex flex-wrap w-full h-full">
                                <div className="w-full relative h-full">
                                    ...
                                    <div className="px-[15px] pb-[30px] w-full h-full" key={index}>
                                        <div className="flex items-center w-full h-full">
                                            <div className="pr-[15px] w-full h-full">
                                                <Link href={""} className='w-full h-full'>
                                                    <Image src={item.image} alt='similar-post' width={150} height={150} className='max-w-[65px] rounded-1 h-[150px] object-cover'/>
                                                </Link>
                                            </div>
                                            <div>
                  ...
                  <div className="w-full xl:max-w-[66.6667%] lg:max-w-[66.6667%] lg:pl-[0px] mb-[30px] flex-shrink-0">
