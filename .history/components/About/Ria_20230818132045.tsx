                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                              <div className="relative block -[20px] h-[500px]">
                                    <Image src={item.image} alt='main-image' width={400} height={400} className='w-full h-full sm:max-h-[300px] lg:max-h-[500px] object-cover rounded-tl-lg rounded-tr-lg'/>
