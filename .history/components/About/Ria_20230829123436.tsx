                ...
                <div className="w-full xl:max-w-[25%] lg:max-w-[25%] mb-[30px] lg:pl-[25px] flex-shrink-0">
                    <aside className="relative block">
                        <div className="relative text-center bg-no-repeat mb-[19px] flex flex-col items-center justify-center">
                            <div className="block w-[200px] h-[200px]  mt-0 mx-auto mb-4">
                            ...
                            <p className="mt-2 mb-1 ml-5 font-light ">Hello, I’m a content writer who is fascinated by content fashion, celebrity and lifestyle.</p>
                        ...
                        <div className="w-full h-full pt-[35px] relative z-[1] overflow-hidden">
                            ...
                            <ul className="space-y-4 mb-5 relative ml-[30px]">
                                {popular.map((item, index) => (
                                    <li key={index} className='flex items-center w-full mt-3 bg-orangeDefault  hover:bg-white hover:shadow-custom group transition-all duration-500 ml-[-30px] hover:ml-[0]'>
                                        <Link href={`/blog/blog-info`} className="text-white  transition-all duration-500 pl-0 group-hover:text-darkBlue  relative">
                                            {item.title}
                                        <BsArrowRight className="text-darkBlue absolute left-[-30px] content-[] top-0 transition-all duration-500 text-[20px] transform translate-x-[-100px] group-hover:translate-x-[0]"/>
                                        </Link>
