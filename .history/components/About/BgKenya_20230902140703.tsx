                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className=" h-[550px] overflow-hidden ">
                                ...
                                <div className=' overflow-hidden z-[1] relative block p-[20px] px-[30px] bg-white shadow-custom '>
                                    ...
                                    <h3 className='mt-5 text-[22px] leading-[22px] font-[800] uppercase text-redDark break-words block -tracking-[0.04] font-nun mb-[10px] border-b border-b-redDark pb-2'>Education is key </h3>
                                    <p
