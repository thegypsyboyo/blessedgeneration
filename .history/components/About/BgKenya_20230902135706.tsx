                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className=" h-[550px] overflow-hidden ">
                                ...
                                <div className=' overflow-hidden z-[1] relative block p-[20px] px-[30px] bg-white shadow-custom '>
                                    ...
                                    <h3 className='mt-[35px] text-[22px] leading-[22px] font-bold uppercase text-redDark break-words block -tracking-[0.04] font-[600] font-nun mb-[20px]'>What Blessed Generation offers it&apos;s children</h3>
                                    <ul className="relative block pl-1 list-disc  mb-[30px] space-y-2">
                                        ...
                                        <li className='flex relative items-center ' key={index*item.id}>
                                            ...
                                            <p className='ml-4 text-[16px] text-dark font-[400]'>{item.title}</p>
                                        </li>
                                        ))}
                                    </ul>
                                    ...
                                    <Image src={"/images/test/gallery-1.jpg"} alt='main-image' width={400} height={400} className='w-full h-full md:h-[550px] object-cover rounded-tl-lg rounded-tr-lg'/>
                                      </div>
