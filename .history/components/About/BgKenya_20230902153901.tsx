                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className=" h-[550px] overflow-hidden ">
                                ...
                                <div className=' overflow-hidden z-[1] relative block p-[20px] px-[30px] bg-white shadow-custom '>
                                    ...
                                    <blockquote className="relative z-[1] border-none text-[20px] mt-[30px] text-white  font-semibold bg-yellowColor p-[50px]">
                                    ...
                                    <h3 className='mt-[35px] text-[22px] leading-[22px] font-bold capitalize text-redDark break-words block -tracking-[0.04] font-man mb-[20px]'>As much help as possible in a family situation</h3>
                                    ...
                                    <h3 className='mt-[35px] text-[22px] leading-[22px] font-bold capitalize text-redDark break-words block -tracking-[0.04] font-man mb-[20px]'>The results are wonderful</h3>
                                    ...
                                    <ImageSlider images={images}  breakpoints={{ 1200: {slidesPerView: 2}, 760:{slidesPerView: 1}}} className="w-full" />
                                    </div>
