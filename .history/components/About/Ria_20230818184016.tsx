            ...
            <div className="flex flex-wrap-reverse  w-full justify-between">
                <div className="w-full xl:max-w-[29.972%] lg:max-w-[29.972%] mb-[30px] lg:pr-[35px] flex-shrink-0">
                    <div className="relative block space-y-[30px]">
                        <div className="bg-white shadow-custom p-[20px] flex items-center flex-col w-full">
                            <div className="h-[60px] w-[60px] rounded-full bg-redDark ">
                                {/* <Image src="/images/about/ria.jpg" alt='ria' width={100} height={100} className='rounded-full object-cover'/> */}
                            </div>
                            <div className="">
                                <h4>Ria Fennema</h4>
