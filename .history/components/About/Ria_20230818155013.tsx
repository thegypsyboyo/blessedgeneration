                            ...
                            className="relative block" key={index}>
                              <div className="relative block -[20px] lg:h-[350px]">
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='mt-5 text-[22px] leading-[22px] font-[800] uppercase text-darkBlue break-words block -tracking-[0.04] font-nun mb-[10px]'>Albert Schweitzer Award of Excellence </h3>
                                    <motion.p 
                                    variants={footerVariants}
                                    initial = "hidden"
                                    animate="show"
                                    ...
                                    <h3 className='lg:max-w-[60%] mt-5 text-[22px] leading-[30px] font-[800] uppercase text-darkBlue break-words block -tracking-[0.04] font-nun mb-[10px]'>Interview with Ria for EO Vision &apos;It could be your neighbour &apos; </h3>
                                    <motion.p 
                                    variants={footerVariants}
                                    initial = "hidden"
                                    animate="show"
                                    ...
                                    <figure className='flex flex-wrap'>
                                        <figure className='lg:max-w-[50%] pr-2'>
                                            <Image src="/images/test/gallery-1.jpg" alt="image-1" width={400} height={400} />
                                        </figure>
                                        <figure className='lg:max-w-[50%] pl-2'></figure>
                                    </figure>
                                </div>
                            </motion.div>
                            ))}
