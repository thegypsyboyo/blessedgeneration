                        ...
                        <div className="w-full h-full pt-[35px] relative z-[1] overflow-hidden">
                            ...
                            <ul className="space-y-4 mb-5 relative ml-[30px]">
                                {popular.map((item, index) => (
                                    <li key={index} className='flex items-center w-full mt-3 bg-transparent   hover:bg-white hover:shadow-custom group transition-all duration-500 ml-[-30px] hover:ml-[0]'>
                                        <Link href={`/blog/blog-info`} className="text-dark  transition-all duration-500 pl-0 group-hover:text-darkBlue  relative">
                                            {item.title}
