                            ...
                            className="relative block" key={index}>
                              <div className="relative block -[20px] lg:h-[500px]">
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='text-[22px] leading-[22px] font-[500] font-man uppercase text-redDark  break-words block -tracking-[0.04] font-nun mb-[10px]'>About Ria Fennema & Festas</h3>
