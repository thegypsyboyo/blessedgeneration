                            ...
                            className="relative block" key={index}>
                              ...
                              <ul className='relative flex items-center mb-[20px] '>
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='mt-5 text-[22px] leading-[22px] font-[800] uppercase text-yellowColor break-words block -tracking-[0.04] font-nun mb-[10px]'>What Does Blessed Generation really offers the children ?</h3>
