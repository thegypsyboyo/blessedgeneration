                ...
                <div className="w-full xl:max-w-[25%] lg:max-w-[25%] mb-[30px] lg:pl-[25px] flex-shrink-0">
                    <aside className="relative block">
                        ...
                        <div className="w-full h-full pt-[35px] relative z-[1] overflow-hidden">
                            ...
                            <ul className="space-y-4 mb-5 relative ml-[30px] group w-full h-full">
                                {popular.map((item, index) => (
                                    <li key={index} className='flex items-center w-full mt-3 bg-transparent  transition-all duration-500 ml-[-30px] hover:ml-[0]'>
                                        <Link href={`/blog/blog-info`} className="text-dark  transition-all duration-500 pl-0 group-hover:text-darkBlue  relative w-full h-full">
                                            {item.title}
