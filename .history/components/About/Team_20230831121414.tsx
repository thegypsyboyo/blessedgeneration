                            ...
                            <div className='single w-full h-full relative block group'>
                                <div className="relative block overflow-hidden !bg-white  z-[1] h-full ">
                                  <Link href={`/team/team-details/${item.slug}`}>
                                  	<Image src={item.image} alt='image-data' width={400} height={400}  className='object-cover transform scale-100 group-hover:scale-125 transition-all duration-700 group-hover:rotate-12 h-[400px] w-full '/>
                                  </Link>
                                ...
                                <div className="w-full bg-white shadow-custom border-b border-b-light py-[22px] px-[15px] pb-0 flex flex-col items-center justify-center">
                                  <p className="text-darkBlue font-bold  text-[20px] leading-[25px] pb-[10px]">{"Lewis Onyango"}</p>
                                  <Link href={`/team/team-details/${item.slug}`}  className="text-[16px] text-[#8ec135] font-[500] font-nan ">Designer</Link>
                                </div>
                            </div>
                        </SwiperSlide>
                    ))}
