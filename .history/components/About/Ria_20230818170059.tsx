                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <div className="mt-7">
                                        ...
                                        <div className="mt-3 flex space-x-2">
                                            ...
                                            <SocialShareButton platform="twitter" url={`locahost:3000/`} title='' body=''  icon={<BsTwitter />} />
                                            <SocialShareButton platform="twitter" url={`locahost:3000/`} title='' body=''  icon={<BsInstagram />} />
                                            <SocialShareButton platform="twitter" url={`locahost:3000/`} title='' body=''  icon={<BsFacebook />} />
                                            <SocialShareButton platform="twitter" url={`locahost:3000/`} title='' body=''  icon={<BsLinkedin />} />
