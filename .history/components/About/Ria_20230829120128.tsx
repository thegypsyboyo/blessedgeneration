                ...
                <div className="w-full xl:max-w-[25%] lg:max-w-[25%] mb-[30px] lg:pl-[25px] flex-shrink-0">
                    <aside className="relative block">
                        ...
                        <div className="w-full h-full pt-[35px] relative z-[1]">
                            <div className="mb-5 text-lg leading-6 font-semibold uppercase">
                                <span className="ml-[14px] text-darkBlue">
                                    <span className='absolute content-[] w-[3px] h-[20px] inline-block  bg-redDark left-0 '/>
                                    Categories
                                </span>
                            </div>
                            <ul className="w-full h-full relative ml-[30px] mb-[20px]">
                                <li className="text-[14px] font-semibold transition-all duration-500 leading-[38px] relative">
                                    <span className="content-[] absolute inline-block top-0 left-[-30px] w-auto h-auto bg-transparent delay-100 transform  translate-x-[0px]">
                                        <BsArrowRight/>
                                        Content
                                    </span>
                                </li>
