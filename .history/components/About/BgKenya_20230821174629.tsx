                            ...
                            className="relative block" key={index}>
                              ...
                              <ul className='relative flex items-center mb-[20px] '>
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <p>Blessed Generation tries to help children and their caregivers preferably in their home situation so that children can grow up in their own environment. The child and the parent or carer will receive medical care if necessary. We also help families with their basic needs such as housing and food. </p>
                                    <p>If this is not sufficient and children cannot be cared for for a longer or shorter period of time with family or in a foster family, the child will be admitted to Blessed Generation. This is done in cooperation with child protection and the children&apos;s court. </p>
