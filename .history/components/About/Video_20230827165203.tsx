                ...
                <div className="lg:max-w-full flex-grow-0 flex-shrink-0 ">
                    <div className="text-center">
                        ...
                        <div className="relative z-[2]">
                            <h2 className="xl:text-[60px] font-bold text-white tracking-tighter uppercase lg:text-[50px] md:text-[40px] text-[28px]">With Design &amp; Conceptual Decisions We Create Value for the Object</h2>
                        </div>
                    </div>
                </div>
            </div>
