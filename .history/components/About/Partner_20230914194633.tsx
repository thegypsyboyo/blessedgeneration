...
const Partner:React.FC<PartnerProps> = ({className}) => {
  ...
  return (
    <div className='relative z-[6] w-full h-full mb-[90px] py-[120px]'>
        <Layout>
                                ...
                                <SwiperSlide className="w-full h-full" key={index}>
                                    <div className="w-full bg-white h-[100px]">
                                        <Link href="" className='w-full h-full relative '>
                                            <Image src={item.image} alt='partners' priority  width={200} height={200} className='w-[300px] h-full object-cover opacity-[1] hover:opacity-[0.6]'/>
                                        </Link>
                                    </div>
                                </SwiperSlide>
                                ))}
