                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <div className="mt-7">
                                        ...
                                        <div className="mt-3 flex space-x-2">
                                            ...
                                            <AnimatedIcon href='' icon={<BsLinkedin/>}/> */}
                                            <SocialShareButton platform="twitter" url={`http://localhost:3000/ria-fennema`} title='ria fennema & festas' body=''  icon={<BsTwitter />} />
                                            <SocialShareButton platform="instagram" url={`http://localhost:3000/ria-fennema`} title='' body=''  icon={<BsInstagram />} />
                                            <SocialShareButton platform="facebook" url={`http://localhost:3000/ria-fennema`} title='' body=''  icon={<BsFacebook />} />
                                            <SocialShareButton platform="linkedin" url={`http://localhost:3000/ria-fennema`} title='' body=''  icon={<BsLinkedin />} />
