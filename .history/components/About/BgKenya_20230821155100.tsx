                            ...
                            className="relative block" key={index}>
                              ...
                              <ul className='relative flex items-center mb-[20px] '>
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='mt-[35px] text-[22px] leading-[22px] font-bold capitalize text-yellowColor break-words block -tracking-[0.04] font-man mb-[20px]'>We work from three locations</h3>
                                    <div className=" h-[400px] overflow-hidden rounded-2xl">
                                    <ImageSlider images={imageUrls} breakpoints={{ 1200: {slidesPerView: 3}, 760:{slidesPerView: 1}}} className="rounded-2xl"/>
                                    </div>
