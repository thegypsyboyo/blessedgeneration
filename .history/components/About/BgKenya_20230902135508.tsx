                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className=" h-[550px] overflow-hidden ">
                                ...
                                <div className=' overflow-hidden z-[1] relative block p-[20px] px-[30px] bg-white shadow-custom '>
                                    ...
                                    <h3 className='mt-[35px] text-[22px] leading-[22px] font-bold uppercase text-redDark break-words block -tracking-[0.04] font-nun mb-[20px]'>What Blessed Generation offers it&apos;s children</h3>
