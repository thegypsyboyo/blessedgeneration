                ...
                <div className="w-full xl:max-w-[25%] lg:max-w-[25%] mb-[30px] lg:pl-[25px] flex-shrink-0">
                    <aside className="relative block">
                        ...
                        <div className="pt-[35px] relative z-[1]">
                            ...
                            <ul className="relative ml-[30px] mb-[20px]">
                                <li className="text-[14px] font-semibold transition-all duration-500 leading-[38px] relative">
                                    <span className="content-[] absolute inline-block top-0 left-[-30px] w-auto h-auto bg-transparent delay-100 transform scale-x-[-1] translate-x-[100px]">
                                        <BsArrowLeft/>
                                    </span>
                                </li>
                            </ul>
