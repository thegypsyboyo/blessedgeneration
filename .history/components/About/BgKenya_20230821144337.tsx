                            ...
                            className="relative block" key={index}>
                              ...
                              <ul className='relative flex items-center mb-[20px] '>
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='lg:max-w-[80%] mt-[30px] text-[18px] lg:text-[30px] leading-[30px] font-[700] capitalize  text-yellowColor break-words block -tracking-[0.04] font-nun mb-[10px]'>What Does Blessed Generation really offers the children ?</h3>
                                    <motion.p 
                                    variants={footerVariants}
                                    initial = "hidden"
                                    animate="show"
