                                ...
                                {popular.map((item, index) => (
                                    <li key={index} className='flex items-center w-full mt-3 bg-orangeDefault  hover:bg-white hover:shadow-custom group transition-all duration-500 '>
                                        <div className="relative ">
                                            <Link href={`/blog/blog-info`} className="text-white  transition-all duration-500 pl-0 group-hover:text-darkBlue py-3  relative">
                                                {item.title}
                                            </Link>

                                        </div>
                                        <BsArrowRight className="absolute left-[-30px] content-[] top-0 "/>
                                    </li>
                                ))}
                            </ul>
