                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <ul className="relative block pl-0 list-none ">
                                        <li className='flex relative '>
                                            <div className="h-[25px] !w-[25px] bg-primaryBase text-[9px] rounded-full text-white flex items-center justify-center">
                                                <FontAwesomeIcon icon={faCheck} />
                                            </div>
                                            <div className="ml-[10px]">
                                                <p className='text-[16px] text-primaryDark font-[700]'>Education (from kindergarten to university) to more than 800 children, partly through our own primary and secondary schools</p>
                                            </div>
                                        </li>
