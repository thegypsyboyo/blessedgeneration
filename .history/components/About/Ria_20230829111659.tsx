            ...
            <div className="flex flex-wrap-reverse flex-row-reverse  w-full justify-between">
                <div className="w-full xl:max-w-[25%] lg:max-w-[25%] mb-[30px] lg:pl-[25px] flex-shrink-0">
                    <aside className="relative block">
                        <div className="relative text-center bg-no-repeat mb-[19px]">
                            <div className="block w-[246px] h-[246px]  mt-0 ml-auto mb-4">
                                <Image src="/images/about/ria.jpg" alt='ria' width={100} height={100} className='w-full h-full object-cover rounded-full'/>
                            </div>
                            <h4 className='pt-1 px-4 text-[24px] leading-[30px] font-[500] text-darkBlue'>Ria Fennema</h4>
                            <p className="mt-2 mb-1 ml-5 font-light ">Hello, I’m a content writer who is fascinated by content fashion, celebrity and lifestyle. She helps clients bring the right content to the right people.</p>
