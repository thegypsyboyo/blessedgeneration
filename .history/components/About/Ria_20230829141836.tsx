                            ...
                            className="relative block" key={index}>
                              <div className="relative block -[20px] lg:h-[500px]">
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <h3 className='mt-5 text-[22px] leading-[22px] font-[600] uppercase text-redDark break-words block -tracking-[0.04] font-nun mb-[10px]'>Albert Schweitzer Award of Excellence </h3>
                                    <motion.p 
                                    variants={footerVariants}
                                    initial = "hidden"
                                    animate="show"
