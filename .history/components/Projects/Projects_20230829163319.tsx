        ...
        <Layout className='flex flex-col items-center' >
            ...
            <div className="flex flex-wrap w-full">
                ...
                {filteredCauesItems.map((item, index) => (
                    <div className="w-full px-[15px] p-[15px] lg:max-w-[33.3333%] md:max-w-[50%]
                    flex-grow-0 flex-shrink-0 group flex items-start " key={index}>
                        {/* <div className="relative mb-[30px] flex flex-col items-center justify-items-center ">
                            ...
                            <div className="flex items-center flex-col  justify-end absolute z-[3] top-0 left-0 w-full h-full p-[25px] text-left transition-all duration-1000 overflow-hidden opacity-0 transform translate-y-[80px] group-hover:visible group-hover:translate-y-[0px]  group-hover:opacity-[1] ">
