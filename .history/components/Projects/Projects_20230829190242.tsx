                            ...
                            <div className={`w-full h-full transform delay-500 transition-all duration-500 ease-in-out translate-y-0`}>
                                ...
                                <div className="mb-[11px] transition-all duration-[900]">
                                    {item.tag?.map((tags, index) => (
                                        <Link href={item.slug} className='text-white bg-yellowColor px-[15px] h-[24px] inline-block leading-[24px] text-[12px] font-semibold uppercase transition-all duration-700 hover:bg-redDark' key={index}>{tags.title}</Link>
