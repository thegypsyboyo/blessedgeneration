        ...
        <Layout className='flex flex-col items-center' >
            ...
            <nav className=''>
              <div className='flex flex-wrap space-x-3 mb-[35px] text-center'>
                {['All', "nyamira children's home", 'ruiru highschool', 'outreach programs', "malindi children's home"].map((category) => (
                  <button
                  key={category}
            ...
            <div className="flex flex-wrap w-full overflow-hidden">
                ...
                {filteredCauesItems.map((item, index) => (
                    <div className={`${filteredCauesItems ? "transform translate-y-[0px]" : ""} transform translate-y-[200px] transition-all duration-500 w-full px-[15px] p-[15px] lg:max-w-[33.3333%] md:max-w-[50%]
