...
import { DonationProps, OurProjectProps } from '@/typings'

const donationData:OurProjectProps[] = [
    {
        category: [
            "ruiru highschool BG",
    ...
    },
    {
        ...
        image: "/images/testing/gallery-13.jpg",
        title: "Let’s education for children get good life",
        slug: "malindi-children's-home",
        tag: [
            {
                id: 1,
                title: "Nyamira"
    ...
    },
    {
        ...
        image: "/images/testing/gallery-12.jpg",
        title: "Let’s education for children get good life",
        slug: "ruiru-highschool-BG",
        tag: [
            {
    ...
    },
    {
        ...
        image: "/images/testing/gallery-17.jpg",
        title: "Let’s education for children get good life",
        slug: "nyamira-children's-home",
        tag: [
            {
                id: 1,
                title: "Nyamira"
    ...
    },
    {
        ...
        image: "/images/testing/gallery-5.jpg",
        title: "Let’s education for children get good life",
    ...
    },
    {
        ...
        image: "/images/testing/gallery-6.jpg",
        title: "Let’s education for children get good life",
        slug: "malindi-children's-home",
        tag: [
            {
                    ...
                    <div className={` transition-all duration-500 w-full px-[15px] p-[15px] lg:max-w-[33.3333%] md:max-w-[50%] flex-grow-0 flex-shrink-0 group flex items-start`} key={index}>
                        <div className="w-full relative overflow-hidden block group bg-transparent h-[400px]">
                            <div className={`w-full h-full transform delay-500 transition-all duration-500 ease-in-out translate-y-0`}>
                                <Link href={`/projects/project-details/${item.slug}`} target='_blank' className='w-full cursor-pointer !overflow-hidden opacity-[1] rounded-none transition-all duration-500 mr-0 pt-[300px]'>
                                    <Image src={item.image} alt="image-main" width={400} height={400} className='w-full h-[400px] object-cover '/>
                                </Link>
                                ...
                                <div className="mb-[11px] transition-all duration-[900]">
                                    {item.tag?.map((tags, index) => (
                                        <Link href={`/projects/project-details/${item.slug}`} className='text-white bg-yellowColor px-[15px] h-[24px] inline-block leading-[24px] text-[12px] font-semibold uppercase transition-all duration-700 hover:bg-redDark m-1' key={index}>{tags.title}</Link>
                                ...
                                <div className="text-center transition-all duration-700 mb-3 pt-2">
                                    ...
                                    <Link href={`/projects/project-details/${item.slug}`}>{item.title}</Link>
                                    </h4>
                                </div>
                                </div>
