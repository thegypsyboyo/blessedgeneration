            ...
            <nav className=''>
              <div className='flex flex-wrap space-x-3 mb-[35px] text-center'>
                {['All', 'education', 'medicine', 'water', 'food'].map((category) => (
                  ...
                  className={`capitalize font-bold bg-transparent py-[5px] px-[12px] text-darkBlue outline-none transition-all duration-500s hover:bg-yellowColor hover:text-white ${activeFilter === category ? 'bg-yellowColor text-white' : ''}`} 
                  >
                  {category}
                  </button>
                ))}
