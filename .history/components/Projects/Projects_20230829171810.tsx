        ...
        <Layout className='flex flex-col items-center' >
            ...
            <div className="flex flex-wrap w-full overflow-hidden">
                ...
                {filteredCauesItems.map((item, index) => (
                    <div className={` transition-all duration-500 w-full px-[15px] p-[15px] lg:max-w-[33.3333%] md:max-w-[50%] 
                    flex-grow-0 flex-shrink-0 group flex items-start`} key={index}>
                        <div className="w-full h-full relative !overflow-hidden block group bg-redDark">
                            <Link href={item.slug} target='_blank' className='w-full cursor-pointer overflow-hidden opacity-[1] rounded-none transition-all duration-500 mr-0 mt-[400px] transform !translate-y-[400px]'>
                                <Image src={item.image} alt="image-main" width={400} height={400} className='w-full h-[400px] object-cover rounded-2xl mt-[300px]'/>
                            </Link>
