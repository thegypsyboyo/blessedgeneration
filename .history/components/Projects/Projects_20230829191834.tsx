    ...
    <section className='relative block pt-[60px] mt-[0px] pb-[90px] px-0 w-full'>
        <Layout className='flex flex-col items-center' >
            <div className="relative block -mt-[4px] mb-[46px] text-center">
                ...
                <p className="text-center font-[400] text-[16px] ">Gardenias’ mission is to provide our customers with responsive service and unsurpassed quality at an affordable price.</p>
            </div>
            <nav className=''>
                            ...
                            <div className={`w-full h-full transform delay-500 transition-all duration-500 ease-in-out translate-y-0`}>
                                ...
                                <div className="mb-[11px] transition-all duration-[900]">
                                    {item.tag?.map((tags, index) => (
                                        <Link href={item.slug} className='text-white bg-yellowColor px-[15px] h-[24px] inline-block leading-[24px] text-[12px] font-semibold uppercase transition-all duration-700 hover:bg-redDark m-1' key={index}>{tags.title}</Link>
