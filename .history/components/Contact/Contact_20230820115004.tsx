  ...
  return (
    <section className="py-[120px] relative">
        <Layout className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-wrap py-[120px] w-full bg-white shadow-custom relative z-[1] w-full h-full pt-[73px] px-[100px] pb-[95px] border-0 ">
                    ...
                    <div className="w-full">
                        ...
                        <form action="#" className='w-full'>
                            <div className="flex flex-wrap w-full">
                                <div className="flex-shrink-0 flex-grow-0 lg:w-[50%] w-full pr-[15px] mt-0">
                                ...
                                <div className="flex-shrink-0 flex-grow-0 lg:w-[50%] pl-[15px] mt-0">
                                    <div className="mt-[20px]">
                                        <input name='name'  typeof='text' placeholder='Enter your email' className='w-full h-[60px] border outline-0 bg-lightBlue px-[25px] py-0 text-white'/>
                                    </div>
                                </div>
                                <div className="flex-shrink-0 flex-grow-0 lg:w-[50%] pr-[15px] mt-0">
                                    <div className="mt-[20px]">
                                        <input name='name' required typeof='text' placeholder='Enter your name' className='w-full h-[60px] border outline-0 bg-lightBlue px-[25px] py-0 text-white'/>
                                    </div>
                                </div>
