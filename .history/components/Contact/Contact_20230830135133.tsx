            ...
            <div className="flex flex-wrap items-center justify-center w-full h-full mb-[50px]">
                <div className="w-full lg:max-w-[66.66667%] flex-grow-0 flex-shrink-0 ">
                    <div className="text-center w-full">
                        <span className="mb-[9px] text-redDark inline-block font-semibold text-[14px] tracking-[0.04em] font-cav ">CONTACT US</span>
                        <h3 className="text-[50px] lg:text-[60px] xl:text-[70px] font-semibold tracking-[-.04em] text-redDark mb-[25px] xl:leading-[80px] lg:leading-[70px] leading-[60px]">Get in touch with us for more information</h3>
                    </div>
                </div>
            </div>

            <div className="flex flex-wrap  bg-white rounded-[0px] shadow-custom relative z-[1] w-full h-full border-0 ">
