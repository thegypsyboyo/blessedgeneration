  ...
  return (
    <section className="py-[120px] relative">
        <Layout className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-wrap py-[120px] bg-white rounded-[10px] shadow-custom relative z-[1] w-full h-full pt-[73px] px-[30px] sm:px-[50px] lg:px-[100px] pb-[95px] border-0 ">
                <div className="flex-grow-0 flex-shrink-0 pl-[15px] pr-[15px] lg:max-w-1/2 w-full">
                            ...
                            <div className="flex flex-wrap w-full">
                                <div className="flex-shrink-0 flex-grow-0 lg:w-[50%] w-full lg:pr-[15px] mt-0">
                                    <div className="mt-[20px]">
                                        <input name='name' required typeof='text' placeholder='Enter your name' className='w-full h-[60px] border outline-0 bg-transparent px-[25px] py-0 text-white'/>
                                    </div>
                                </div>
                                <div className="flex-shrink-0 flex-grow-0 lg:w-[50%] w-full lg:pl-[15px] mt-0">
                                    <div className="mt-[20px]">
                                        <input name='name'  type='email' placeholder='Enter your email' className='w-full h-[60px] border outline-0 bg-transparent px-[25px] py-0 text-white'/>
                                    </div>
                                </div>
                                <div className="flex-shrink-0 flex-grow-0 lg:w-[50%] w-full lg:pr-[15px] mt-0">
                                    <div className="mt-[20px]">
                                        <input name='name' required typeof='text' placeholder='Phone' className='w-full h-[60px] border outline-0 bg-transparent px-[25px] py-0 text-white'/>
                                    </div>
                                </div>
                                <div className="flex-shrink-0 flex-grow-0 lg:w-[50%] w-full lg:pl-[15px] mt-0">
                                    <div className="mt-[20px]">
                                        <input name='name'  typeof='text' required placeholder='Subject' className='w-full h-[60px] border outline-0 bg-transparent px-[25px] py-0 text-white'/>
                                    </div>
                                </div>
                                <div className="flex-shrink-0 flex-grow-0 w-full mt-0">
                                    <div className="mt-[20px]">
                                        <textarea name='name'  typeof='text' placeholder='Your messege' required  className='w-full h-[160px] border outline-0 bg-transparent py-[23px] px-[25px] text-white'/>
                                    </div>
                                </div>
