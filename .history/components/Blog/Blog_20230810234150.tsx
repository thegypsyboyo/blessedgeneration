                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                                ...
                                <div className='relative block mt-[10px]'>
                                    <h3>
                                        <Link href={`/blog/blog-info/${item.slug}`} className='text-[22px] leading-[22px] font-[800] uppercase break-words block -tracking-[0.04] font-man'><AnimatedText className="text-primaryDark hover:text-primaryBase transition-all duration-500 !font-[900]" text={item.title}/></Link>
                                    </h3>
                                    ...
                                    <div className='w-full h-[1px] bg-primaryText mt-5 relative'>
                                        <span className='content-[] absolute w-[100px] bg-orangeDefault h-[1px] left-0 top-0'/>
                                    </div>
