                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                                ...
                                <div className='relative block mt-[22px]'>
                                    <h3>
                                        <Link href={`/blog/blog-info/${item.slug}`} className='text-[22px] leading-[22px] font-bold uppercase break-words block -tracking-[0.04] font-cav'><AnimatedText className="text-primaryDark hover:text-primaryBase transition-all duration-500 " text={item.title}/></Link>
                                    </h3>
