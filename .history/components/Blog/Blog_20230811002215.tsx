                    ...
                    <div className="relative block space-y-[30px]">
                        ...
                        className='cat relative block bg-borderColor pt-[46px] pb-[36px] px-[20px] overflow-hidden z-[1]'>
                            ...
                            <ul className="space-y-4">
                                {data.map((item, index) => (
                                    <li key={index} className='flex items-center justify-center w-full pt-[14px] pb-[15px] px-[20px] pr-[18px] transition-all duration-500 hover:bg-white'>
                                        <div className='w-2 h-2 bg-primaryText rounded-full mr-2'/>
