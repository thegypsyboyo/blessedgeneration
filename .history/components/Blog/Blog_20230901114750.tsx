                        ...
                        >
                            ...
                            <ul className="w-full">
                                <li className="text-primaryText font-semibold p-1 break-words w-full">
                                    <div className="content-[] inline-block align-middle w-[6px] h-[6px] border-t border-t-[#111111] border-l border-l-[#111111] transform rotate-[135deg] mr-[12.5px] transition-all duration-500 relative "></div>
                                </li>
                            </ul>
