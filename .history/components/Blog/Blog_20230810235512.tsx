                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                                <div className="relative block -[20px]">
                                    <Image src={item.image} alt='main-image' width={400} height={400} className='w-full h-full lg:max-h-[300px] object-cover'/>
                                ...
                                <div className='relative block mt-[10px]'>
                                    ...
                                    <div className='w-full h-[1px] bg-primaryText mt-5 relative flex items-center'>
