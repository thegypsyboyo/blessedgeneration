                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <motion.div 
                                    ...
                                    className="flex flex-wrap mb-[15px]">
                                      <div className="mr-[15px] relative flex-grow-0 flex-shrink-0 w-[calc(50%-15px)] transition-all duration-500  py-[30px] border rounded-t-none rounded-br-2xl border-borderColor flex hover:bg-orangeDefault hover:text-white  bg-borderColor group">
                                      ...
                                      <div className="mr-[15px] relative flex-grow-0 flex-shrink-0 w-[calc(50%-15px)] transition-all duration-500 shadow-slate-100 py-[30px] border border-borderColor rounded-t-none rounded-br-2xl flex flex hover:bg-orangeDefault hover:text-white  bg-borderColor group">
                                        <Link href="" className="flex items-center px-[20px]">
                                          <div className='flex-1'>
                                            <div className="mb-[0.4rem] text-[0.8125rem] text-[#aaa] font-cav">{item.date}</div>
