...
import { faArrowRight, faComment, faMagnifyingGlass, faPersonCirclePlus, faSearch, faUserCircle } from '@fortawesome/free-solid-svg-icons'
    ...
    <section className='block py-[120px] relative'>
        <Layout>
            <div className="flex flex-wrap w-full justify-between">
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <div className="mb-4 overflow-hidden block relative  ">
                                        <ul className='m-0 pl-0 list-none'>
                                            <li className="relative z-[1] text-xs uppercase pr-14 float-left">
                                                <Image src="/images/person.png" alt='person-icon' width={80} height={80} className='h-9 w-9 rounded-full mr-3 object-contain bg-yellowColor p-1'/>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <div className="w-full xl:max-w-[33.333333%] lg:max-w-[41.666666%] mb-[30px] lg:pr-[15px] lg:pl-[15px] flex-shrink-0">
