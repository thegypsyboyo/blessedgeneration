                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className="mt-0 mx-[-15px] mb-[-30px] flex flex-wrap w-full h-full ">
                                <div className="w-full  h-full flex flex-wrap relative pb-[30px]">
                                    ...
                                    <div className="flex-grow-0 flex-shrink-0 md:w-[50%] h-full px-2" key={index}>
                                        <div className="w-full h-full flex flex-col items-center">
                                            <div className="w-full h-full bg-yellowColor">
                                                <Link href={""} className='w-full h-full'>
                                                    <Image src={item.image} alt='similar-post' width={150} height={150} className='w-full  rounded-1 h-[240px] object-cover'/>
                                                </Link>
                                            </div>
                                            <div>
