                            ...
                            className="relative block" key={index}>
                                ...
                                <div className='relative block mt-[10px]'>
                                    ...
                                    <ul className='flex items-center space-x-4'>
                                        <li >
                                            <Link href="" className='text-[20px] text-[#777766] font-[600] transition-all duration-500 hover:text-yellowColor'>
                                                <FontAwesomeIcon icon={faUserCircle} className='text-orangeDefault pr-[3px]'/>
                                                {item.author}
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="" className='text-[14px] text-[#777766] font-[600] transition-all duration-500 hover:text-yellowColor'>
                                                <FontAwesomeIcon icon={faComment} className='text-orangeDefault pr-[3px]'/>
                                                2 comments
                                            </Link>
                                        </li>
