                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className="p-[20px] px-[30px] bg-white shadow-custom">
                              ...
                              <h4 className="font-bold text-[22px] text-dark mt-6">Conduct replied off whether arrived adapted</h4>
                              ...
                              <p 
                                  className='mb-[15px]'>
                                    {tags.map((item, key) => (
                                          <Link href="#" key={item.id * key} className='relative text-primaryDark text-[10px] bg-[#f7f7f7] mr-[2px] mb-[5px] inline-block py-[10px] px-[15px] font-[800] uppercase transition-all duration-500   hover:bg-primaryBase ml-[8px] mt-[10px] hover:text-white'>
                                            {item.title}
                                          </Link>
                                  ))}
                              </p>
                              <div className="uppercase font-[600] text-[18px]">Share this post</div>
                              <div 
