                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <div className="mb-4 overflow-hidden block relative  ">
                                        <ul className='m-0 pl-0 list-none'>
                                            ...
                                            <li className="relative z-[1] text-xs uppercase pr-14 float-left flex items-center  justify-center text-primaryText">
                                               <FontAwesomeIcon icon={faEye} className='text-primaryText text-xl mr-2'/>
