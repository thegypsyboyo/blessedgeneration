                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                                <div className="relative block -[20px]">
                                    <Image src={urlFor(item.mainImage).url()} alt='main-image' width={400} height={400} className='w-full h-[500px] object-cover rounded-tl-lg rounded-tr-lg'/>
                                    <div className="absolute left-[30px] bg-orangeDefault py-[6px] px-[25px] bottom-[30px] z-[2] -[15px]">
                                        <p className='text-[18px] text-white font-cav leading-[18px] font-[700]'> {new Date(item._createdAt).toLocaleDateString("en-Us", {
                                                day: "numeric",
                                                month: "long",
                                                year: "numeric",
                                            })}
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    className="mb-[10px] leading-[32px] pt-[10px] pb-[11px] text-[16px] text-primaryText font-[400]">There are many variations of passages of Lorem
                                            ...
                                            className="flex items-center ">
                                                <AnimatedButton className='' link={`/blog/blog-info/${item.slug.current}`} text='read more' style='!mt-0 !rounded-none mb-[20px]'/>
                                            </motion.div>
