                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className="mt-0 mx-[-15px] mb-[-30px] flex flex-wrap w-full h-full ">
                                <div className="w-full  h-full flex flex-wrap relative space-y-2 pb-[30px]">
                                    {relatedPost.map((item, index) => (
                                    <div className="px-[15px] flex-grow-0 flex-shrink-0 md:w-[50%] h-full" key={index}>
                                        <div className="flex flex-col items-center">
                                            <div className="pr-[15px]">
                                                <Link href={""} className='w-full h-full'>
                                                    <Image src={item.image} alt='similar-post' width={150} height={150} className='w-full  rounded-1 h-full object-cover'/>
                                                </Link>
                                            </div>
                                            <div>
