            ...
            <div className="flex flex-wrap w-full justify-between">
                ...
                <div className="w-full xl:max-w-[33.333333%] lg:max-w-[33.333333%] mb-[30px] pr-[15px] pl-[15px] flex-shrink-0">
                    <div className="relative block space-y-[30px]">
                        ...
                        <div className="">
                            {tags?.map((item, index) => (
                                <Link href="#" key={item.id * index + "wxxx"} className='text-[10px] text-primaryDark transition-all duration-500 bg-white inline-block py-[10px] px-[20px] uppercase -[17px] ml-[5px] font-[800] mb-[10px] hover:bg-borderColor hover:text-primaryBase hover:border hover:border-solid hover:border-primaryBase'>
                                    {item.title}
                                </Link>
                            ))}
                        </div>
