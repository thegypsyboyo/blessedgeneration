                ...
                <div className="w-full xl:max-w-[66.66666%] lg:max-w-[58.333333%] mb-[30px] flex-shrink-0">
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                           ...
                           <div className="w-full h-full rounded-[5px] px-[30px] bg-white mb-[30px] shadow-custom">
                              <h2 className="text-[1.2rem] text-[#4a4a4a] font-[600] mt-[-30px] mx-[-30px] mb-[25px] border-b border-b-[#eaeaea] bg-white">About the Author</h2>
                         </div>
                            </motion.div>
                            ))}
                        </div>
