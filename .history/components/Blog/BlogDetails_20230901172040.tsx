...
import { BsClockHistory, BsFacebook, BsFolder2, BsInstagram, BsTwitter, BsYoutube} from "react-icons/bs"
                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <div className="mt-[30px] w-full relative block  bg-white shadow-custom  p-[30px] group rounded-[5px]">
                                ...
                                <div className="flex items-start justify-start py-[30px] px-0">
