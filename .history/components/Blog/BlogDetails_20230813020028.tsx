                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            <motion.div 
                                    ...
                                    className="flex flex-wrap mb-[15px]">
                                      <div className="mr-[15px] relative flex-grow-0 flex-shrink-0 w-[calc(50%-15px)] transition-all duration-500  py-[30px] border rounded-t-none rounded-br-2xl border-borderColor flex hover:bg-orangeDefault hover:text-white  bg-borderColor">
                                        <Link href="" className="flex items-center px-[20px]">
                                          ...
                                          <div className='flex-1'>
                                            ...
                                            <div className=" text-primaryDark transition-all duration-500 font-[800] text-[20px]">{item.title}</div>
                                          </div>
                                        </Link>
                                      </div>
