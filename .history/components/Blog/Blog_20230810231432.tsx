    ...
    <section className='block py-[120px] relative'>
        <Layout>
            <div className="flex flex-wrap w-full justify-between">
                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                                <div className="relative block -[20px]">
                                    ...
                                    <div className="absolute left-[30px] bg-yellowColor py-[6px] px-[25px] bottom-[30px] z-[2] -[15px]">
                ...
                <div className="w-full xl:max-w-[33.333333%] lg:max-w-[41.666666%] mb-[30px] pr-[15px] pl-[15px] flex-shrink-0">
                    <div className="relative block space-y-[30px]">
                        <div className='relative block '>
                            <form action="#" className='relative'>
                                <input type="text" placeholder='Search here'  className='block border-none outline-none bg-primaryBase text-white text-[16px] font-[400] pl-[50px] h-[50px] w-full pr-[80px] -[20px]'/>
                        ...
                        className='cat relative block bg-borderColor pt-[46px] pb-[36px] px-[20px] overflow-hidden z-[1] -[20px]'>
                            ...
                            <ul className="space-y-4">
                                {data.map((item, index) => (
                                    <li key={index} className='flex items-center w-full pt-[14px] pb-[15px] px-[20px] pr-[18px] transition-all duration-500 -[20px] hover:bg-white'>
