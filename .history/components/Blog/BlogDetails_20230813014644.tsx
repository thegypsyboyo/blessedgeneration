                            ...
                            <div className="flex items-center justify-between flex-wrap py-[30px] mt-[50px] border-t-[1px] border-borderColor">
                                 <motion.p 
                                      ...
                                      className='mb-[15px]'>
                                        ...
                                        {tags.map((item, key) => (
                                          <Link href="#" key={item.id * key} className='relative text-primaryDark text-[10px] bg-[#f7f7f7] mr-[3px] mb-[5px] inline-block py-[10px] px-[15px] font-[800] uppercase transition-all duration-500 hover:border-[1px]  hover:bg-primaryBase ml-[8px] mt-[10px]'>
                                            {item.title}
                                          </Link>
                                        ))}
                                      </motion.p>
