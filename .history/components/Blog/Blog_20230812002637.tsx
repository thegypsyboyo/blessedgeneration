                                    ...
                                    <li key={index} className='flex items-center w-full pt-[14px] pb-[15px] px-[20px] pr-[18px] transition-all duration-500 hover:bg-white'>
                                        <div className="relative top-[-1] ">
                                            <h3 className='flex flex-col leading-[20px] ml-0 p-0 text-[#454545] font-semibold text-sm'>
                                                <Link href={`/blog/blog-info/${item.slug}`} className=" transition-all duration-500 pl-0 hover:text-primaryBase py-3 border border-b-1 border-[#e7e7e7] border-solid">
                                                    {item.title}
                                                </Link>
                                            </h3>
