            ...
            <div className="flex flex-wrap w-full justify-between">
                ...
                <div className="w-full xl:max-w-[33.333333%] lg:max-w-[33.333333%] mb-[30px] pr-[15px] pl-[15px] flex-shrink-0">
                    <div className="relative block space-y-[30px]">
                        ...
                        initial = "hidden"
                        whileInView="show"
                        className='cat relative block overflow-hidden z-[1]'>
                            <h3 className='text-[20px] mb-[10px] font-[900] -tracking-[0.04] text-primaryDark pl-[30px]'>Latest Posts</h3>
                            <ul className="space-y-4">
                                {data.map((item, index) => (
                                    <li key={index} className='flex items-center justify-start w-full pt-[14px] pb-[15px] px-[20px] pr-[18px] transition-all duration-500 hover:bg-white relative'>
                                        <div className='w-2 h-2 bg-primaryText rounded-full mr-2 absolute left-0 top-0 mt-[20px]'/>
