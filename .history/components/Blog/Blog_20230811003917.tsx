                    ...
                    <div className="relative block space-y-[30px]">
                        <div className='relative block '>
                            <form action="#" className='relative'>
                                <input type="text" placeholder='Search & hit enter'  className='block border-none outline-none bg-white text-primaryText text-[16px] font-[400] pl-[50px] h-[50px] w-full pr-[80px]'/>
