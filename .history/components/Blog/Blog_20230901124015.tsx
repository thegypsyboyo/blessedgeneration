                        ...
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                                <div className="relative block -[20px]">
                                    ...
                                    <div className="absolute left-[30px] bg-[#ffff] py-[6px] px-[25px] bottom-[30px] z-[2]  -[15px] rounded-3xl border border-[#ffbb00] ">
                                        <p className='text-[18px] text-[#ffbb00] font-cav leading-[18px] font-[700]'>{item.date}</p>
                                    </div>
                                </div>
