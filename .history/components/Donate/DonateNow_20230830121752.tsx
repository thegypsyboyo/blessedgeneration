                                ...
                                <form onSubmit={handleStripeSubmit}>
                                    <div className="relative block mt-0 mb-12">
                                        ...
                                        <div className="relative block bg-white">
                                            ...
                                            className='h-[130px] w-full border-none outline-none bg-white shadow-custom  pl-[150px] pr-[30px] text-5xl text-right font-extrabold tracking-tighter text-darkBlue z-[1]' />
                                        </div>
                                    </div>
