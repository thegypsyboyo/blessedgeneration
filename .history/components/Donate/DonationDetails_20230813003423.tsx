                            ...
                            className="relative block" key={index}>
                              ...
                              <div className="relative block -[20px]">
                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    <h3>
                                        <Link href={`/blog/blog-info/${item.slug}`} className='text-[22px] leading-[22px] font-[800] uppercase text-darkBlue break-words block -tracking-[0.04] font-nun mb-[10px]'><h3 className='font-extrabold font-nun '>{item.title}</h3></Link>
                                    </h3>
