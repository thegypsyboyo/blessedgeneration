                            ...
                            {selectedPaymentMethod === "stripe" ? (
                                <form onSubmit={handleStripeSubmit}>
                                    <div className="relative block mt-0 mb-12">
                                        ...
                                        <span className="bg-[#002866] text-white text-center h-[60px] flex items-center w-[60px]">$</span>
                                        <input type='text'
                                        defaultValue="100"
                                        className="text-[#002866] text-[24px] font-[600] px-[20px] border border-borderColor text-end shadow-main w-full"/>
                                    </div>
