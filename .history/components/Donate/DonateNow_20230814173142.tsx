                                    ...
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block ">
                                                <div className="flex flex-wrap ">
                                                    <span className='h-[65px] rounded-[10px] bgbg-white shadow-custom leading-[65px] text-[1.8rem] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]'>ksh. 500</span>
                                                    <span className='h-[65px] rounded-[10px] bg-white shadow-custom leading-[65px] text-[1.8rem] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px]'>ksh. 1500</span>
                                                    <span className='h-[65px] rounded-[10px] bg-white shadow-custom leading-[65px] text-[1.8rem] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]'>ksh. 3000</span>
                                                    <span className='h-[65px] rounded-[10px] bg-white shadow-custom leading-[65px] text-[1.8rem] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]'>ksh. 5000</span>
                                                    <span className='h-[65px] rounded-[10px] bg-white shadow-custom leading-[65px] text-[1.8rem] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]'>ksh. 10,000</span>
                                                </div>
                                        </div>
                                    </div>
