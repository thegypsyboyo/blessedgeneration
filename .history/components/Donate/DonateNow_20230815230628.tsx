                                    ...
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block bg-white">
                                            <div className="absolute w-auto left-5 top-0 ">
                                                <select name="" id="" className='bg-white text-darkBlue h-[130px] w-[120px] outline-none rounded-3xl border-0 p-0 m-0 text-white text-5xl font-extrabold'>
                                            ...
                                            className='h-[100px] w-full border-none outline-none bg-white rounded-3xl pl-[10px] pr-[30px] text-5xl text-right font-extrabold tracking-tighter text-white z-[1]' />
                                        </div>
                                    </div>
                                    <div className="relative block mt-12 mb-12">
