        ...
        <Layout className='flex flex-col items-center' >
            ...
            <nav className=''>
              <div className='flex flex-wrap space-x-3 mb-[35px] text-center'>
                {['All', 'education', 'medicine', 'water', 'food'].map((category) => (
                  ...
                  className={`border-solid border-2 border-white capitalize font-bold bg-transparent py-[10px] px-[25px] text-darkBlue outline-none rounded-[30px] ${activeFilter === category ? 'border-redDark border-solid border-2 bg-yellowColor text-white' : ''}`} 
                  >
                  {category}
                  </button>
                ))}
            ...
            <div className="flex flex-wrap w-full">
                ...
                {filteredCauesItems.map((item, index) => (
                    ...
                    flex-grow-0 flex-shrink-0 group bg-yellowColor flex items-center m-auto justify-center " key={index}>
                        <div className="relative mb-[30px] flex flex-col items-center justify-center m-auto auto">
