                                ...
                                <form onSubmit={handleStripeSubmit}>
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block bg-white">
                                            ...
                                            className='h-[100px] w-full border-none outline-none bg-white shadow-custom rounded-3xl pl-[10px]  text-[30px] text-right font-extrabold tracking-tighter text-white z-[1]' />
                                        </div>
                                    </div>
                                    <div className="relative block mt-12 mb-12">
