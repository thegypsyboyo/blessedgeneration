                                ...
                                <div className="w-full h-full">
                                    <ul className="">
                                        ...
                                        <li className="inline-block ml-0 mr-4 relative" onClick={() => handlePaymentMethodChange('mpesa')}>
                                            <input type="radio" name='payment mode' />
                                            <label htmlFor="give gateway" className='text-[#002866] text-[14px font-normal leading-[24px] pl-[20px] transition-all duration-300'>
                                                M-Pesa Payment
                                            </label>
                                        </li>
                                    </ul>
                            ...
                            {selectedPaymentMethod === "stripe" ? (
                                <form onSubmit={handleStripeSubmit}>
                                    ...
                                    <div className="flex mb-[30px] relative w-full">
                                        <span className="bg-[#002866] text-white p-3 w-[30%]">Donation total: </span>
                                        <input type='text'
                                        defaultValue="100"
                                        className="text-[#002866] text-[24px] font-[600] px-[20px] shadow-main h-[50px] "/>
                                    </div>
                                ...
                                <div className="relative block mt-12 mb-12">
                                    ...
                                    <ul className="flex w-full h-full flex-wrap mb-[20px]">
                                            <li className="flex-shrink-0  flex-grow-0 ">
                                                ...
                                                className={`${formState.donationAmount === 5000 ? "bg-darkBlue  text-white" : ""} outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]`}>Ksh,5000</button>
                                            </li>
                                            <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                                <button 
                                                onClick={() => handleDonationAmountChange(100)}
                                                className={`${formState.donationAmount === 100 ? "bg-darkBlue  text-white" : ""} outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]`}>ksh,10000</button>
                                            </li>
                                            <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                                <button 
                                                onClick={() => handleDonationAmountChange(20000)}
                                                className={`${formState.donationAmount === 20000 ? "bg-darkBlue  text-white" : ""} outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]`}>Ksh,20,000</button>
                                            </li>
                                            <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                                <button 
                                                onClick={() => handleDonationAmountChange(50000)}
                                                className={`${formState.donationAmount === 50000 ? "bg-darkBlue  text-white" : ""} outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounded-[3px] w-[100px]`}>Ksh,50000</button>
                                            </li>
                                            <li className="ml-3  flex-shrink-0  flex-grow-0 ">
                                                <button 
                                                className="outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block px-[8px] shadow-main overflow-hidden transition-all duration-500 rounded-[3px] h-[50px] w-[100px]">Custom Amount</button>
                                            </li>
                                        </ul>
                                    {/* <div className="relative block ">
                                            <div className="flex flex-wrap ">
