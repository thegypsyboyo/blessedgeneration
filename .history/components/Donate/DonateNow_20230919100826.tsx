  ...
  return (
    <>
      ...
      <div className={`fixed overflow-y-auto w-full p-[20px] pt-[120px] h-full block text-white  bg-black opacity-[0.9] top-0 left-0 transition-all duration-500 z-[9999]`} />
        ...
        <div className={`fixed overflow-y-auto w-[600px] p-[20px] pt-[120px] h-full block text-white bg-white top-0 right-0  shadow-md transition-all duration-500 z-[9999] ${isOpen ? "transform translate-x-[0px] transition-all duration-[1200ms] ease-in":"transform translate-x-[500px]"}`}>
