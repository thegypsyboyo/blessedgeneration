                                ...
                                <div className='relative block pt-8 overflow-hidden z-[1]'>
                                    ...
                                    <div className="mb-4 overflow-hidden block relative  ">
                                        {/* <ul className='m-0 pl-0 list-none flex'>
                                            {singlecause.authors.map((author, index) =>(
                                            <li className="relative z-[1] text-xs uppercase pr-14 float-left flex items-center text-primaryText" key={index}>
                                                <Image src={urlFor(author.image).url()} alt='person-icon' width={80} height={80} className='h-9 w-9 rounded-full mr-3 object-contain bg-[#e9ecef] p-2'/>
