                ...
                <div className="w-full xl:max-w-[58.333333%] lg:max-w-[58.333333%] mb-[30px] flex-shrink-0">
                  ...
                  <div className="relative flex bg-lightBlue rounded-[20px] pt-[50px] pb-[41px] px-[50px] overflow-hidden">
                    ...
                    <div className="ml-[20px] mt-[-4px] ">
                        ...
                        <p className="font-semibold text-[18px] mt-[2px] text-darkBlue">Organizer:</p>
                        <p className="font-extrabold text-redDark text-[18px] ">Lewis Onyango</p>
                        <ul className="relative block mt-[11px] list-disc">
                            <li className="font-semibold text-darkBlue pl-[10px]">Education</li>
                        </ul>
                    </div>
                  </div>
                </div>
