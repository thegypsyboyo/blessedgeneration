        ...
        <Layout className='flex flex-col items-center' >
            ...
            <div className="flex flex-wrap w-full">
                ...
                {filteredCauesItems.map((item, index) => (
                    ...
                    flex-grow-0 flex-shrink-0 group bg-yellowColor m-auto " key={index}>
                        <div className="relative mb-[30px] flex flex-col items-center justify-center m-auto w-full bg-yellowColor h-full">
