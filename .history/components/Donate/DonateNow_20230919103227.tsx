  ...
  return (
    <>
      ...
      <div className={`fixed overflow-y-auto w-full p-[20px] pt-[120px] h-full block text-white  bg-black opacity-[0.9] top-0 left-0 transition-all duration-500 z-[9999]`} />
        ...
        <div className={`fixed overflow-y-auto w-full p-[20px] pt-[60px] h-full block text-white bg-transaprent top-0 mx-auto shadow-md transition-all duration-500 z-[9999] ${isOpen ? "transform translate-x-[0px] transition-all duration-[1200ms] ease-in":"transform translate-x-[500px]"}`}>
            <div className="rounded-full text-[#0e2258] text-[20px] font-normal h-[40px] leading-[38px] relative text-center top-[-85px] w-[40px] z-[2] float-right cursor-pointer"  onClick={onClose}> 
        ...
        <button
            ...
            <div className="flex flex-wrap w-full items-center justify-center">
                <div className="w-full lg:max-w-[50%] mb-[30px] flex-shrink-0">
