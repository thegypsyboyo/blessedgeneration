                                ...
                                <form onSubmit={handleStripeSubmit}>
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block bg-white">
                                            ...
                                            className='h-[100px] w-full border-none outline-none bg-darkBlue rounded-3xl pl-[10px] pr-[30px] text-5xl text-right font-extrabold tracking-tighter text-white z-[1]' />
                                        </div>
                                    </div>
                                    <div className="relative block mt-12 mb-12">
