...
const DonateNow:React.FC<DonationFormProps>  = ({}) =>  {
            ...
            <div className="flex flex-wrap w-full justify-between">
                <div className="w-full lg:max-w-[66.667%] mb-[30px] flex-shrink-0">
                  ...
                  {/* <div className="w-full xl:max-w-[33.333333%] lg:max-w-[33.333333%] mb-[30px] lg:pr-[15px] lg:pl-[15px] flex-shrink-0">
                    <h2 className="capitalize text-redDark mb-7 font-bold">Similar causes</h2>
                  ...
                  <div className="relative block mb-[30px]">
                            <div className="relative block overflow-hidden z-[1]">
                                ...
                                <Image src={"/images/test/gallery-4.jpg"} alt='main-image' width={400} height={400} className='w-full h-[300px] object-cover transform scale-[1] transition duration-500 ease group-hover:scale-[1.05]'/>
                  ...
                  <div className="relative flex bg-lightBlue  pt-[50px] pb-[41px] px-[50px] overflow-hidden">
                   ...
                   <div className="w-full lg:max-w-[33.333333%] mb-[30px] lg:pr-[15px] lg:pl-[35px] flex-shrink-0">
                                        ...
                                        <div className="flex items-start">
                                            <div className="pr-[15px]">
                                                <Link href={""} className='w-full h-full'>
                                                    <Image src={item.image} alt='similar-post' width={150} height={150} className='max-w-[65px]  rounded-1 h-[80px] object-cover'/>
                                                </Link>
                                            </div>
                                            <div>
