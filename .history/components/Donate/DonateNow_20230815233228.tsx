                ...
                <div className="w-full xl:max-w-[58.333333%] lg:max-w-[58.333333%] mb-[30px] flex-shrink-0">
                    <div className="relative -mt-2 flex w-full">
                        <div>
                            <div className="flex items-center">
                                <div className="flex ">
                                <button onClick={() => handlePaymentMethodChange('stripe')} className={`${selectedPaymentMethod === "stripe" ? "bg-darkBlue text-white": ""} relative flex items-center align-middle justify-between shadow-custom  appearance-none outline-none white text-darkblue text-[14px] font-[800] uppercase tracking-[0]  py-[15px] px-[30px] overflow-hidden transition-all ease-linear duration-500 group z-[1] rounded-[15px] hover:text-white mt-[41px] h-[70px]`}>
                                ...
                                <div className="ml-4">
                                    <button onClick={() => handlePaymentMethodChange('mpesa')} className={`${selectedPaymentMethod === "mpesa" ? "bg-darkBlue text-white":""} relative flex items-center align-middle justify-between shadow-custom  appearance-none outline-none white text-darkblue text-[14px] font-[800] uppercase tracking-[0]  py-[15px] px-[30px] overflow-hidden transition-all ease-linear duration-500 group z-[1] rounded-[15px] hover:text-white mt-[41px]  h-[70px]`}>
                                    <span className={`absolute w-[200%] h-[200%] content-[] -top-[230%] left-[50%] transform -translate-x-[50%] rounded-[50%] -z-[1] transition-all duration-1000 bg-primaryDark  group-hover:-top-[40%] `}/>
                                    ...
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block bg-white">
                                            <div className="absolute w-auto left-5 top-0 ">
                                                <select name="" id="" className='bg-transparent text-darkBlue h-[100px] w-[70px] outline-none rounded-3xl border-0 p-0 m-0 text-[30px] font-extrabold '>
                                                {selectedPaymentMethod === 'stripe' && <option value="" className="text-darkBlue bg-white hover:bg-darkBlue hover:text-white transition-all duration-300">$</option>}
                                                {selectedPaymentMethod === 'stripe' && <option value="">€</option>}
                                                {selectedPaymentMethod === 'stripe' && <option value="">kes</option>}
                                                </select>
                                            </div>
                                            <input 
                                            type='text ' 
                                            ...
                                            className='h-[100px] w-full border-none outline-none bg-white shadow-custom rounded-3xl text-[30px] text-right font-extrabold tracking-tighter text-darkBlue pr-[50px] z-[1] ' />
                                        </div>
                                    </div>
                                    <div className="relative block mt-12 mb-12">
                                ...
                                <div className="relative block mt-12 mb-12">
                                    ...
                                    <div className="relative block ">
                                            <div className="flex flex-wrap ">
                                                    ...
                                                    className={`${formState.donationAmount === 1000 ? "bg-orangeDefault text-white" : ""} h-[65px] rounded-[10px] bgbg-white shadow-custom leading-[65px] text-[2] transition-all duration-500 font-bold  px-7 cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        Ksh.1000
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(1500)}
                                                    className={`${formState.donationAmount === 1500 ? "bg-orangeDefault text-white" : ""} h-[65px] rounded-[10px] bgbg-white shadow-custom leading-[65px] text-[2] transition-all duration-500 font-bold  px-7 cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        Ksh.1500
                                                    </span>
                                    ...
                                    <div className="relative block">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            ...
                                            <div className="w-full xl:max-w-[50%] flex-shrink-0 flex-grow-0 xl:pl-[10px]">
                                                ...
                                                typeof="text" required placeholder="Last name" name="lastName" className='h-[58px] w-full border-none outline-none bg-borderColor text-primaryText] text-[14px] py-0 px-[30px] rounded-[20px] font-[400] '/>
                                                </div>
                                            </div>
                                            <div className="w-full xl:max-w-[50%] flex-shrink-0 flex-grow-0  xl:pr-[10px]">
                                                <div className="relative block mb-[20px] ">
                  ...
                  <div className="relative block mb-[30px]">
                            <div className="relative block rounded-tl-[20px] rounded-tr-[20px] overflow-hidden z-[1]">
                                ...
                                <Image src="/images/test/gallery-3.jpg" alt='main-image' width={400} height={400} className='w-full h-full object-cover transform scale-[1] transition duration-500 ease group-hover:scale-[1.05]'/>
                  ...
                  <div className="relative flex bg-lightBlue rounded-[20px] pt-[50px] pb-[41px] px-[50px] overflow-hidden">
                    <div className="relative block">
                        <Image src="/images/test/gallery-3.jpg" alt='main-image' width={400} height={400} className='w-[70px] h-[70px] object-cover transform scale-[1] transition duration-500 ease rounded-full'/>
                    </div>
