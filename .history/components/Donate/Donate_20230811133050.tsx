    ...
    <section className='relative block pt-[60px] mt-[120px] pb-[90px] px-0 w-full'>
        <Layout className='flex flex-col items-center' >
            <div className="relative block -mt-[4px] mb-[46px] text-center">
                <span className="text-primaryBase text-[24px] font-[700] leading-[24px] mb-[10px] font-cav">Help &amp; donate</span>
                <h2 className="m-0 text-orangeDefault text-[50px] leading-[60px] -tracking-[0.04em] font-[900] mt-[6px]">Find the popular cause <br /> and donate them</h2>
            </div>
                        ...
                        <div className="relative block mb-[30px]">
                            ...
                            <div className="relative block bg-white shadow-custom rounded-bl-[20px] rounded-br-[20px] border-solid border-borderColor pt-[22px] pb-[30px] px-[30px] border-t-0">
                                <h3 className="text-[26px] leading-[26px] font-[800] -tracking-[0.04em] ">
                                    <Link href={`/donate/donation-info/${item.slug}`} className='text-primaryDark transition-all duration-500 hover:text-redLight'>{item.title}</Link>
                                </h3>
                                ...
                                <div className="relative block w-full pt-[49px] px-[29px] pb-[20px] bg-borderColor rounded-[20px] border-solid border-borderColor z-[1]">
                                    <div className="relative w-full h-[7%] bg-white rounded-[5px] mb-[3px]">
                                        <div className="relative block h-[7px] rounded-[5px] bg-primaryBase transition-all duration-[1500ms] " style={{width: item.percentageAchieved}}>
                                            <div className="absolute right-0 bottom-[11px] text-primaryBase leading-[20px] text-[12px] text-center font-[700] transition-all duration-500 ease-in">
                                                <div className='absolute left-[12px] top-[24px] h-[6px] w-[6px] bg-white rounded-[50%] z-[1] content-[]'/>
                                               {item.percentageAchieved}
                                                <div className='content-[]  absolute left-[5px] top-[17px] h-[20px] w-[20px] bg-primaryBase rounded-[50%]'/>
                                            </div>
                                        </div>
                                    </div>
