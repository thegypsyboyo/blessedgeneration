                ...
                <div className="w-full xl:max-w-[58.333333%] lg:max-w-[58.333333%] mb-[30px] flex-shrink-0">
                    <div className="relative block -mt-2">
                        ...
                        <div className="relative block mt-12 mb-12">
                            ...
                            <div className="relative block ">
                                <div className="absolute w-auto left-0 target: ">
                                    <select name="" id="">
                                        <option value="">Ksh.</option>
                                        <option value="">$</option>
                                    </select>
                                </div>
                                <input typeof='text ' name='donation-money' placeholder=".00" value="" className='h-[130px] w-full border-none outline-none bg-primaryBase rounded-3xl pl-[150px] pr-[50px] text-5xl text-right font-extrabold tracking-tighter text-white z-[1]' />
                            </div>
                        </div>
                    </div>
                </div>
