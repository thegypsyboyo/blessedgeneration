            ...
            <nav className=''>
              <div className='flex w-full flex-wrap space-x-3 mb-[35px] text-center'>
                {['All', 'education', 'medicine', 'water', 'food'].map((category) => (
                  ...
                  className={`border-solid border-2  capitalize font-bold bg-transparent py-[10px] px-[25px] text-darkBlue outline-none rounded-[30px] ${activeFilter === category ? 'border-redDark border-solid' : ''}`} 
                  >
                  {category}
                  </button>
                ))}
