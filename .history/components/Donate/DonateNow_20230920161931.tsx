            ...
            <div className="flex flex-wrap w-full items-center justify-center">
                <div className="w-full lg:max-w-[66.667%] mb-[30px] flex-shrink-0">
                    <div className="relative -mt-2 flex w-full bg-white shadow-main p-[30px] rounded-[5px]">
                        <div className="absolute right-0 top-0 w-[30px] h-[30px] text-[20px] font-light text-white bg-black pb-[50x] pl-[5px] rounded-bl-[30px] flex items-center justify-center " >
                        <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
                    fill="none"
