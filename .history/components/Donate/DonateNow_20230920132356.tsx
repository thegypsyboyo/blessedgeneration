                                    ...
                                    <ul className="">
                                        <li className="inline-block ml-0 mr-4 relative">
                                            ...
                                            <label htmlFor="give gateway" className='text-[#002866] text-[14px font-normal leading-[24px] pl-[20px] transition-all duration-300'>
                                                <div className='content-[] absolute top-[50%] left-0 w-[12px] h-[12px] rounded-[12px] shadow-main transform translate-y-[-50%] bg-[#002866]'/>
                                                Test Donation
                                                <div className="content-[] absolute top-[50%] left[2px] w-[8px] h-[8px] bg-[#0073a8] rounded-[10px] transform translate-y-[-50%] transition-all duration-300"/>
                                            </label>
                                        </li>
                                    </ul>
                                </div>
