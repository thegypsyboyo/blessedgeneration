                            ...
                            <div className="relative block ">
                                <form action="#" >
                                    <div className="flex flex-wrap ">
                                        <span className='h-[65px] rounded-[10px] bg-lightBlue shadow-custom leading-[65px] text-[1.8rem] transition-all duration-500 font-bold px-[20px] cursor-pointer '>ksh. 500</span>
                                        <span>ksh. 1000</span>
                                        <span>ksh. 2000</span>
                                    </div>
                                </form>
