                                ...
                                <div className="relative block mt-12 mb-12">
                                    ...
                                    <div className="relative block ">
                                            <div className="flex flex-wrap ">
                                                    ...
                                                    className={`${formState.donationAmount === 250 ? "bg-yellowColor  text-white" : ""} h-[65px]  bg-white shadow-custom leading-[65px]  transition-all duration-500 font-bold  cursor-pointer  px-11  hover:bg-yellowColor  hover:text-white rounded-lg text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        250
                                                    </span>
                                                    <span  
