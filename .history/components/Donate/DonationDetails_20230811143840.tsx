...
import { faArrowRight, faComment, faDonate, faMagnifyingGlass, faSearch, faUserCircle } from '@fortawesome/free-solid-svg-icons'
                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                              ...
                              <div className='relative flex bg-borderColor border-solid border-borderColor rounded-[20px] items-center justify-between py-[36px] px-[39px] overflow-hidden mt-12 mb-12 z-[1]'>
                                <div className="relative block">
                                  <ul className='relative flex items-center'>
                                    <li className="flex relative items-center">
                                      <div className="relative flex items-center">
                                        <span className="relative inline-block text-6xl text-primaryBase">
                                          <FontAwesomeIcon icon={faDonate}/>
                                        </span>
                                      </div>
                                      <div className="ml-5">
                                        <span className="text-xl font-normal text-primaryText">Raised</span>
                                        <p className='text-xl text-primaryDark font-bold leading-6'>Ksh.40,000</p>
                                      </div>
                                    </li>
                                    <li className="flex relative items-center">
                                      <div className="relative flex items-center">
                                      ...
                                      <div className="ml-5">
                                        <span className="text-xl font-normal text-primaryText">Goal</span>
                                        <p className='text-xl text-primaryDark font-bold leading-6'>Ksh, 140,000</p>
                                      </div>
                                    </li>
                                  </ul>
                                </div>
