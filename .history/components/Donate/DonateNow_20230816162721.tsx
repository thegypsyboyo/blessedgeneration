    ...
    const handlePaymentMethodChange = (method: 'stripe' | 'mpesa') => {
      ...
      const handleMpesaSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
          ...
          const accessTokenResponse = await axios.post(MPESA_API_URL, null, {
            headers: {
          ...
          const paymentResponse = await axios.post(
            'https://api.safaricom.co.ke/mpesa/c2b/v1/simulate',
            {
              ...
              Amount: formState.donationAmount.toString(), // Convert amount to string
              Msisdn: formState.phoneNumber, // Use the phone number from formState
