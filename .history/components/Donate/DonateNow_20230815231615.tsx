                                    ...
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block bg-white">
                                            <div className="absolute w-auto left-5 top-0 ">
                                                <select name="" id="" className='bg-transparent text-darkBlue h-[100px] w-[120px] outline-none rounded-3xl border-0 p-0 m-0 text-[30px] font-extrabold '>
                                                ...
                                                {selectedPaymentMethod === 'stripe' && <option value="">Ksh</option>}
                                                </select>
                                            </div>
                                            <input 
                                            type='text ' 
                                            ...
                                            className='h-[100px] w-full border-none outline-none bg-white shadow-custom rounded-3xl pl-[10px]  text-[30px] text-right font-extrabold tracking-tighter text-white z-[1] pl-4' />
                                        </div>
                                    </div>
                                    <div className="relative block mt-12 mb-12">
