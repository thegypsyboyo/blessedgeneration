                    ...
                    <div className="relative -mt-2 flex w-full bg-white shadow-main p-[30px] rounded-[5px]">
                        <div>
                            <div className="flex items-start flex-col w-full">
                                ...
                                <div className="w-full h-full">
                                    <ul className="">
                                        <li className="inline-block ml-0 mr-4 relative">
                                    ...
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <ul className="flex w-full h-full flex-wrap mb-[20px]">
                                            <li className="flex-shrink-0  flex-grow-0 ">
                                                <button 
                                                onClick={() => handleDonationAmountChange(10)}
                                                className={`${formState.donationAmount === 10 ? "bg-darkBlue  text-white" : ""} outline-none text-[#002866] bg-[#fe0] text-[16px] font-[600]  inline-block py-[12px] px-[8px] shadow-main overflow-hidden transition-all duration-500 rounde-[3px] w-[100px]`}>$10</button>
                                            </li>
