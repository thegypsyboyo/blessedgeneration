                                    ...
                                    <div className="relative block">
                                        ...
                                        <div className="flex flex-wrap w-full">
                                            ...
                                            <div className="w-full xl:max-w-[50%] flex-shrink-0 flex-grow-0 xl:pl-[10px]">
                                                ...
                                                typeof="text" required placeholder="Last name" name="lastName" className='min-h-[50px] px-[20px] py-[12px]  w-full border-none outline-none bg-borderColor text-primaryText] text-[16px] font-[400] '/>
                                                </div>
                                            </div>
                                            <div className="w-full xl:max-w-[50%] flex-shrink-0 flex-grow-0  xl:pr-[10px]">
                                                <div className="relative block mb-[20px] ">
