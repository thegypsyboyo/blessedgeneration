                           ...
                           <h3 className='text-[23px] font-[700] -tracking-[0.04] text-primaryDark relative pb-4 capitalize'>
                            ...
                            <ul className='m-0 pl-0 list-none'>
                                ...
                                <li key={(item.id)*index}>
                                    ...
                                    className={`group text-[#7b8381] text-[16px] relative transition-all duration-500 block bg-none py-[5px] font-[500]  hover:text-primaryDark mt-[10px] hover:border-b-borderColor border-b border-b-[#e7e7e7] ${item.id === activeCategoryId? "border-b-borderColor": ""}`}>
                                        {item.title}
