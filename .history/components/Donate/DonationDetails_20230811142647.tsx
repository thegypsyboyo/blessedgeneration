                    ...
                    <div className="relative block w-full">
                        <div className="relative block space-y-4 w-full ">
                            ...
                            className="relative block" key={index}>
                              ...
                              <div className='relative flex bg-borderColor border-solid border-borderColor rounded-[20px] items-center justify-between py-[36px] px-[39px] overflow-hidden mt-12 mb-12'>others</div>
                            </motion.div>
