                                        ...
                                        <div className="flex flex-wrap w-full">
                                            <div className="w-full xl:max-w-[50%] flex-shrink-0 flex-grow-0  xl:pr-[10px]">
                                                ...
                                                <label htmlFor="First name" className="text-[14px] font-normal leading-[24px] relative text-darkBlue">
                                                    ...
                                                    <span className="text-primaryText text-[14px] mx-1 p-0 transition-all duration-200 relative inline-block">
                                                        <span className="absolute left-[calc(50%-6px)] mb-[-11px] border-[6px] border-primaryText rounded-full top-0">
