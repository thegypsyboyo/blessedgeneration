                                    ...
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block ">
                                                <div className="flex flex-wrap ">
                                                    ...
                                                    className={`${formState.donationAmount === 25 ? "bg-yellowColor  text-white" : ""} h-[65px]  bg-white shadow-custom leading-[65px] text-darkBlue transition-all duration-500 font-bold  cursor-pointer  px-11  hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        25
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(50)}
                                                    className={`${formState.donationAmount === 50 ? "bg-yellowColor  text-white" : ""} h-[65px] bg-white shadow-custom leading-[65px] text-darkBlue transition-all duration-500 font-bold  px-11 cursor-pointer hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        50
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(100)}
                                                    className={`${formState.donationAmount === 100 ?  "bg-yellowColor  text-white" : ""} h-[65px] bg-white shadow-custom leading-[65px] text-darkBlue transition-all duration-500 font-bold  px-11 cursor-pointer hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        100
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(500)}
                                                    className={`${formState.donationAmount === 500 ?  "bg-yellowColor  text-white" : ""} h-[65px] bg-white shadow-custom leading-[65px] text-darkBlue transition-all duration-500 font-bold  px-11 cursor-pointer hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        500
                                                    </span>
                                ...
                                <div className="relative block mt-12 mb-12">
                                    ...
                                    <div className="relative block ">
                                            <div className="flex flex-wrap ">
                                                    ...
                                                    className={`${formState.donationAmount === 250 ? "bg-orangeDefault text-white" : ""} h-[65px]  bgbg-white shadow-custom leading-[65px] text-[2] transition-all duration-500 font-bold  cursor-pointer  px-11  hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        250
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(500)}
                                                    className={`${formState.donationAmount === 500 ? "bg-orangeDefault text-white" : ""} h-[65px]  bgbg-white shadow-custom leading-[65px] text-[2] transition-all duration-500 font-bold  px-11 cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        500 
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(1000)}
                                                    className={`${formState.donationAmount === 1000 ? "bg-orangeDefault text-white" : ""} h-[65px]  bgbg-white shadow-custom leading-[65px] text-[2] transition-all duration-500 font-bold  px-11 cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        1000
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(1500)}
                                                    className={`${formState.donationAmount === 1500 ? "bg-orangeDefault text-white" : ""} h-[65px] bg-white shadow-custom leading-[65px] text-[2] transition-all duration-500 font-bold  px-11 cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        1500
                                                    </span>
