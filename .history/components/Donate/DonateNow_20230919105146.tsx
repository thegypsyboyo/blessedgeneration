...
const DonateNow:React.FC<DonationFormProps>  = ({isOpen, onClose}) =>  {
  ...
  return (
    <>
      ...
      <div className={`fixed overflow-y-auto w-full p-[20px] pt-[120px] h-full block text-white  bg-black opacity-[0.9] top-0 left-0 transition-all duration-500 z-[9999]`} />
        ...
        <div className={`fixed overflow-y-auto w-full p-[0px] pt-[60px] h-full block text-white bg-transaprent top-0 mx-auto shadow-md transition-all duration-500 z-[9999] ${isOpen ? "transform translate-x-[0px] transition-all duration-[1200ms] ease-in":"transform translate-x-[500px]"}`}>
            {/* <div className="rounded-full text-[#0e2258] text-[20px] font-normal h-[40px] leading-[38px] relative text-center top-[10px] w-[40px] z-[2] float-right cursor-pointer bg-white"  onClick={onClose}> 
                    <FontAwesomeIcon icon={faClose}/>
            </div> */}
            <button
                  onClick={onClose}
                  className="relative mt-0  text-white  focus:outline-none"
                >
                  <svg
            ...
            <div className="flex flex-wrap w-full items-center justify-center">
                <div className="w-full lg:max-w-[66.667%] mb-[30px] flex-shrink-0">
                    <div className="relative -mt-2 flex w-full bg-white bg-shadow  p-[30px] rounded-[5px]">
                        <div>
                            <div className="flex items-center flex-wrap w-full">
                                <div className="flex lg:max-w-[50%] w-full ">
                                <button onClick={() => handlePaymentMethodChange('stripe')} className={`${selectedPaymentMethod === "stripe" ? "bg-yellowColor text-white": ""} relative flex items-center align-middle justify-between bg-shadow  appearance-none w-full  outline-none white text-darkblue text-[14px] font-[800] uppercase tracking-[0]  py-[15px] px-[30px] overflow-hidden transition-all ease-linear duration-500 rounded-[5px]  group z-[1]  hover:text-white mt-[4px] h-[70px]`}>
                                ...
                                <div className="lg:pl-4 w-full lg:mt-0 mt-5 lg:max-w-[50%]">
                                    <button onClick={() => handlePaymentMethodChange('mpesa')} className={`${selectedPaymentMethod === "mpesa" ? "bg-yellowColor text-white":""} relative flex items-center align-middle justify-between bg-shadow  appearance-none w-full  outline-none white text-darkblue text-[14px] font-[800] uppercase tracking-[0]  py-[15px] px-[30px] overflow-hidden transition-all ease-linear duration-500 group rounded-[5px] z-[1] hover:text-white mt-[4px]  h-[70px]`}>
                                    <span className={`absolute w-[200%] h-[200%] content-[] -top-[230%] left-[50%] transform -translate-x-[50%] rounded-[50%] -z-[1] transition-all duration-1000 bg-yellowColor  group-hover:-top-[40%] `}
                            ...
                            {selectedPaymentMethod === "stripe" ? (
                                <form onSubmit={handleStripeSubmit}>
                                    <div className="relative block mt-0 mb-12">
                                        ...
                                        <div className="relative block bg-white">
                                            ...
                                            className='h-[100px] w-full border-none outline-none bg-yellowColor bg-shadow  pl-[150px] pr-[30px] text-5xl rounded-[5px]  text-right font-extrabold tracking-tighter text-white z-[1]' />
                                        </div>
                                    </div>
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block ">
                                                <div className="flex flex-wrap ">
                                                    ...
                                                    className={`${formState.donationAmount === 25 ? "bg-yellowColor  text-white" : ""} h-[65px]  bg-white bg-shadow leading-[65px]  transition-all duration-500 font-bold  cursor-pointer  px-11  hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        25
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(50)}
                                                    className={`${formState.donationAmount === 50 ? "bg-yellowColor  text-white" : ""} h-[65px] bg-white bg-shadow leading-[65px] text-darkBlue transition-all duration-500 font-bold  px-11 cursor-pointer rounded-[5px] hover:bg-yellowColor  hover:text-white mr-[20px] mb-[15px]`}
                                                    >
                                                        50
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(100)}
                                                    className={`${formState.donationAmount === 100 ?  "bg-yellowColor  text-white" : ""} h-[65px] bg-white bg-shadow leading-[65px] text-darkBlue transition-all duration-500 font-bold  px-11 cursor-pointer hover:bg-yellowColor  hover:text-white  mr-[20px] mb-[15px]`}
                                                    >
                                                        100
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(500)}
                                                    className={`${formState.donationAmount === 500 ?  "bg-yellowColor  text-white" : ""} h-[65px] bg-white bg-shadow leading-[65px]  transition-all duration-500 font-bold  px-11 cursor-pointer hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        500
                                                    </span>
                                ...
                                <div className="relative block mt-7 mb-12">
                                        ...
                                        <div className="relative block ">
                                            ...
                                            value={formState.donationAmount}
                                            onChange= {(event) => handleDonationAmountChange(Number(event.target.value))}
                                            className='h-[100px] w-full border-none outline-none bg-yellowColor bg-shadow  pl-[150px] pr-[30px] text-5xl text-right font-extrabold tracking-tighter text-white z-[1]' />
                                        </div>
                                </div>
                                <div className="relative block mt-12 mb-12">
                                    ...
                                    <div className="relative block ">
                                            <div className="flex flex-wrap ">
                                                    ...
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(500)}
                                                    className={`${formState.donationAmount === 500 ? "bg-yellowColor  text-white" : ""} h-[65px]  bg-white bg-shadow leading-[65px]  transition-all duration-500 font-bold  cursor-pointer  px-11  hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        500 
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(1000)}
                                                    className={`${formState.donationAmount === 1000 ? "bg-yellowColor  text-white" : ""} h-[65px]  bg-white bg-shadow leading-[65px]  transition-all duration-500 font-bold  cursor-pointer  px-11  hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        1000
                                                    </span>
                                                    <span  
                                                    onClick={() => handleDonationAmountChange(1500)}
                                                    className={`${formState.donationAmount === 1500 ? "bg-yellowColor  text-white" : ""} h-[65px]  bg-white bg-shadow leading-[65px]  transition-all duration-500 font-bold  cursor-pointer  px-11  hover:bg-yellowColor  hover:text-white text-darkBlue mr-[20px] mb-[15px]`}
                                                    >
                                                        1500
                                                    </span>
    ...
    <section className='block py-[120px] relabg-tive'>
        <Layout>
