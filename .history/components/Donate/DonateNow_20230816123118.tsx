                                    ...
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block bg-white">
                                            <div className="absolute w-auto left-5 top-0 ">
                                                ...
                                                >
                                                {selectedPaymentMethod === 'stripe' && <option value="stripe"  className="">$</option>}
                                                {selectedPaymentMethod === 'stripe' && <option value="stripe" >€</option>}
                                                {selectedPaymentMethod === 'stripe' && <option value="stripe" >kes</option>}
                                                </select>
                                            </div>
                                            <input 
                                            type='text ' 
