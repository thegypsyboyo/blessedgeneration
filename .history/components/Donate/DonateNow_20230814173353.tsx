                    ...
                    <div className="relative -mt-2 flex w-full">
                        <div>
                            ...
                            {selectedPaymentMethod === "stripe" ? (
                                    ...
                                    <div className="relative block mt-12 mb-12">
                                        ...
                                        <div className="relative block ">
                                                <div className="flex flex-wrap ">
                                                    <span className='h-[65px] rounded-[10px] bgbg-white shadow-custom leading-[65px] text-[20px] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]'>ksh. 500</span>
                                                    <span className='h-[65px] rounded-[10px] bg-white shadow-custom leading-[65px] text-[20px] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px]'>ksh. 1500</span>
                                                    ...
                                                    <span className='h-[65px] rounded-[10px] bg-white shadow-custom leading-[65px] text-[20px] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]'>ksh. 5000</span>
                                                    <span className='h-[65px] rounded-[10px] bg-white shadow-custom leading-[65px] text-[20px] transition-all duration-500 font-bold px-[20px] cursor-pointer hover:bg-orangeDefault  hover:text-white text-darkBlue mr-[20px] mb-[15px]'>ksh. 10,000</span>
                                                </div>
                                        </div>
                                    </div>
                                ...
                                {/* Common form fields */}
                                <div className="relative block mt-12 mb-12">
                                        <h3 className="lg:text-2xl lg:leading-8 xl:text-3xl xl:leading-9 text-lg mt-7 mb-6 font-extrabold tracking-tighter text-white">Enter your donation</h3>
                                        <div className="relative block ">
                                            <div className="absolute w-auto left-5 top-0 ">
                                                <select name="" id="" className='bg-primaryBase h-[130px] w-[120px] outline-none rounded-3xl border-0 p-0 m-0 text-white text-5xl font-extrabold'>
                                                    <option value="">Ksh</option>
