                    ...
                    <div className="relative -mt-2 flex w-full">
                        <div>
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <button onClick={() => handlePaymentMethodChange('mpesa')} className={`relative flex items-center align-middle justify-between shadow-custom  appearance-none outline-none white text-darkblue text-[14px] font-[800] uppercase tracking-[0]  py-[15px] px-[30px] overflow-hidden transition-all ease-linear duration-500 group z-[1] bg-green-600 hover:text-white mt-[41px]`}>
                                    ...
                                    <Image src="/images/mpesa.png" alt="mpesa" width={100} height={100} className='w-[40px] h-[40px] object-contain mr-3 rounded-full bg-slate-300 p-2'/>
                                        M-Pesa
                                    </button>
                                </div>
                            </div>
