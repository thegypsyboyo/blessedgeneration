            ...
            <nav className=''>
              <div className='flex w-full flex-wrap space-x-3 mb-[35px] text-center'>
                {['All', 'Education', 'medicine', 'Water', 'Food'].map((category) => (
                  ...
                  className={`border-solid border-2 border-transparent capitalize font-bold bg-transparent py-[10px] px-[25px] text-darkBlue outline-none ${activeFilter === category ? 'item-active' : 'nav-link'}`} 
                  >
                  {category}
                  </button>
                ))}
