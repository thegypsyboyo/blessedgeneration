                    ...
                    <div className="relative block -mt-2">
                        ...
                        <div className="relative block mt-12 mb-12">
                            ...
                            <div className="relative block ">
                                ...
                                <input typeof='text ' name='donation-money' placeholder=".00" value="" className='h-[130px] w-full border-none outline-none bg-primaryDark rounded-3xl pl-[150px] pr-[50px] text-5xl text-right font-extrabold tracking-tighter text-white z-[1]' />
                            </div>
                        </div>
                    </div>
                </div>
