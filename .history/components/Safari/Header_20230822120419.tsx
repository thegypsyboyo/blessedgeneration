        ...
        <Layout>
            ...
            <div className='relative w-full h-full flex transition-transform duration-500  bg-darkBlue'>
                ...
                <div className='relative flex h-full flex-wrap w-full bg-dakBlue justify-center items-center'>
                    <div className="content-[] bg-[#94b3cd] absolute w-[70%]  h-[600px] top-0 bottom-0 left-0  "/>
                    <div className="bg-[#abb8c3] w-full h-full flex-shrink-0 flex-grow-0  lg:max-w-[40.8%] px-[16%] pt-[50px] pb-[85px] z-[2]">
                        <h3>{item.title}</h3>
                    </div>
