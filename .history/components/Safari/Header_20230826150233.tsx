        ...
        <Layout>
            ...
            <div className='relative w-full h-full flex transition-transform duration-500  bg-darkBlue'>
                ...
                <div className='relative flex h-full flex-wrap w-full bg-transparent justify-center items-center lg:px-5'>
                    <div className="content-[] bg-yellowColor absolute  w-[70%]  h-full top-0 bottom-0 left-0  "/>
                    <div className="bg-yellowColor w-full h-full flex-shrink-0 flex-grow-0   lg:max-w-[40.8%] z-[2] flex text-center items-center justify-center">
                        <div className="px-[16%] pt-[50px] pb-[85px] w-full h-full flex flex-col items-center justify-center">
                            <span className='text-[40px] font-[300] font-cav  text-redDark'>{item.location}</span>
                            <h3 className='text-[30px] leading-[43px] font-[400] font-nun text-white uppercase'>{item.title}</h3>
                            <span className='text-primaryText font-light font-nun text-[20px] uppercase text-white mt-3'>{item.category}</span>
                            <p className="text-[16px] text-darkBlue leading-[25px] font-[400] font-man mt-[20px] tracking-[0.04em]">
                               {item.description}
                            </p>
