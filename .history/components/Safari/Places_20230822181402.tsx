...
const Places = () => {
  return (
    <section className="py-[50px] w-full h-full">
        ...
        <div className="bg-cover bg-center bg-repeat w-full relative h-[207px] inline-block align-middle mt-[40px] " style={{backgroundImage: `url(/images/timeline.svg)`}}></div>
    </section>
  )
}
