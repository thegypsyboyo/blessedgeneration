                ...
                {causesItem.map((item, index) => (
                    ...
                    flex-grow-0 flex-shrink-0 group flex items-center m-auto justify-center " key={index}>
                        <div className="relative mb-[30px] flex flex-col items-center justify-items-center ">
                            ...
                            <div className="relative block w-full min-h-[250px] bg-white shadow-custom border-solid border-borderColor pt-[22px] pb-[30px] px-[30px] border-t-0">
                                <h3 className="text-[26px] leading-[26px] font-[800] -tracking-[0.04em] ">
                                    <Link href={`/donate/donation-info/${item.slug}`} className='text-redLight transition-all duration-500 hover:text-darkBlue'>explore</Link>
                                </h3>
