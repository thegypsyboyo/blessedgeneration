        ...
        <Layout >
            <div className="w-full h-full flex justify-between flex-wrap ">
                ...
                <div className="flex-grow-0 flex-shrink-0 lg:max-w-[66.6666%] w-full h-full lg:pr-[15px]">
                    <div className="w-full h-full bg-redDark flex flex-wrap space-y-2">
                        <div className="md:max-w-[50%] bg-lightBlue h-full w-full h-[240px]">content</div>
                        <div className="md:max-w-[50%] bg-lightBlue h-full w-full">content</div>
                        <div className="md:max-w-[50%] bg-lightBlue h-full w-full">content</div>
                        <div className="md:max-w-[50%] bg-lightBlue h-full w-full">content</div>
                    </div>
                </div>
