            ...
            <div className="w-full h-full flex items-center flex-wrap ">
                ...
                <div className="flex-grow-0 flex-shrink-0 lg:max-w-[66.6666%] w-full h-full lg:pr-[15px]">
                    <div className="w-full h-full bg-redDark flex flex-wrap">
                        <div className="md:w-[50%] w-full h-full flex-shrink-0 flex-grow-0 ">
                            <Image src="/images/test/gallery-1.jpg" alt='img-1' width={300} height={300} className='w-full h-full'/>
                            <div className="">
