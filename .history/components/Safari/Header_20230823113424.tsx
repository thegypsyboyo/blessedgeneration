        ...
        <Layout>
            ...
            <div className='relative w-full h-full flex transition-transform duration-500  bg-darkBlue'>
                ...
                <div className='relative flex h-full flex-wrap w-full bg-transparent justify-center items-center lg:px-5'>
                    ...
                    <div className="custom-prev z-[2] absolute left-0 top-[50%] px-2 py-3 rounded-full bg-lightBlue">
                     <BsArrowLeft/>
                    </div>
                    <div className="custom-next z-[2] absolute right-0 top-[50%] px-2 py-3 rounded-full bg-lightBlue ">
                        <BsArrowRight/>
                    </div>
                </div>
