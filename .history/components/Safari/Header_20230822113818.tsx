        ...
        <Layout>
            ...
            <div className='swiper-container relative w-full h-full z-100 flex transition-transform duration-500 ease-in-out box-content'>
                ...
                <div className='relative flex flex-wrap h-full w-full bg-white justify-center items-center'>
                    ...
                    <div className="lg:max-w-[59.2%] w-full h-full bg-transparent z-[2] items-center flex justify-center flex-shrink-0 flex-grow-0">
                        <Link href="" className="w-full h-[350px] bg-primaryDark">
