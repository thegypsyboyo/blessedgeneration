        ...
        <Layout>
            ...
            <div className='swiper-container relative w-full h-full z-100 flex transition-transform duration-500 ease-in-out box-content'>
                ...
                <div className='relative flex h-full w-full bg-white justify-center items-center'>
                    <div className="content-[] bg-[#abb8c3] absolute w-[70%] h-full top-0 bottom-0 left-0  "/>
                    <div className="bg-[#abb8c3] w-full h-full flex-shrink-0 flex-grow-0 lg:max-w-[40.8%]">
                        <h3>{item.title}</h3>
                    </div>
                    <div className="lg:max-w-[59.2%] w-full h-full  bg-yellow bg-darkBlue z-[2] items-center flex justify-center">
                        <Link href="" className="w-full h-[350px]">
                            {/* <Image src={item.img} alt="image main" width={500} height={500} className="w-full"  /> */}
                        </Link>
                    </div>
                </div>
