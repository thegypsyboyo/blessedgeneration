        ...
        <Layout >
            <div className="w-full h-full flex justify-between flex-wrap ">
                ...
                <div className="flex-grow-0 flex-shrink-0 lg:max-w-[66.6666%] w-full h-full lg:pl-[15px] bg-darkBlue">
                    <div className='w-full h-full flex flex-wrap items-start justify-between bg-redDark'>
                        <div className="w-full bg-redLight h-[250px] pl-2  mb-[30px] overflow-hidden md:max-w-[50%]
