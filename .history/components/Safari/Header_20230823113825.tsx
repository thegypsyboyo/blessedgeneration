        ...
        <Layout>
            ...
            <div className='relative w-full h-full flex transition-transform duration-500  bg-darkBlue'>
                ...
                <div className='relative flex h-full flex-wrap w-full bg-transparent justify-center items-center lg:px-5'>
                    ...
                    <div className="custom-prev z-[2] absolute left-0 top-[50%] p-2 rounded-full bg-darkBlue w-[40px] h-[40px] flex items-center text-white">
                     <BsArrowLeft className="z-[3] text-white text-[20px]"/>
                    </div>
                    <div className="custom-next z-[2] absolute right-0 top-[50%] flex items-center p-2 rounded-full bg-darkBlue w-[40px] text-white h-[40px] ">
                        <BsArrowRight/>
                    </div>
                </div>
