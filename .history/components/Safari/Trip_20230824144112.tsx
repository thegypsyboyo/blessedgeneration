            ...
            <div className="w-full h-full flex justify-between flex-wrap items-center">
                <div className="flex-grow-0 flex-shrink-0 w-full mb-7 lg:max-w-[33.3333%] h-full lg:pr-[15px] items-center justify-center">
                    <div className="w-full h-full">
                        <h1 className="m-0 text-dark lg:text-[50px] lg:leading-[60px] text-[35px] leading-[40px] -tracking-[0.04em] font-[900] lg:max-w-[650px] sm:max-w-[500px] mt-[6px] uppercase">THE TOP 4 DAY TRIPS</h1>
                        <span className="text-[18px] capitalize leading-[28px] mt-[30px] pb-4 font-[500]  text-redLight">check out our most popular attractions in Kenya</span>
