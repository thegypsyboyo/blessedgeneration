        ...
        <Layout>
            ...
            <div className='relative w-full h-full flex transition-transform duration-500  bg-darkBlue'>
                ...
                <div className='relative flex h-full flex-wrap w-full bg-transparent justify-center items-center lg:px-5'>
                    <div className="content-[] bg-redLight absolute rounded-[20px] w-[70%]  h-full top-0 bottom-0 left-0  "/>
                    <div className="bg-redLight w-full h-full flex-shrink-0 flex-grow-0   lg:max-w-[40.8%] z-[2] flex text-center items-center justify-center">
                    ...
                    <div className="lg:max-w-[59.2%] flex-shrink-0 flex-grow-0  w-full lg:h-full  bg-yellow bg-trasparent items-center h-[400px] overlow-hidden flex justify-center z-[2]">
                        <Link href="" className="w-full rounded-[10px] bg-white overflow-hidden h-[400px] lg:h-[80%]">
                            <Image src={item.img} alt="image main" width={500} height={500} className="w-full h-full rounded-[10px] object-cover"/>
                        </Link>
                    </div>
                    <div className="custom-prev z-[2] absolute left-0 top-[50%] p-2 rounded-full bg-darkBlue w-[40px] h-[40px] flex items-center text-white cursor-pointer group transition-all duration-500 ease-in hover:text-redLight hover:bg-white">
                     <BsArrowLeft className="text-white text-[20px] group-hover:text-darkBlue"/>
                    </div>
                    <div className="custom-next z-[2] absolute right-1 top-[50%] p-2 rounded-full bg-darkBlue w-[40px] h-[40px] flex items-center text-white cursor-pointer group transition-all duration-500 ease-in hover:text-redLight hover:bg-white">
