  ...
  return (
    ...
    <section className='py-[120px] w-full h-full'>
        <Layout>
            ...
            loop={true}
            // navigation={true}
            navigation={{ nextEl: '.custom-next', prevEl: '.custom-prev' }} // Configure custom navigation arrows
            ...
            <div className='relative w-full h-full flex transition-transform duration-500  bg-darkBlue'>
                ...
                >
                <div className='relative flex h-full flex-wrap w-full bg-darkBlue justify-center items-center px-5'>
                    <div className="content-[] bg-lightBlue absolute w-[70%]  h-full top-0 bottom-0 left-0  " style={{backgroundImage: `url(/images/orangeBg.jpg)`}}/>
                    <div className="bg-lightBlue w-full h-full flex-shrink-0 flex-grow-0  lg:max-w-[40.8%] z-[2] flex text-center items-center justify-center" style={{backgroundImage: `url(/images/orangeBg.jpg)`}}>
                        <div className="px-[16%] pt-[50px] pb-[85px] w-full h-full flex flex-col items-center">
                            <span className='text-[40px] font-[300] font-cav  text-white'>Watamu Kenya</span>
                            <h3 className='text-[30px] leading-[43px] font-[400] font-nun text-white uppercase'>travel nighclubs in watamu kenya</h3>
                            ...
                            <div className="mt-[30px]">
                                <Link href="" className="font-[400] uppercase font-man text-[14px] text-white">read more ...</Link>
                    ...
                    <div className="lg:max-w-[59.2%] flex-shrink-0 flex-grow-0  w-full h-full  bg-yellow bg-trasparent items-center flex justify-center z-[2]">
                        <Link href="" className="w-full  bg-white h-[450px]">
                            <Image src={item.img} alt="image main" width={500} height={500} className="w-full h-full  object-cover"/>
                        </Link>
                    </div>
                    <div className="custom-prev z-[2] absolute left-0 top-[50%]">Previous</div>
                    <div className="custom-next z-[2] absolute right-0 top-[50%] px-2 px-3 bg-lightBlue ">Next</div>
                </div>
