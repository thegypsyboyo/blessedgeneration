                ...
                <div className='relative flex h-full flex-wrap w-full bg-transparent justify-center items-center lg:px-5'>
                    ...
                    <div className="lg:max-w-[59.2%] flex-shrink-0 flex-grow-0  w-full lg:h-full  bg-yellow bg-trasparent items-center h-[400px] overflow-hidden flex justify-center z-[2]">
                        <Link href="" className="w-full rounded-[10px] bg-white overflow-hidden h-[400px] lg:h-[80%]">
                            <Image src={item.img} alt="image main" width={500} height={500} className="w-full h-full rounded-[20px] object-cover"/>
                        </Link>
                    </div>
                    <div className="custom-prev z-[2] absolute left-0 top-[50%] p-2 rounded-full bg-darkBlue w-[60px] h-[60px] flex items-center text-white cursor-pointer group transition-all justify-center duration-500 ease-in hover:text-redLight hover:bg-white">
