  ...
  return (
    <section className="py-[50px] w-full h-full">
        ...
        {/* <div className="mt-7 relative overflow-x-auto overflow-y-hidden h-[207px] min-w-screen ">
                <div className="absolute top-0 left-0 w-full h-full bg-cover bg-map-image z-[-1]" style={{backgroundImage: `url(/images/timeline.svg)`}} />
        ...
        <div className="flex items-center justify-center mt-7">
            <div className={`card  overflow-x-auto  bg-redLight min-w-full min-h-[200px] flex ${isDragging ? "cursor-grabbing" : "cursor-grab"}`} onMouseDown={handleMouseDown}
          onMouseUp={handleMouseUp}>
                <div className="card--content bg-white min-w-[200px] m-2 "></div>
                <div className="card--content bg-white min-w-[200px] m-2 "></div>
                <div className="card--content bg-white min-w-[200px] m-2 "></div>
                <div className="card--content bg-white min-w-[200px] m-2 "></div>
                <div className="card--content bg-white min-w-[200px] m-2 "></div>
