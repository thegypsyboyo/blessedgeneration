            ...
            <div className="w-full h-full flex justify-between flex-wrap ">
                ...
                <div className="flex-grow-0 flex-shrink-0 lg:max-w-[66.6666%] w-full h-full lg:pr-[15px]">
                    <div className="w-full h-full bg-redDark flex flex-wrap ">
                        <div className="md:max-w-[50%] bg-lightBlue w-full h-full flex-shrink-0 flex-grow-0 ">
                            <div className="mr-[20px] w-full h-[300px] overflow-hidden">
                                <Image src="/images/test/gallery-1.jpg" alt="" width={300} height={300} className="w-full h-full object-cover"/>
                                <div>content</div>
                            </div>
                        </div>
                        <div className="md:max-w-[50%] bg-lightBlue w-full h-full flex-shrink-0 flex-grow-0 ">
                            <div className="mr-[20px] w-full h-[300px]">
                                <Image src="/images/test/gallery-1.jpg" alt="" width={300} height={300} className="w-full h-full object-cover"/>
                                <div>content</div>
                            </div>
                        </div>
                        ...
                        {/* <div className="md:max-w-[50%] bg-lightBlue w-full h-[240px]">content</div>
                        <div className="md:max-w-[50%] bg-lightBlue w-full h-[240px]">content</div>
                        <div className="md:max-w-[50%] bg-lightBlue w-full h-[240px]">content</div> */}
                    </div>
                </div>
