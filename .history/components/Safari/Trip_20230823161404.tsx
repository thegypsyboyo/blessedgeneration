        ...
        <Layout >
            <div className="w-full h-full flex justify-between flex-wrap ">
                ...
                <div className="flex-grow-0 flex-shrink-0 lg:max-w-[66.6666%] w-full h-full lg:pl-[15px] bg-darkBlue">
                    <div className='w-full h-full flex flex-wrap bg-redDark'>
                        <div className="w-full bg-redLight h-[250px] overflow-hidden md:max-w-[50%]
                        flex-grow-0 flex-shrink-0 group flex items-center m-auto justify-center" >
                            <div className="w-full h-full relative mb-[30px] flex flex-col items-center group ">
                                ...
                                <Image src="/images/test/gallery-1.jpg" alt="" width={200} height={200} className="w-full h-full"/>
                                <div className='absolute bottom-[0] left-[30px] bg-redLight py-[6px] px-[25px] rounded-[15px] z-[2]'>
                                ...
                                {/* <div className="relative block overflow-hidden z-[1]">
                                    <div className="absolute content-[]  left-0 bottom-0 w-full h-[0] bg-primaryDark bg-opacity-[0.7] opacity-[0] transform  rotate-90 translate-y-[50px] transition-all duration-[900ms] z-[1] group-hover:visible group-hover:opacity-[1] group-hover:h-full  group-hover:rotate-[0] group-hover:translate-y-[0px]"/>
                                    <Image src="/images/test/gallery-1.jpg" alt='main-image' width={250} height={250} className='object-cover transform scale-[1] transition duration-500 ease group-hover:scale-[1.05] w-full h-full'/>
