...
const Places = () => {
  return (
    <section className="py-[50px] w-full h-full">
        ...
        <div className="relative overflow-x-auto overflow-y-hidden h-[207px] min-w-screen">
      <div className="absolute top-0 left-0 w-full h-full bg-cover bg-map-image" style={{backgroundImage: `url(/images/timeline.svg)`}}></div>
    </div>
    </section>
  )
}
