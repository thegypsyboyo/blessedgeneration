        ...
        <Layout>
            ...
            <div className='swiper-container relative w-full h-full z-100 flex transition-transform duration-500 ease-in-out box-content'>
                ...
                <SwiperSlide key={index}
                    className=''
                >
                <div className='flex items-center h-full w-full bg-[#abb8c3] justify-center items-center'>
                    <div className="bg-[#abb8c3] w-full h-full flex-shrink-0 flex-grow-0 lg:max-w-[50%]">
                        <h3>{item.title}</h3>
                    </div>
                    <div className="lg:max-w-[50%] w-full h-[400px]  bg-yellow bg-white z-[2]">
                        <Image src={item.img} alt="image main" className="" width={500} height={500}/>
                    </div>
                </div>
