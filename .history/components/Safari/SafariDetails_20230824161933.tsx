    ...
    <section className='block py-[120px] relative'>
        <Layout>
            <div className="flex flex-wrap  w-full justify-between">
                <div className="w-full h-[400px] mb-[40px]">
                    <Image src="/images/test/gallery-1.jpg" alt='main-image' width={300} height={300} priority className='w-full h-full object-cover'/>
                </div>
