                    ...
                    flex-grow-0 flex-shrink-0 group flex items-center m-auto justify-center " key={index}>
                        <div className="relative mb-[30px] flex flex-col items-center justify-items-center ">
                            ...
                            <div className=" w-full bg-white shadow-custom border-solid border-borderColor pt-[22px] pb-[30px] px-[30px] border-t-0 flex flex-col items-center justify-center">
                                <h3 className="text-[18px] leading-[26px] font-[500] -tracking-[0.04em]  text-center">
                                    <Link href={`/donate/donation-info/${item.slug}`} className='text-darkBlue transition-all duration-500 hover:text-primaryText'>{item.title}</Link>
                                </h3>
