            ...
            <div className="w-full h-full flex justify-between flex-wrap items-center">
                <div className="flex-grow-0 flex-shrink-0 w-full mb-7 lg:max-w-[33.3333%] h-full lg:pr-[15px] items-center justify-center">
                    <div className="w-full h-full">
                        <h1 className='text-[30px] text-dark font-nun font-[700] leading-[40px]'>THE TOP 4 DAY TRIPS</h1>
                        <span className="text-[18px] capitalize leading-[28px] pb-4 font-[300]  text-primaryText">check out our most popular attractions in Kenya</span>
                        <p className="text-primaryText font-[400] lg:max-w-[80%] leading-[32px] text-[18px] mt-4"> Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit.</p>

                        <div className="flex items-center space-x-3 mt-5">
                            <AnimatedIcon  href='' icon={<BsFacebook/>} className="!text-white bg-dakrBlue hover:text-white"  style="bg-darkBlue"/>
