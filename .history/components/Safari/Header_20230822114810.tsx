  ...
  return (
    ...
    <section className='py-[120px]'>
        <Layout>
            ...
            >
            <div className='swiper-container relative w-full h-full flex transition-transform duration-500 ease-in-out box-content'>
                {data.map((item, index) =>(
                <SwiperSlide key={index}
                    className=''
                >
                <div className='relative flex h-full flex-wrap w-full bg-dakBlue justify-center items-center'>
                    <div className="content-[] bg-[#abb8c3] absolute w-[70%] z-[1] h-full top-0 bottom-0 left-0  "/>
                    <div className="bg-[#abb8c3] w-full h-full flex-shrink-0 flex-grow-0  lg:max-w-[40.8%]">
                        <h3>{item.title}</h3>
                    </div>
                    <div className="lg:max-w-[59.2%] flex-shrink-0 flex-grow-0  w-full h-full  bg-yellow bg-trasparent items-center flex justify-center z-[1]">
