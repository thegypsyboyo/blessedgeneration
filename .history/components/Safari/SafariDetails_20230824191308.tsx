            ...
            <div className="flex flex-wrap  w-full justify-between">
                <div className="w-full h-[500px] mb-[40px]">
                  ...
                  <div className="w-full xl:max-w-[66.6667%] lg:max-w-[66.6667%] mb-[30px] flex-shrink-0">
                    ...
                    <div className="relative mb-[30px] w-full items-center flex justify-center">
                        <div 
                        className='relative block rounded-lg'>
                            <Image src="/images/test/gallery-1.jpg" alt='' width={300} height={300} className='w-[120px] h-[120px] rounded-full object-cover'/>
                        </div>
                    
                    </div>
                    <div className=" relative mb-[30px] w-full border border-ligthBlue items-center flex justify-center flex-col p-[30px]">
                        ...
                        <div className="mx-5 flex flex-wrap w-full">
                            <div className="flex-grow-0 flex-shrink-0 mb-2 w-full lg:w-1/2 px-1">
                                <Image src="/images/test/gallery-1.jpg" alt='' width={200} height={200} className='w-full lg:h-[120px] object-cover h-full'/>
                            </div>
                            <div className="flex-grow-0 flex-shrink-0 mb-2 w-full lg:w-1/2 px-2">
                                <Image src="/images/test/gallery-1.jpg" alt='' width={200} height={200} className='w-full lg:h-[120px] object-cover h-full'/>
                            </div>
                            <div className="flex-grow-0 flex-shrink-0 mb-2 w-full lg:w-1/2 px-2">
                                <Image src="/images/test/gallery-1.jpg" alt='' width={200} height={200} className='w-full lg:h-[120px] object-cover h-full'/>
                    ...
                    <div className="relative block">
                        <div 
                        className='relative block p-10 rounded-lg border border-ligthBlue '>
                            <h3 className='text-[23px] font-[700] -tracking-[0.04] text-primaryDark relative pb-4 capitalize'>
                                Similar Interests
                                <span className="content-[] absolute w-full h-[1px] bg-white left-0 bottom-0 z-[2]"/>
                                    ...
                                    <li key={index} className='flex items-center w-full  pr-[18px] transition-all duration-500 '>
                                        <div className="relative mt-3 flex items-center w-full">
                                            <div className="w-[200px] h-[100px] ">
                                                <Image  src="/images/test/gallery-1.jpg" alt='sub-image' width={200} height={200} className="w-full h-full object-cover"/>
                                            </div>
                                            <h3 className='pl-3 flex flex-col leading-[20px] ml-0 p-0 text-[#454545] font-[300] text-[16px] w-auto'>
