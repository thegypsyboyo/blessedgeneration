            ...
            <div className="w-full h-full flex justify-between flex-wrap items-center">
                <div className="flex-grow-0 flex-shrink-0 w-full mb-7 lg:max-w-[33.3333%] h-full lg:pr-[15px] items-center justify-center">
                    <div className="w-full h-full">
                        ...
                        <span className="text-[18px] capitalize leading-[28px] pb-4 font-[500]  text-primaryText">check out our most popular attractions in Kenya</span>
                        <p className="text-primaryText font-[300] lg:max-w-[80%] leading-[32px] text-[18px] mt-4"> Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit.</p>
