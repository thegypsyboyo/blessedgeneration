...
const SafariDetails:React.FC = () => {
  ...
  return (
    <section className='block py-[120px] relative'>
        <Layout>
            <div className="flex flex-wrap mb-[40px] w-full justify-between">
                <div className="w-full h-[400px]">
                    <Image src="/images/test/gallery-1.jpg" alt='main-image' width={400} height={400} className='w-full h-full object-cover'/>
                </div>
