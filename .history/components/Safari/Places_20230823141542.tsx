  ...
  return (
    <section className="py-[50px] w-full h-full">
        ...
        <div className="flex items-center justify-center mt-7">
            <div className={`card relative  overflow-x-auto  !min-w-[100%] min-h-[250px] flex bg-redLight`} >
                <div className='fixed !min-w-full min-h-[250px] bg-no-repeat bg-center bg-cover z-[3] '  style={{backgroundImage: `url(/images/timeline.svg)`}}/>
