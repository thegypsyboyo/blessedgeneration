        ...
        <Layout>
            ...
            <div className='swiper-container relative w-full h-full z-100 flex transition-transform duration-500 ease-in-out box-content'>
                ...
                <SwiperSlide key={index}
                    className=''
                >
                <div className='relative flex flex-wrap h-full w-full bg-white '>
                    {/* <div className="content-[] bg-[#abb8c3] absolute lg:w-[70%] w-full h-full top-0 bottom-0 left-0  "/> */}
                    <div className="w-full h-full flex-shrink-0 flex-grow-0 lg:max-w-[40.8%]">
                        <h3>{item.title}</h3>
                    </div>
                    <div className="bg-[#abb833] w-full h-full flex-shrink-0 flex-grow-0 lg:max-w-[59.8%]">
                        <h3>{item.title}</h3>
                    </div>
                    {/* <div className="lg:max-w-[59.2%] w-full h-full z-[3] items-center flex justify-center flex-shrink-0 flex-grow-0">
                        <Link href="" className="w-full h-full bg-primaryDark">
