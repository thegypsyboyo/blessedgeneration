        ...
        <Layout>
            ...
            <div className='relative w-full h-full flex transition-transform duration-500  bg-darkBlue'>
                ...
                <div className='relative flex h-full flex-wrap w-full bg-transparent justify-center items-center lg:px-5'>
                    ...
                    <div className="custom-prev z-[2] absolute left-0 top-[50%] p-2 rounded-full bg-darkBlue w-[60px] h-[60px] flex items-center text-white cursor-pointer group transition-all duration-500 ease-in hover:text-redLight hover:bg-white">
                     <BsArrowLeft className="text-white text-[20px] group-hover:text-darkBlue"/>
                    </div>
                    <div className="custom-next z-[2] absolute right-1 top-[50%] p-2 rounded-full bg-darkBlue w-[60px] h-[60px] flex items-center text-white cursor-pointer group transition-all duration-500 ease-in hover:text-redLight hover:bg-white">
