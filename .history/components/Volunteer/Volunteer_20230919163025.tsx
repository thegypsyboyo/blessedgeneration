        ...
        <Layout className='flex flex-col'>
            ...
            <div className="flex flex-wrap mx-auto mt-auto w-full h-full">
                <div className="h-full flex-shrink-0 flex-grow-0 xl:max-w-[50%] w-full lg:max-w-[50%]">
                    <div className="relative block bg-borderColor ld:rounded-tl-lg  lg:rounded-tr-0 rounded-tl-lg rounded-tr-lg lg:py-[60px] md:p-[30px] p-[20px] lg:px-[60px]">
                ...
                <div className="flex-shrink-0 flex-grow-0 xl:max-w-[50%] w-full lg:max-w-[50%]">
                    <div className="relative block bg-white bg-shadow border-borderColor border-solid lg:rounded-tr-[20px] rounded-br-[20px] lg:p-[60px] md:p-[30px] p-[20px]  h-full">
