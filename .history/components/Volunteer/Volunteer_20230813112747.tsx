                    ...
                    <div className="relative block bg-borderColor rounded-tl-[20px]  py-[60px] px-[60px]">
                        ...
                        <div className="relative flex items-center border-t-borderColor border-solid pt-[30px] mt-[50px] ">
                            ...
                            <div className='relative -top-[2px] ml-[20px]'>
                                ...
                                <p className="text-[20px] font-[800] leading-[20px]"><Link href="tel:980009630" className='text-white transition-all duration-500 hover:text-primaryBase'>+98 (000) - 9630</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
