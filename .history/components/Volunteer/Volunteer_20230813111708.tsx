    ...
    <section className='py-[120px] relative block h-full w-full'>
        <Layout className='flex flex-col'>
            <div className='relative -mt-[40px] mb-[46px] flex flex-col items-center justify-center w-full'>
                <span className="text-[24px] text-primaryBase font-[700] leading-[24px] mb-[10px] font-cav text-center">Register yourself with us</span>
            ...
            <div className="flex flex-wrap mx-auto mt-auto w-full">
                <div className="flex-shrink-0 flex-grow-0 xl:max-w-[50%] w-full lg:max-w-[50%]">
                    <div className="relative block bg-borderColor rounded-tl-[20px] rounded-br-[20px] py-[60px] px-[60px]">
                        ...
                        <div className="relative flex items-center border-t-borderColor border-solid pt-[30px] mt-[50px] ">
                            <div className='relative flex items-center justify-center h-[65px] w-[65px] bg-yellowColor rounded-[50%] text-[35px] text-primaryDark'>
                                <SiWechat/>
                            </div>
                            <div className='relative -top-[2px] ml-[20px]'>
                                ...
                                <p className="text-[20px] font-[800] leading-[20px]"><Link href="tel:980009630" className='text-primaryDark transition-all duration-500 hover:text-primaryBase'>+98 (000) - 9630</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
