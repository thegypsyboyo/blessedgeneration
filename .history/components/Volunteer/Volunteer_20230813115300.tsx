    ...
    <section className='py-[120px] relative block h-full w-full'>
        <Layout className='flex flex-col'>
            <div className='relative -mt-[40px] mb-[46px] flex flex-col items-center justify-center w-full'>
                ...
                <h2 className="m-0 text-primaryDark text-[30px] font-[800] -tracking-[0.04em] mt-[6px] text-center lg:text-[45px] lg:leading-[50px] xl:text-[50px] lg:max-w-[600px] border-b border-b-darkBlue pb-[15px] border-w-[40px] relative">
                    Let’s join our community to become a volunteer

                    <span className="content-[] absolute w-[100px] h-[1px] bg-orangeDefault bottom-0 "/>
                </h2>
            </div>
