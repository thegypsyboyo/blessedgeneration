...
const Volunteer = () => {
    ...
    async function submitForm(e: React.FormEvent<HTMLFormElement>) {
        ...
        let username: string, phone:string, email: string, subject:string, occupation: string,dob:string, address: string,  message: string;
        ...
        if (!username || !dob || !address || !occupation || !email || !subject || !phone || !message) {
        ...
        const formValues: FormValues = { username,phone, email, message, subject, address, dob, occupation };
        let result;
        try {
                        ...
                        <form action="#" onSubmit={submitForm}  className='relative block w-full'>
                            <div className="flex flex-wrap w-full">
                                ...
                                <div className="w-full xl:max-w-[50%] flex-shrink-0 flex-grow-0 xl:pl-[10px]">
                                    <div className="relative block mb-[20px] ">
                                    <input typeof="text" required placeholder="Your Phone" ref={phoneRef} 
