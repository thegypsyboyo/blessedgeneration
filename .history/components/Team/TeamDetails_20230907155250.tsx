        ...
        <Layout>
            ...
            <div className="flex flex-wrap w-full h-full" key={index}>
                <div className="flex-grow-0 flex-shrink-0 w-full px-[15px]">
                    <div className="flex flex-wrap w-full h-full relative z-[1] pl-[60px] pb-[67px] bg-white ">
                        <div className="flex-grow-0 flex-shrink-0 w-full lg:w-[50%] pr-[57px]">
                            <div className="lg:max-w-[480px] ">
                                <Image src={item.image} alt='team-member' priority width={500} height={500} className='w-full h-full lg:h-[500px] object-cover'/>
                            </div>
                        </div>
