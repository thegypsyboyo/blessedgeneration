            ...
            <div className="flex flex-wrap w-full h-full" key={index}>
                <div className="flex-grow-0 flex-shrink-0 md:max-w-[41.6666%] w-full h-full">
                    <div className="rounded-[10px] mb-0 w-full max-w-[520px] inline-block overflow-hidden relative">
                        ...
                        <div className="mt-[-45px] mx-[30px] mb-[60px] inline-block relative bg-redDark p-[30px] text-white rounded-[10px] w-[80%]">
                            <ul className="w-full h-full">
                                ...
                                <li className="border-b border-b-yellowColor  pb-[10px] mb-[10px] w-full h-full">
                                    <div className="flex gap-0 w-full h-full">
                                        ...
                                        <p className='font-bold text-white uppercase text-[18px] leading-[26px]'>Email <a href="tel:+123-4561-5523" className="w-full h-full">example@email.com</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
