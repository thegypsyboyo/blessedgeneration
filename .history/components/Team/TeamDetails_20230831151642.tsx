        ...
        <Layout>
            ...
            <div className="flex flex-wrap w-full h-full" key={index}>
                <div className="flex-grow-0 flex-shrink-0 w-full px-[15px]">
                    <div className="flex flex-wrap w-full h-full relative z-[1] pl-[60px] pb-[67px] bg-[#f8f5f0] ">
                        <div className="flex-grow-0 flex-shrink-0 w-full mt-[-70px] mb-[50px] pr-[57px]">
                            <div className="lg:max-w-[480px] ">
                                <Image src={item.image} alt='team-member' width={400} height={400} className='w-full h-full lg:h-[500px] object-cover'/>
                            </div>
                        </div>
                        <div className="flex-grow-0 flex-shrink-0 w-full flex-col  lg:flex-grow-1 pt-[78px] pb-[80px]">
                ...
                <div className="flex-grow-0 flex-shrink-0 w-full px-[15px] mt-7 lg:max-w-[full] w-full">
