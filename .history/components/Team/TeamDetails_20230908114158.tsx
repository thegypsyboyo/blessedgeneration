                ...
                <div className="flex-grow-0 flex-shrink-0 md:max-w-[58.33333%] w-full h-full">
                    <div className="md:pl-[70px] md:pr-[45px] mb-[60px] w-full h-full">
                        ...
                        <div className="mt-[35px] ">
                            ...
                            <p className="text-[16px] font-normal text-primaryText leading-[26px]">The English garden usually included a lake, sweeps of gently rolling lawns set against groves of trees, and recreations of classical temples.</p>
                        </div>
                    </div>
                </div>
            </div>
