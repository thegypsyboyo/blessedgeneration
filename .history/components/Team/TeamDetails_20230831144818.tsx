                    ...
                    <div className="w-full h-full flex relative z-[1] pl-[60px] pb-[67px] bg-[#f8f5f0] ">
                        <div className="mt-[-70px] mb-[50px] pr-[57px]">
                            <div className="lg:max-w-[480px] ">
                                <Image src={item.image} alt='team-member' width={400} height={400} className='w-full h-full lg:h-[500px] object-cover'/>
                            </div>
                        </div>
                        <div className="flex flex-col flex-grow-1 pt-[78px] pb-[80px]">
                            ...
                            <ul className="w-full h-full flex mt-2">
                                      {item.socials?.map((social, index) => (       
                                        <li key={index} className="mr-2 w-[60px] h-[50px] flex ">
                                          <Link href={social.url} rel="noreferrer noopener" target="_blank" className={`${social.platform === "facebook" ? "bg-blue-800":""} ${social.platform === "instagram" ? "hover:bg-[#F56040] ":"!bg-[#F56040] "}  ${social.platform === "linkedin" ? "hover:bg-blue-400":"bg-blue-400"} ${social.platform === "twitter" ? "hover:bg-blue-600":"!!!bg-blue-600"}  ${social.platform === "youtube" ? "hover:bg-[#c4302b]":""} ${social.platform === "twitch" ? "hover:bg-[#6441A4]":"bg-[#6441A4]"} bg-yellowColor  text-white cursor-pointer w-full h-full flex items-center justify-center z-[1]`}>
