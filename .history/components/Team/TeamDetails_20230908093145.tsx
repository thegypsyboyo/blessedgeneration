                    ...
                    <div className="flex flex-wrap w-full h-full relative z-[1] pb-[67px] bg-white ">
                        <div className="flex-grow-0 flex-shrink-0 w-full md:w-[41.666%] mb-[20px]">
                            <div className="w-full max-w-[520px] ">
                                <Image src={item.image}  alt='team-member' priority width={500} height={500} className='w-full h-full md:h-[400px] z-[-1] object-cover rounded-[10px]'/>
                                <div className="!z-[8888] w-full h-full  mt-[-45px] mx-[30px] mb-[60px] rounded-[10px] p-[30px] bg-yellowColor">Content here</div>
                            </div>
                        </div>
