                ...
                <div className="flex-grow-0 flex-shrink-0 md:max-w-[58.33333%] w-full h-full">
                    <div className="md:pl-[70px] md:pr-[45px] mb-[60px] w-full h-full">
                        ...
                        <div className="mt-[35px] ">
                            ...
                            <div className="flex flex-wrap gap-[45px] pb-[15px] overflow-hidden">
                                <div className="w-[calc(100%-45px)/2] overflow-x-clip mb-[25px]">
                                    <div className="mb-[16px]flex justify-between items-center relative">
