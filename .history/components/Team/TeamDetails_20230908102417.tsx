                            ...
                            <ul className="w-full h-full">
                                ...
                                <li className="border-b border-b-yellowColor  pb-[10px] mb-[10px] w-full h-full">
                                    <div className="flex gap-0 w-full h-full">
                                        ...
                                        <p className='font-bold text-white uppercase text-[18px] leading-[26px] w-full h-full'>Email <Link href="tel:+123-4561-5523" className="w-full h-full">example@email.com</Link></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
