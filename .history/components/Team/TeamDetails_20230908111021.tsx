            ...
            <div className="flex flex-wrap w-full h-full" key={index}>
                ...
                <div className="flex-grow-0 flex-shrink-0 md:max-w-[58.33333%] w-full h-full">
                    <div className="md:pl-[70px] md:pr-[45px] mb-[60px] w-full h-full">
                        ...
                        <p className="mb-[20px] text-[16px]">Most gardens consist of a mix of natural and constructed elements, although even very natural gardens are always an inherently artificial creation. Natural elements present in a garden principally.</p>
                    </div>
                </div>
            </div>
            ))}
