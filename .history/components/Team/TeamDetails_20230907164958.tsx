                ...
                <div className="flex-grow-0 flex-shrink-0 w-full px-[15px]">
                    <div className="flex flex-wrap w-full h-full relative z-[1] pb-[67px] bg-white ">
                        ...
                        <div className="flex-grow-1 flex-shrink-0 w-full md:w-[66.6667%] flex-col">
                            ...
                            <h2 className="relative text-[3rem] text-[#232e4e] font-semibold">{item.name}</h2>

                            <p className='text-[17px] text-dark'>Utinam maiestatis quo cu. Id libris patrioque eos, pro soluta dignissim splendide ei, vim in iudico facilis. Usu te liber repudiare. Mea option apeirian periculis et, ex vis graece intellegam, option omittam id quo.</p>
