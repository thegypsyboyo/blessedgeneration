            ...
            <div className="flex flex-wrap w-full h-full" key={index}>
                <div className="flex-grow-0 flex-shrink-0 w-full px-[15px]">
                    <div className="flex flex-wrap w-full h-full relative z-[1] pb-[67px] bg-white ">
                        <div className="flex-grow-0 flex-shrink-0 w-full md:w-[41.666%] mb-[20px]">
                            <div className="w-full max-w-[520px] ">
                                <Image src={item.image}  alt='team-member'  width={500} height={500} className='w-full h-full z-[0] object-cover rounded-[10px]'/>
                                <div className="!z-[8] h-full mt-[-45px] mx-[30px] mb-[60px] rounded-[10px] p-[30px] bg-yellowColor">
                                    <div className="z-[8] h-full mt-[-45px] mx-[30px] mb-[60px] rounded-[10px] p-[30px] bg-redDark"></div>
                                </div>
                            </div>
                        </div>
                        <div className="flex-grow-1 flex-shrink-0 w-full md:w-[58.3333%] flex-col md:pl-[30px]">
