...
import { faMailForward, faPhone, faPhoneAlt } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className="flex flex-wrap w-full h-full" key={index}>
                <div className="flex-grow-0 flex-shrink-0 md:max-w-[41.6666%] w-full h-full">
                    <div className="rounded-[10px] mb-0 w-full max-w-[520px] inline-block overflow-hidden relative">
                        ...
                        <div className="mt-[-45px] mx-[30px] mb-[60px] inline-block relative bg-redDark p-[30px] text-white rounded-[10px]">
                            <ul>
                                <li className="border-b border-b-[#154b39] pb-[10px] mb-[10px]">
                                    <div className="flex gap-0">
                                        <div className='text-[18px] text-yellowColor min-w-[40px]'>
                                            <FontAwesomeIcon icon={faPhone} className=''/>
                                        </div>
                                        <p className='font-bold text-white uppercase text-[8px] leading-[26px]'>Tel: <a href="tel:+123-4561-5523">+123-4561-5523</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
